...
namespace GS2Studio.Generated.Schedule.UI
{
    ...
    /// based on the condition <c>eq(scheduleType, relative)</c> evaluated
    ...
    /// </summary>
    [AddComponentMenu("GS2 Studio/DomainType/Schedule/ActiveToggle/RelativeActiveToggle")]
    public sealed class ScheduleRelativeActiveToggle : MonoBehaviour
    {
        ...
        private void OnEnable()
        {
            ...
            if (_handler == null)
            {
                ...
                if (!_warnedMissingHandler)
                {
                    ...
                    Debug.LogWarning(
                        $"{nameof(ScheduleRelativeActiveToggle)} on '{name}': no ScheduleHandlerBase found in the parent chain; component inactive.", this);
                }
                return;
            }
            if (!_subscribed)
        ...
        {
            bool result = object.Equals(model.ScheduleType, "relative");
