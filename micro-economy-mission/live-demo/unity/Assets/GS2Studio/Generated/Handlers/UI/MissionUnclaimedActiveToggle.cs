...
namespace GS2Studio.Generated.Mission.UI
{
    ...
    /// </summary>
    [AddComponentMenu("GS2 Studio/DomainType/Mission/ActiveToggle/UnclaimedActiveToggle")]
    public sealed class MissionUnclaimedActiveToggle : MonoBehaviour
    {
        ...
        private void OnEnable()
        {
            ...
            if (_handler == null)
            {
                ...
                if (!_warnedMissingHandler)
                {
                    ...
                    Debug.LogWarning(
                        $"{nameof(MissionUnclaimedActiveToggle)} on '{name}': no MissionHandlerBase found in the parent chain; component inactive.", this);
                }
                return;
            }
            if (!_subscribed)
