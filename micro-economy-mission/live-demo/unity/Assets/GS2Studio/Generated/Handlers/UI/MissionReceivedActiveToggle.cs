...
namespace GS2Studio.Generated.Mission.UI
{
    ...
    /// based on the condition <c>truthy(received)</c> evaluated
    ...
    /// </summary>
    [AddComponentMenu("GS2 Studio/DomainType/Mission/ActiveToggle/ReceivedActiveToggle")]
    public sealed class MissionReceivedActiveToggle : MonoBehaviour
    {
        ...
        private void OnEnable()
        {
            ...
            if (_handler == null)
            {
                ...
                if (!_warnedMissingHandler)
                {
                    ...
                    Debug.LogWarning(
                        $"{nameof(MissionReceivedActiveToggle)} on '{name}': no MissionHandlerBase found in the parent chain; component inactive.", this);
                }
                return;
            }
            if (!_subscribed)
