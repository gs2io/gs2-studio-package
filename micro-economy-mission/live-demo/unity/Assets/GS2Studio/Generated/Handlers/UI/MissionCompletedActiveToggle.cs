...
namespace GS2Studio.Generated.Mission.UI
{
    ...
    /// based on the condition <c>truthy(completed)</c> evaluated
    ...
    /// <c>MissionHandler</c> or <c>MissionListItemHandler</c>;
    ...
    /// </summary>
    [AddComponentMenu("GS2 Studio/DomainType/Mission/ActiveToggle/CompletedActiveToggle")]
    public sealed class MissionCompletedActiveToggle : MonoBehaviour
    {
        ...
        private void OnEnable()
        {
            ...
            if (_handler == null)
            {
                ...
                if (!_warnedMissingHandler)
                {
                    ...
                    Debug.LogWarning(
                        $"{nameof(MissionCompletedActiveToggle)} on '{name}': no MissionHandlerBase found in the parent chain; component inactive.", this);
                }
                return;
            }
            if (!_subscribed)
