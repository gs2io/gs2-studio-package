...
using GS2Studio.Generated.TriggerPull;
...
namespace GS2Studio.Generated.TriggerPull.UI
{
    ...
    /// substituted with the resolved value from <c>TriggerPull</c>
    ...
    /// </summary>
    [AddComponentMenu("GS2 Studio/DomainType/TriggerPull/TemplateLabel/NameLabel")]
    public sealed class TriggerPullNameLabel : MonoBehaviour
    {
        ...
        private void OnEnable()
        {
            ...
            if (_handler == null)
            {
                ...
                if (!_warnedMissingHandler)
                {
                    ...
                    Debug.LogWarning(
                        $"{nameof(TriggerPullNameLabel)} on '{name}': no TriggerPullHandlerBase found in the parent chain; component inactive.", this);
                }
                return;
            }
            if (!_subscribed)
        ...
        {
            if (_handler == null) _handler = GetComponentInParent<TriggerPullHandlerBase>();
        }

        private void OnUpdated(TriggerPull model)
        {
