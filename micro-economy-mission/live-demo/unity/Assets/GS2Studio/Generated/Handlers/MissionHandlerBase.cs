...
namespace GS2Studio.Generated.Mission
{
    ...
    /// MissionBinder: the standalone/list MissionHandler and the
    /// slot-bound MissionListItemHandler. Concrete handlers supply the
    ...
    public abstract class MissionHandlerBase : MonoBehaviour
    {
        ...
        public abstract IActionableMissionBinder? Binder { get; }
        ...
        public event Action<Mission>? Updated;

        /// <summary>Fires once each time a binder is attached (non-owning actionable view).</summary>
        public event Action<IActionableMissionBinder>? Bound;
        ...
        protected void RaiseUpdated(Mission model) => Updated?.Invoke(model);
        protected void RaiseBound(IActionableMissionBinder binder) => Bound?.Invoke(binder);
