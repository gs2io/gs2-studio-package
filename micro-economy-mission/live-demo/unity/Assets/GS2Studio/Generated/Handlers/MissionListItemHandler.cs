...
{
    /// <summary>
    /// Mounts onto Binders[index] of a parent IMissionBinderListSource
    /// (the plain MissionListHandler or any ref-scoped variant) and
    ...
    /// </summary>
    [AddComponentMenu("GS2 Studio/DomainType/Mission/Mission List Item Handler")]
    public sealed class MissionListItemHandler : MissionHandlerBase
    {
        ...
        private IMissionBinderListSource? _list;
        ...
        // non-owning IActionableMissionBinder.
        private IActionableMissionBinder? _binder;
        private long _reevaluateGeneration;

        public override IActionableMissionBinder? Binder => _binder;
        // The binder implements <see cref="Mission"/>, so it is the model.
        ...
        /// </summary>
        public void AttachTo(IMissionBinderListSource list, int index)
        {
        ...
        private void Start()
        {
            ...
            var list = GetComponentInParent<IMissionBinderListSource>();
            if (list == null)
            {
                RaiseFailed(new InvalidOperationException(
                    "No ancestor IMissionBinderListSource found in the parent chain."));
                SetContentVisible(false);
                return;
            }
            _list = list;
