...
{
    /// <summary>
    /// MonoBehaviour list handler for MissionCollection scoped by the
    /// Schedule reference. Auto-resolves a parent
    /// ScheduleHandlerBase from the GameObject hierarchy, owns a
    /// MissionCollectionBinderCollection, and instantiates a child
    /// MissionCollectionListItemHandler only for the binders whose
    /// Schedule equals the parent's id. Implements
    /// IMissionCollectionBinderListSource so items read Binders[Index] through the
    /// shared parent-list surface.
    /// </summary>
    [AddComponentMenu("GS2 Studio/DomainType/MissionCollection/MissionCollection List By Schedule Handler")]
    public sealed class MissionCollectionListByScheduleHandler : MonoBehaviour, IMissionCollectionBinderListSource
    {
        // Which of MissionCollectionBinderCollection's mount axes this list reads
        ...
        // them.
        [SerializeField] private MissionCollectionListAxis _axis;
        ...
        [SerializeField] private MissionCollectionListItemHandler? _itemPrefab;
        ...
        // Construction seam. Defaults to DefaultMissionCollectionBinderFactory.Instance;
        // override via SetBinderFactory to substitute a fake collection.
        private IMissionCollectionBinderFactory? _binderFactory;

        private IMissionCollectionBinderCollection? _collection;
        ...
        private Action<IMissionCollectionBinder>? _collectionItemAddedCallback;
        private Action<IMissionCollectionBinder>? _collectionItemRemovedCallback;
        ...
        // binders' handlers.
        private readonly Dictionary<IActionableMissionCollectionBinder, MissionCollectionListItemHandler> _handlers =
            new Dictionary<IActionableMissionCollectionBinder, MissionCollectionListItemHandler>();
        ...
        private readonly Dictionary<IActionableMissionCollectionBinder, IMissionCollectionBinder> _binderByView =
            new Dictionary<IActionableMissionCollectionBinder, IMissionCollectionBinder>();
        ...
        private readonly List<IActionableMissionCollectionBinder> _visibleBinders =
            new List<IActionableMissionCollectionBinder>();
        ...
        private IComparer<IReadOnlyMissionCollectionBinder>? _comparer;
        ...
        public IReadOnlyList<IActionableMissionCollectionBinder> Binders => _visibleBinders;
        ...
        public event Action<IActionableMissionCollectionBinder>? ItemAdded;
        ...
        public event Action<IActionableMissionCollectionBinder>? ItemRemoved;
        ...
        public IComparer<IReadOnlyMissionCollectionBinder>? Comparer
        {
            ...
            set
            {
                ...
                // MissionCollectionBinderCollection.MissionCollectionBinderComparer.
                var applied = value ?? MissionCollectionBinderCollection.MissionCollectionBinderComparer.Default;
        ...
        /// to substitute a fake MissionCollectionBinderCollection; takes precedence over
        /// the default factory. Pass null to revert to the default. Applies to
        /// the next ReloadAsync.
        /// </summary>
        public void SetBinderFactory(IMissionCollectionBinderFactory? factory)
        {
            _binderFactory = factory;
        }

        private IMissionCollectionBinderFactory ResolveBinderFactory()
            => _binderFactory ?? DefaultMissionCollectionBinderFactory.Instance;
        ...
        /// (the MissionCollectionBinderCollection only re-sorts on list-membership
        ...
        public async Task ReloadAsync(CancellationToken cancellationToken = default)
        {
            ...
            var operationGeneration = ++_reloadGeneration;
            IMissionCollectionBinderCollection? operationCollection = null;
            try
            {
                Cleanup();
                ...
                switch (_axis)
                {
                    case MissionCollectionListAxis.MissionMissionMaster:
                        await collection.MountFromMissionMissionMasterDataAsync(cancellationToken);
                        break;
                    case MissionCollectionListAxis.MissionMissionUser:
                        await collection.MountFromMissionMissionUserDataAsync(cancellationToken);
                        break;
                }
                ...
                if (_autoSubscribe)
                {
                    ...
                    switch (_axis)
                    {
                        case MissionCollectionListAxis.MissionMissionMaster:
                            ...
                            break;
                        case MissionCollectionListAxis.MissionMissionUser:
                            collection.SubscribeFromMissionMissionUserData(collectionChanged, collectionFailed);
                            break;
                    }
                }
        ...
        private const string AxisMemberNames = "MissionMissionMaster, MissionMissionUser";
        ...
        private bool MatchesParent(IReadOnlyMissionCollectionBinder binder)
            => binder.Schedule.HasValue && EqualityComparer<ScheduleId>.Default.Equals(binder.Schedule.Value, _parentId);

        private bool IsCurrentOperation(long operationGeneration, IMissionCollectionBinderCollection? operationCollection)
            => !_isDestroyed
        ...
        {
            Action<IMissionCollectionBinder> itemAdded = binder =>
                OnItemAdded(operationGeneration, collection, binder);
            Action<IMissionCollectionBinder> itemRemoved = binder =>
        ...
        private void OnItemAdded(
            long operationGeneration,
            IMissionCollectionBinderCollection collection,
            IMissionCollectionBinder binder)
        {
            if (!IsCurrentOperation(operationGeneration, collection)) return;
        ...
        private void OnCollectionChanged(long operationGeneration, IMissionCollectionBinderCollection collection)
        {
            if (!IsCurrentOperation(operationGeneration, collection)) return;
        ...
        private int IndexOf(IActionableMissionCollectionBinder binder)
        {
        ...
        private void DestroyItem(IActionableMissionCollectionBinder binder)
        {
            ...
            IMissionCollectionBinderCollection collection)
        {
            ...
            var visibleSet = new HashSet<IActionableMissionCollectionBinder>(_visibleBinders);
        ...
        private void Cleanup()
        {
            ...
            var handlers = new List<MissionCollectionListItemHandler>(_handlers.Values);
            _collection = null;
