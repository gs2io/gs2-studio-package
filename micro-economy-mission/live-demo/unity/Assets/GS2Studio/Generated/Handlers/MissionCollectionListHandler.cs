...
{
    /// <summary>
    /// MonoBehaviour list handler for MissionCollection. Owns a
    /// MissionCollectionBinderCollection, instantiates a child MissionCollectionListItemHandler
    ...
    /// </summary>
    [AddComponentMenu("GS2 Studio/DomainType/MissionCollection/MissionCollection List Handler")]
    public sealed class MissionCollectionListHandler : MonoBehaviour, IMissionCollectionBinderListSource
    {
        ...
        /// itself is the IReadOnlyList&lt;IActionableMissionCollectionBinder&gt;.</summary>
        public IReadOnlyList<IActionableMissionCollectionBinder> Binders =>
            (IReadOnlyList<IActionableMissionCollectionBinder>?)_collection ?? Array.Empty<IActionableMissionCollectionBinder>();
        ...
        {
            if (!IsCurrentOperation(operationGeneration, collection)) return;
            // The collection is the IReadOnlyList<IActionableMissionCollectionBinder>; index it
