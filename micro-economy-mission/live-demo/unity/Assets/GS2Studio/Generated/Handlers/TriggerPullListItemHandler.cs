...
{
    /// <summary>
    /// Mounts onto Binders[index] of a parent ITriggerPullBinderListSource
    /// (the plain TriggerPullListHandler or any ref-scoped variant) and
    ...
    /// </summary>
    [AddComponentMenu("GS2 Studio/DomainType/TriggerPull/TriggerPull List Item Handler")]
    public sealed class TriggerPullListItemHandler : TriggerPullHandlerBase
    {
        ...
        private ITriggerPullBinderListSource? _list;
        ...
        // non-owning IActionableTriggerPullBinder.
        private IActionableTriggerPullBinder? _binder;
        private long _reevaluateGeneration;

        public override IActionableTriggerPullBinder? Binder => _binder;
        // The binder implements <see cref="TriggerPull"/>, so it is the model.
        ...
        /// </summary>
        public void AttachTo(ITriggerPullBinderListSource list, int index)
        {
        ...
        private void Start()
        {
            ...
            var list = GetComponentInParent<ITriggerPullBinderListSource>();
            if (list == null)
            {
                RaiseFailed(new InvalidOperationException(
                    "No ancestor ITriggerPullBinderListSource found in the parent chain."));
                SetContentVisible(false);
                return;
            }
            _list = list;
