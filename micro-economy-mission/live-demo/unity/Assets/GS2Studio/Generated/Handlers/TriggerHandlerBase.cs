...
namespace GS2Studio.Generated.Trigger
{
    ...
    /// TriggerBinder: the standalone/list TriggerHandler and the
    /// slot-bound TriggerListItemHandler. Concrete handlers supply the
    ...
    public abstract class TriggerHandlerBase : MonoBehaviour
    {
        ...
        public event Action<Trigger>? Updated;

        /// <summary>Fires once each time a binder is attached (non-owning actionable view).</summary>
        public event Action<IActionableTriggerBinder>? Bound;
        ...
        protected void RaiseUpdated(Trigger model) => Updated?.Invoke(model);
        protected void RaiseBound(IActionableTriggerBinder binder) => Bound?.Invoke(binder);
