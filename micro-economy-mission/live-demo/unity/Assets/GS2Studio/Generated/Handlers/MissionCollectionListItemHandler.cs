...
{
    /// <summary>
    /// Mounts onto Binders[index] of a parent IMissionCollectionBinderListSource
    /// (the plain MissionCollectionListHandler or any ref-scoped variant) and
    ...
    /// </summary>
    [AddComponentMenu("GS2 Studio/DomainType/MissionCollection/MissionCollection List Item Handler")]
    public sealed class MissionCollectionListItemHandler : MissionCollectionHandlerBase
    {
        ...
        private IMissionCollectionBinderListSource? _list;
        ...
        // non-owning IActionableMissionCollectionBinder.
        private IActionableMissionCollectionBinder? _binder;
        private long _reevaluateGeneration;

        public override IActionableMissionCollectionBinder? Binder => _binder;
        // The binder implements <see cref="MissionCollection"/>, so it is the model.
        ...
        /// </summary>
        public void AttachTo(IMissionCollectionBinderListSource list, int index)
        {
        ...
        private void Start()
        {
            ...
            var list = GetComponentInParent<IMissionCollectionBinderListSource>();
            if (list == null)
            {
                RaiseFailed(new InvalidOperationException(
                    "No ancestor IMissionCollectionBinderListSource found in the parent chain."));
                SetContentVisible(false);
                return;
            }
            _list = list;
