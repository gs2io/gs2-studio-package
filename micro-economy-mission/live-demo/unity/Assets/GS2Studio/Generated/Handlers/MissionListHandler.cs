...
{
    /// <summary>
    /// MonoBehaviour list handler for Mission. Owns a
    /// MissionBinderCollection, instantiates a child MissionListItemHandler
    ...
    /// </summary>
    [AddComponentMenu("GS2 Studio/DomainType/Mission/Mission List Handler")]
    public sealed class MissionListHandler : MonoBehaviour, IMissionBinderListSource
    {
        ...
        /// itself is the IReadOnlyList&lt;IActionableMissionBinder&gt;.</summary>
        public IReadOnlyList<IActionableMissionBinder> Binders =>
            (IReadOnlyList<IActionableMissionBinder>?)_collection ?? Array.Empty<IActionableMissionBinder>();
        ...
        {
            if (!IsCurrentOperation(operationGeneration, collection)) return;
            // The collection is the IReadOnlyList<IActionableMissionBinder>; index it
