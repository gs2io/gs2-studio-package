...
namespace GS2Studio.Generated.TriggerPull
{
    ...
    /// TriggerPullBinder: the standalone/list TriggerPullHandler and the
    /// slot-bound TriggerPullListItemHandler. Concrete handlers supply the
    ...
    public abstract class TriggerPullHandlerBase : MonoBehaviour
    {
        ...
        public event Action<TriggerPull>? Updated;

        /// <summary>Fires once each time a binder is attached (non-owning actionable view).</summary>
        public event Action<IActionableTriggerPullBinder>? Bound;
        ...
        protected void RaiseUpdated(TriggerPull model) => Updated?.Invoke(model);
        protected void RaiseBound(IActionableTriggerPullBinder binder) => Bound?.Invoke(binder);
