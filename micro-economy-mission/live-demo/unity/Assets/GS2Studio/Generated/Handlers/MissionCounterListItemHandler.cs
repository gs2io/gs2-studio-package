...
{
    /// <summary>
    /// Mounts onto Binders[index] of a parent IMissionCounterBinderListSource
    /// (the plain MissionCounterListHandler or any ref-scoped variant) and
    ...
    /// </summary>
    [AddComponentMenu("GS2 Studio/DomainType/MissionCounter/MissionCounter List Item Handler")]
    public sealed class MissionCounterListItemHandler : MissionCounterHandlerBase
    {
        ...
        private IMissionCounterBinderListSource? _list;
        ...
        // non-owning IActionableMissionCounterBinder.
        private IActionableMissionCounterBinder? _binder;
        private long _reevaluateGeneration;

        public override IActionableMissionCounterBinder? Binder => _binder;
        // The binder implements <see cref="MissionCounter"/>, so it is the model.
        ...
        /// </summary>
        public void AttachTo(IMissionCounterBinderListSource list, int index)
        {
        ...
        private void Start()
        {
            ...
            var list = GetComponentInParent<IMissionCounterBinderListSource>();
            if (list == null)
            {
                RaiseFailed(new InvalidOperationException(
                    "No ancestor IMissionCounterBinderListSource found in the parent chain."));
                SetContentVisible(false);
                return;
            }
            _list = list;
