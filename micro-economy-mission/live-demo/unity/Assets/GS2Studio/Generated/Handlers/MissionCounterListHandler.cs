...
{
    /// <summary>
    /// MonoBehaviour list handler for MissionCounter. Owns a
    /// MissionCounterBinderCollection, instantiates a child MissionCounterListItemHandler
    ...
    /// IMissionCounterBinderListSource so items read Binders[Index] through the
    /// shared parent-list surface.
    /// </summary>
    [AddComponentMenu("GS2 Studio/DomainType/MissionCounter/MissionCounter List Handler")]
    public sealed class MissionCounterListHandler : MonoBehaviour, IMissionCounterBinderListSource
    {
        // Which of MissionCounterBinderCollection's mount axes this list reads
        ...
        [SerializeField] private MissionCounterListAxis _axis;
        [SerializeField] private MissionCounterListItemHandler? _itemPrefab;
        ...
        // Construction seam. Defaults to DefaultMissionCounterBinderFactory.Instance;
        // override via SetBinderFactory to substitute a fake collection.
        private IMissionCounterBinderFactory? _binderFactory;

        private IMissionCounterBinderCollection? _collection;
        ...
        private Action<IMissionCounterBinder>? _collectionItemAddedCallback;
        private Action<IMissionCounterBinder>? _collectionItemRemovedCallback;
        ...
        private readonly Dictionary<IActionableMissionCounterBinder, MissionCounterListItemHandler> _handlers =
            new Dictionary<IActionableMissionCounterBinder, MissionCounterListItemHandler>();
        ...
        private IComparer<IReadOnlyMissionCounterBinder>? _comparer;
        ...
        /// itself is the IReadOnlyList&lt;IActionableMissionCounterBinder&gt;.</summary>
        public IReadOnlyList<IActionableMissionCounterBinder> Binders =>
            (IReadOnlyList<IActionableMissionCounterBinder>?)_collection ?? Array.Empty<IActionableMissionCounterBinder>();
        ...
        public event Action<IActionableMissionCounterBinder>? ItemAdded;

        /// <summary>Fires once for each binder removed.</summary>
        public event Action<IActionableMissionCounterBinder>? ItemRemoved;
        ...
        public IComparer<IReadOnlyMissionCounterBinder>? Comparer
        {
            ...
            set
            {
                ...
                // MissionCounterBinderCollection.MissionCounterBinderComparer.
                var applied = value ?? MissionCounterBinderCollection.MissionCounterBinderComparer.Default;
        ...
        /// to substitute a fake MissionCounterBinderCollection; takes precedence over
        /// the default factory. Pass null to revert to the default. Applies to
        /// the next ReloadAsync.
        /// </summary>
        public void SetBinderFactory(IMissionCounterBinderFactory? factory)
        {
            _binderFactory = factory;
        }

        private IMissionCounterBinderFactory ResolveBinderFactory()
            => _binderFactory ?? DefaultMissionCounterBinderFactory.Instance;
        ...
        /// (the MissionCounterBinderCollection only re-sorts on list-membership
        ...
        public async Task ReloadAsync(CancellationToken cancellationToken = default)
        {
            ...
            var operationGeneration = ++_reloadGeneration;
            IMissionCounterBinderCollection? operationCollection = null;
            try
            {
                Cleanup();
                ...
                switch (_axis)
                {
                    case MissionCounterListAxis.MissionMissionMaster:
                        await collection.MountFromMissionMissionMasterDataAsync(cancellationToken);
                        break;
                    case MissionCounterListAxis.ExchangeMissionAdvanceMaster:
                        await collection.MountFromExchangeMissionAdvanceMasterDataAsync(cancellationToken);
                        break;
                    case MissionCounterListAxis.MissionMissionUser:
                ...
                if (_autoSubscribe)
                {
                    ...
                    switch (_axis)
                    {
                        case MissionCounterListAxis.MissionMissionMaster:
                            ...
                            break;
                        case MissionCounterListAxis.ExchangeMissionAdvanceMaster:
                            collection.SubscribeFromExchangeMissionAdvanceMasterData(collectionChanged, collectionFailed);
                            break;
                        case MissionCounterListAxis.MissionMissionUser:
        ...
        private const string AxisMemberNames = "MissionMissionMaster, ExchangeMissionAdvanceMaster, MissionMissionUser";
        ...
        private bool IsCurrentOperation(long operationGeneration, IMissionCounterBinderCollection? operationCollection)
            => !_isDestroyed
        ...
        private void AttachCollectionCallbacks(
            ...
            IMissionCounterBinderCollection collection)
        {
            Action<IMissionCounterBinder> itemAdded = binder =>
                OnItemAdded(operationGeneration, collection, binder);
            Action<IMissionCounterBinder> itemRemoved = binder =>
        ...
        private void OnCollectionChanged(long operationGeneration, IMissionCounterBinderCollection collection)
        {
            if (!IsCurrentOperation(operationGeneration, collection)) return;
        ...
        private int IndexOf(IActionableMissionCounterBinder binder)
        {
            var binders = Binders;
        ...
        {
            if (!IsCurrentOperation(operationGeneration, collection)) return;
            // The collection is the IReadOnlyList<IActionableMissionCounterBinder>; index it
        ...
        private void Cleanup()
        {
            ...
            var handlers = new List<MissionCounterListItemHandler>(_handlers.Values);
            _collection = null;
