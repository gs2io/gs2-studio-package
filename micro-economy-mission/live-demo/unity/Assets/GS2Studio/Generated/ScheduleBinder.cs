...
namespace GS2Studio.Generated.Schedule
{
    ...
    public interface IScheduleBinder : IActionableScheduleBinder, IDisposable
    {
        ...
        void Invalidate();
        Task<GS2Studio.Generated.MissionCollection.IReadOnlyMissionCollectionBinderCollection> GetMissionCollections(CancellationToken cancellationToken = default);
    }
    ...
    public sealed class ScheduleBinder : ReadOnlyScheduleBinder, IScheduleBinder
    {
        ...
        public void Dispose()
        {
            ...
            _missionCollectionsRoot?.Dispose();

            GC.SuppressFinalize(this);
        }

        #region Reference navigation
        public async Task<GS2Studio.Generated.MissionCollection.IReadOnlyMissionCollectionBinderCollection> GetMissionCollections(CancellationToken cancellationToken = default)
        {
            ThrowIfDisposed();
            var root = await EnsureMissionCollectionsRootAsync(cancellationToken);
            return root.WhereSchedule(_model.Id);
        }
        #endregion

        #region Reference navigation roots
        private async Task<GS2Studio.Generated.MissionCollection.MissionCollectionBinderCollection> EnsureMissionCollectionsRootAsync(CancellationToken cancellationToken)
        {
            if (_missionCollectionsRootTask == null)
            {
                _missionCollectionsRootTask = BuildMissionCollectionsRootAsync(cancellationToken);
            }
            var task = _missionCollectionsRootTask;
            GS2Studio.Generated.MissionCollection.MissionCollectionBinderCollection root;
            try
            {
                root = await task;
            }
            ...
            {
                if (ReferenceEquals(_missionCollectionsRootTask, task)) _missionCollectionsRootTask = null;
                throw;
            }

            if (_disposed) { root.Dispose(); ThrowIfDisposed(); }
            _missionCollectionsRoot = root;
            return _missionCollectionsRoot;
        }

        private async Task<GS2Studio.Generated.MissionCollection.MissionCollectionBinderCollection> BuildMissionCollectionsRootAsync(CancellationToken cancellationToken)
        {
            var root = await GS2Studio.Generated.MissionCollection.MissionCollectionBinderCollection.CreateFromMissionMissionMasterDataAsync(_gs2, _session, cancellationToken);
