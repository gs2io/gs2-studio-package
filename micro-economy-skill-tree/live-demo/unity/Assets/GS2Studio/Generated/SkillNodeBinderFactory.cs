...
namespace GS2Studio.Generated.SkillNode
{
    ...
    public sealed class DefaultSkillNodeBinderFactory : ISkillNodeBinderFactory
    {
        ...
        public async Task<ISkillNodeBinder> CreateAsync(
            SkillNodeId id, string owner,
            Gs2Domain gs2,
            IGameSession session,
            CancellationToken cancellationToken = default)
        {
            return await SkillNodeBinder.CreateAsync(id, owner, gs2, session, cancellationToken);
        }
        public ISkillNodeBinderCollection CreateCollection(Gs2Domain gs2, IGameSession session, string owner)
        {
            return new SkillNodeBinderCollection(gs2, session, owner);
        }
    }
}
