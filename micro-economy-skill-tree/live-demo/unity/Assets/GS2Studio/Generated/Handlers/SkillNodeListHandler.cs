...
{
    /// <summary>
    /// MonoBehaviour list handler for SkillNode. Owns a
    /// SkillNodeBinderCollection, instantiates a child SkillNodeListItemHandler
    ...
    /// ISkillNodeBinderListSource so items read Binders[Index] through the
    ...
    public sealed class SkillNodeListHandler : MonoBehaviour, ISkillNodeBinderListSource
    {
        ...
        // Construction seam. Defaults to DefaultSkillNodeBinderFactory.Instance;
        // override via SetBinderFactory to substitute a fake collection.
        private ISkillNodeBinderFactory? _binderFactory;

        private ISkillNodeBinderCollection? _collection;
        ...
        private readonly Dictionary<IActionableSkillNodeBinder, SkillNodeListItemHandler> _handlers =
            new Dictionary<IActionableSkillNodeBinder, SkillNodeListItemHandler>();
        ...
        private IComparer<IReadOnlySkillNodeBinder>? _comparer;
        ...
        /// itself is the IReadOnlyList&lt;IActionableSkillNodeBinder&gt;.</summary>
        public IReadOnlyList<IActionableSkillNodeBinder> Binders =>
            (IReadOnlyList<IActionableSkillNodeBinder>?)_collection ?? Array.Empty<IActionableSkillNodeBinder>();
        ...
        public event Action<IActionableSkillNodeBinder>? ItemRemoved;
        ...
        public IComparer<IReadOnlySkillNodeBinder>? Comparer
        {
            ...
            set
            {
                ...
                // SkillNodeBinderCollection.SkillNodeBinderComparer.
                var applied = value ?? SkillNodeBinderCollection.SkillNodeBinderComparer.Default;
        ...
        /// to substitute a fake SkillNodeBinderCollection; takes precedence over
        /// the default factory. Pass null to revert to the default. Applies to
        /// the next ReloadAsync.
        /// </summary>
        public void SetBinderFactory(ISkillNodeBinderFactory? factory)
        {
            _binderFactory = factory;
        }

        private ISkillNodeBinderFactory ResolveBinderFactory()
            => _binderFactory ?? DefaultSkillNodeBinderFactory.Instance;
        ...
        /// </summary>
        public void SetScope(string owner)
        {
        ...
        /// (the SkillNodeBinderCollection only re-sorts on list-membership
        ...
        public async Task ReloadAsync(CancellationToken cancellationToken = default)
        {
            ...
            var operationGeneration = ++_reloadGeneration;
            ISkillNodeBinderCollection? operationCollection = null;
            try
            {
                Cleanup();
                ...
                var collection = ResolveBinderFactory().CreateCollection(gs2, session, _owner);
                ...
                await collection.MountFromSkillTreeSkillTreeMasterDataAsync(cancellationToken);
                ...
                if (_autoSubscribe)
                {
                    ...
                    collection.SubscribeFromSkillTreeSkillTreeMasterData(collectionChanged, collectionFailed);
                }
        ...
        private bool IsReadyForReload()
        {
            ...
            if (string.IsNullOrEmpty(_owner)) return false;
            return true;
        }

        private bool IsCurrentOperation(long operationGeneration, ISkillNodeBinderCollection? operationCollection)
            => !_isDestroyed
        ...
        private void AttachCollectionCallbacks(
            ...
            ISkillNodeBinderCollection collection)
        {
            Action<ISkillNodeBinder> itemAdded = binder =>
                OnItemAdded(operationGeneration, collection, binder);
            Action<ISkillNodeBinder> itemRemoved = binder =>
        ...
        private void OnCollectionChanged(long operationGeneration, ISkillNodeBinderCollection collection)
        {
            if (!IsCurrentOperation(operationGeneration, collection)) return;
        ...
        private int IndexOf(IActionableSkillNodeBinder binder)
        {
            var binders = Binders;
        ...
        {
            if (!IsCurrentOperation(operationGeneration, collection)) return;
            // The collection is the IReadOnlyList<IActionableSkillNodeBinder>; index it
        ...
        private void Cleanup()
        {
            ...
            var handlers = new List<SkillNodeListItemHandler>(_handlers.Values);
            _collection = null;
