...
namespace GS2Studio.Generated.Character.UI
{
    ...
    public sealed class CharacterPropertyIdValue : MonoBehaviour
    {
        ...
        /// </summary>
        public static readonly string[] RequiredLoaders = { "UserdataInventoryCharacterItemModel", "UserdataSkillTreeSkillTreeNodeModel", "UserdataExperienceCharacterExperienceExperienceModel" };
        ...
        private void WarnUnloadedLoadersOnce()
        {
            ...
            if ((binder.LoadedUserdataInventoryCharacterItemModel || binder.LoadedUserdataSkillTreeSkillTreeNodeModel || binder.LoadedUserdataExperienceCharacterExperienceExperienceModel)) return;
            _warnedUnloadedLoaders = true;
            Debug.LogWarning(
                $"{nameof(CharacterPropertyIdValue)} on '{name}': this row's mount surface did not run UserdataInventoryCharacterItemModel, UserdataSkillTreeSkillTreeNodeModel, UserdataExperienceCharacterExperienceExperienceModel, which fills what this component reads (PropertyId); those readings render as their default, not as an absent value.", this);
        }
