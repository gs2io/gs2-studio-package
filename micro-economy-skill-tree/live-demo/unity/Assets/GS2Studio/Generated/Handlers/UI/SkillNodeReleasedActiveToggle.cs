...
namespace GS2Studio.Generated.SkillNode.UI
{
    ...
    /// based on the condition <c>truthy(released)</c> evaluated
    ...
    /// </summary>
    [AddComponentMenu("GS2 Studio/DomainType/SkillNode/ActiveToggle/ReleasedActiveToggle")]
    public sealed class SkillNodeReleasedActiveToggle : MonoBehaviour
    {
        ...
        private void OnEnable()
        {
            ...
            if (_handler == null)
            {
                ...
                if (!_warnedMissingHandler)
                {
                    ...
                    Debug.LogWarning(
                        $"{nameof(SkillNodeReleasedActiveToggle)} on '{name}': no SkillNodeHandlerBase found in the parent chain; component inactive.", this);
                }
                return;
            }
            if (!_subscribed)
