...
{
    /// <summary>
    /// Mounts onto Binders[index] of a parent ISkillNodeBinderListSource
    /// (the plain SkillNodeListHandler or any ref-scoped variant) and
    ...
    /// </summary>
    [AddComponentMenu("GS2 Studio/DomainType/SkillNode/SkillNode List Item Handler")]
    public sealed class SkillNodeListItemHandler : SkillNodeHandlerBase
    {
        ...
        private ISkillNodeBinderListSource? _list;
        ...
        // non-owning IActionableSkillNodeBinder.
        private IActionableSkillNodeBinder? _binder;
        private long _reevaluateGeneration;

        public override IActionableSkillNodeBinder? Binder => _binder;
        // The binder implements <see cref="SkillNode"/>, so it is the model.
        ...
        /// </summary>
        public void AttachTo(ISkillNodeBinderListSource list, int index)
        {
        ...
        private void Start()
        {
            ...
            var list = GetComponentInParent<ISkillNodeBinderListSource>();
            if (list == null)
            {
                RaiseFailed(new InvalidOperationException(
                    "No ancestor ISkillNodeBinderListSource found in the parent chain."));
                SetContentVisible(false);
                return;
            }
            _list = list;
