...
namespace GS2Studio.Generated.SkillNode
{
    ...
    /// SkillNodeBinder: the standalone/list SkillNodeHandler and the
    /// slot-bound SkillNodeListItemHandler. Concrete handlers supply the
    ...
    public abstract class SkillNodeHandlerBase : MonoBehaviour
    {
        ...
        public event Action<SkillNode>? Updated;

        /// <summary>Fires once each time a binder is attached (non-owning actionable view).</summary>
        public event Action<IActionableSkillNodeBinder>? Bound;
        ...
        protected void RaiseUpdated(SkillNode model) => Updated?.Invoke(model);
        protected void RaiseBound(IActionableSkillNodeBinder binder) => Bound?.Invoke(binder);
