...
namespace GS2Studio.Generated.CharacterExperience
{
    ...
    /// CharacterExperienceBinder: the standalone/list CharacterExperienceHandler and the
    /// slot-bound CharacterExperienceListItemHandler. Concrete handlers supply the
    ...
    /// </summary>
    public abstract class CharacterExperienceHandlerBase : MonoBehaviour
    {
        /// <summary>The bound binder (non-owning actionable view), or null when none is attached.</summary>
        public abstract IActionableCharacterExperienceBinder? Binder { get; }

        /// <summary>The bound model, or null when no binder is attached.</summary>
        public abstract CharacterExperience? Model { get; }
        ...
        public event Action<CharacterExperience>? Updated;

        /// <summary>Fires once each time a binder is attached (non-owning actionable view).</summary>
        public event Action<IActionableCharacterExperienceBinder>? Bound;
        ...
        protected void RaiseUpdated(CharacterExperience model) => Updated?.Invoke(model);
        protected void RaiseBound(IActionableCharacterExperienceBinder binder) => Bound?.Invoke(binder);
