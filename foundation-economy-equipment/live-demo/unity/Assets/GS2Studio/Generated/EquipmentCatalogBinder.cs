...
namespace GS2Studio.Generated.EquipmentCatalog
{
    ...
    public sealed class EquipmentCatalogBinder : ReadOnlyEquipmentCatalogBinder, IEquipmentCatalogBinder
    {
        ...
        public static bool RestoreEquipment(IMutableEquipmentCatalog model, string actionName, string requestJson)
        {
            ...
            if (actionName == "Gs2Inventory:AcquireItemSetByUserId" && ReadRequestValue(request, new string[] { "namespaceName" }) == "Equipment" && ReadRequestValue(request, new string[] { "inventoryName" }) == "Equipment")
            {
