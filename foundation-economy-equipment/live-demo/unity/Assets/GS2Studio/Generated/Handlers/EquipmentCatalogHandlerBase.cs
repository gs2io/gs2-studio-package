...
namespace GS2Studio.Generated.EquipmentCatalog
{
    ...
    /// EquipmentCatalogBinder: the standalone/list EquipmentCatalogHandler and the
    /// slot-bound EquipmentCatalogListItemHandler. Concrete handlers supply the
    ...
    /// </summary>
    public abstract class EquipmentCatalogHandlerBase : MonoBehaviour
    {
        /// <summary>The bound binder (non-owning actionable view), or null when none is attached.</summary>
        public abstract IActionableEquipmentCatalogBinder? Binder { get; }

        /// <summary>The bound model, or null when no binder is attached.</summary>
        public abstract EquipmentCatalog? Model { get; }
        ...
        public event Action<EquipmentCatalog>? Updated;

        /// <summary>Fires once each time a binder is attached (non-owning actionable view).</summary>
        public event Action<IActionableEquipmentCatalogBinder>? Bound;
        ...
        protected void RaiseUpdated(EquipmentCatalog model) => Updated?.Invoke(model);
        protected void RaiseBound(IActionableEquipmentCatalogBinder binder) => Bound?.Invoke(binder);
