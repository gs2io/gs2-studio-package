...
namespace GS2Studio.Generated.Equipment.UI
{
    ...
    /// substituted with the resolved value from <c>Equipment</c>
    ...
    /// </summary>
    [AddComponentMenu("GS2 Studio/DomainType/Equipment/TemplateLabel/NameLabel")]
    public sealed class EquipmentNameLabel : MonoBehaviour
    {
        ...
        private void OnEnable()
        {
            ...
            if (_handler == null)
            {
                ...
                if (!_warnedMissingHandler)
                {
                    ...
                    Debug.LogWarning(
                        $"{nameof(EquipmentNameLabel)} on '{name}': no EquipmentHandlerBase found in the parent chain; component inactive.", this);
                }
                return;
            }
            if (!_subscribed)
