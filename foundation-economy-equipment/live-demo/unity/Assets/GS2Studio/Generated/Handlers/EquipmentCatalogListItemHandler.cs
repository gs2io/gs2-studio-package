...
{
    /// <summary>
    /// Mounts onto Binders[index] of a parent IEquipmentCatalogBinderListSource
    /// (the plain EquipmentCatalogListHandler or any ref-scoped variant) and
    ...
    /// </summary>
    [AddComponentMenu("GS2 Studio/DomainType/EquipmentCatalog/EquipmentCatalog List Item Handler")]
    public sealed class EquipmentCatalogListItemHandler : EquipmentCatalogHandlerBase
    {
        ...
        private IEquipmentCatalogBinderListSource? _list;
        ...
        // non-owning IActionableEquipmentCatalogBinder.
        private IActionableEquipmentCatalogBinder? _binder;

        public override IActionableEquipmentCatalogBinder? Binder => _binder;
        // The binder implements <see cref="EquipmentCatalog"/>, so it is the model.
        ...
        /// </summary>
        public void AttachTo(IEquipmentCatalogBinderListSource list, int index)
        {
        ...
        private void Start()
        {
            ...
            var list = GetComponentInParent<IEquipmentCatalogBinderListSource>();
            if (list == null)
            {
                RaiseFailed(new InvalidOperationException(
                    "No ancestor IEquipmentCatalogBinderListSource found in the parent chain."));
                SetContentVisible(false);
                return;
            }
            _list = list;
