...
namespace GS2Studio.Generated.Character
{
    ...
    public sealed class CharacterListHandler : MonoBehaviour, ICharacterBinderListSource
    {
        ...
        /// </summary>
        public void SetScope(string propertyId)
        {
        ...
        public async Task ReloadAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var collection = ResolveBinderFactory().CreateCollection(gs2, session, _propertyId);
                ...
                switch (_axis)
                {
                    ...
                    case CharacterListAxis.InventoryCharacterUser:
                        ...
                        break;
                    case CharacterListAxis.DictionaryCharacterDictionaryUser:
                        await collection.MountFromDictionaryCharacterDictionaryUserDataAsync(cancellationToken);
                        break;
                }
                ...
                if (_autoSubscribe)
                {
                    ...
                    switch (_axis)
                    {
                        ...
                        case CharacterListAxis.InventoryCharacterUser:
                            ...
                            break;
                        case CharacterListAxis.DictionaryCharacterDictionaryUser:
                            collection.SubscribeFromDictionaryCharacterDictionaryUserData(collectionChanged, collectionFailed);
                            break;
                    }
                }
        ...
        private const string AxisMemberNames = "InventoryCharacterMaster, ExchangeCharacterTrainMaster, DictionaryCharacterDictionaryMaster, ExchangeCharacterDexRecruitMaster, InventoryCharacterUser, DictionaryCharacterDictionaryUser";
