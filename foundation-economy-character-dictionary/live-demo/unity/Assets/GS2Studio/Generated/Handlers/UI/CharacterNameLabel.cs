...
namespace GS2Studio.Generated.Character.UI
{
    ...
    /// </summary>
    [AddComponentMenu("GS2 Studio/DomainType/Character/TemplateLabel/NameLabel")]
        ...
        private void OnEnable()
        {
            ...
            if (_handler == null)
            {
                ...
                if (!_warnedMissingHandler)
                {
                    ...
                    Debug.LogWarning(
                        $"{nameof(CharacterNameLabel)} on '{name}': no CharacterHandlerBase found in the parent chain; component inactive.", this);
                }
                return;
            }
            if (!_subscribed)
