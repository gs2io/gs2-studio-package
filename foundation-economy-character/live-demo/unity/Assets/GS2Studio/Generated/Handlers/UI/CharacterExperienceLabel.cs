...
{
    /// <summary>
    /// UI label bound to <c>Character.experience</c>.
    ...
    /// supplied.
    /// </summary>
    [AddComponentMenu("GS2 Studio/DomainType/Character/Label/ExperienceLabel")]
    public sealed class CharacterExperienceLabel : MonoBehaviour
    {
        ...
        private void OnEnable()
        {
            ...
            if (_handler == null)
            {
                ...
                if (!_warnedMissingHandler)
                {
                    ...
                    Debug.LogWarning(
                        $"{nameof(CharacterExperienceLabel)} on '{name}': no CharacterHandlerBase found in the parent chain; component inactive.", this);
                }
                return;
            }
            if (!_subscribed)
        ...
        {
            _onUpdate.Invoke(System.Convert.ToString(model.Experience) ?? "");
        }
    }
}
