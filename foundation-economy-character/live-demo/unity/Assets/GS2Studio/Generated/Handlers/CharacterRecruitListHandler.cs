...
{
    /// <summary>
    /// MonoBehaviour list handler for CharacterRecruit. Owns a
    /// CharacterRecruitBinderCollection, instantiates a child CharacterRecruitListItemHandler
    ...
    /// </summary>
    [AddComponentMenu("GS2 Studio/DomainType/CharacterRecruit/CharacterRecruit List Handler")]
    public sealed class CharacterRecruitListHandler : MonoBehaviour, ICharacterRecruitBinderListSource
    {
        ...
        /// The collection itself is the IReadOnlyList&lt;IActionableCharacterRecruitBinder&gt;.</summary>
        public IReadOnlyList<IActionableCharacterRecruitBinder> Binders =>
            (IReadOnlyList<IActionableCharacterRecruitBinder>?)_collection ?? Array.Empty<IActionableCharacterRecruitBinder>();
        ...
        {
            if (_collection == null) return;
            // The collection is the IReadOnlyList<IActionableCharacterRecruitBinder>; index it
