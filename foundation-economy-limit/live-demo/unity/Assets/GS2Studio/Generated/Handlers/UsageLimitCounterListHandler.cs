...
{
    /// <summary>
    /// MonoBehaviour list handler for UsageLimitCounter. Owns a
    /// UsageLimitCounterBinderCollection, instantiates a child UsageLimitCounterListItemHandler
    ...
    /// </summary>
    [AddComponentMenu("GS2 Studio/DomainType/UsageLimitCounter/UsageLimitCounter List Handler")]
    public sealed class UsageLimitCounterListHandler : MonoBehaviour, IUsageLimitCounterBinderListSource
    {
        ...
        /// itself is the IReadOnlyList&lt;IActionableUsageLimitCounterBinder&gt;.</summary>
        public IReadOnlyList<IActionableUsageLimitCounterBinder> Binders =>
            (IReadOnlyList<IActionableUsageLimitCounterBinder>?)_collection ?? Array.Empty<IActionableUsageLimitCounterBinder>();
        ...
        {
            if (!IsCurrentOperation(operationGeneration, collection)) return;
            // The collection is the IReadOnlyList<IActionableUsageLimitCounterBinder>; index it
