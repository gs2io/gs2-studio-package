...
{
    /// <summary>
    /// Mounts onto Binders[index] of a parent IUsageLimitCounterBinderListSource
    /// (the plain UsageLimitCounterListHandler or any ref-scoped variant) and
    ...
    /// </summary>
    [AddComponentMenu("GS2 Studio/DomainType/UsageLimitCounter/UsageLimitCounter List Item Handler")]
    public sealed class UsageLimitCounterListItemHandler : UsageLimitCounterHandlerBase
    {
        ...
        private IUsageLimitCounterBinderListSource? _list;
        ...
        // non-owning IActionableUsageLimitCounterBinder.
        private IActionableUsageLimitCounterBinder? _binder;

        public override IActionableUsageLimitCounterBinder? Binder => _binder;
        // The binder implements <see cref="UsageLimitCounter"/>, so it is the model.
        ...
        /// </summary>
        public void AttachTo(IUsageLimitCounterBinderListSource list, int index)
        {
        ...
        private void Start()
        {
            ...
            var list = GetComponentInParent<IUsageLimitCounterBinderListSource>();
            if (list == null)
            {
                RaiseFailed(new InvalidOperationException(
                    "No ancestor IUsageLimitCounterBinderListSource found in the parent chain."));
                SetContentVisible(false);
                return;
            }
            _list = list;
