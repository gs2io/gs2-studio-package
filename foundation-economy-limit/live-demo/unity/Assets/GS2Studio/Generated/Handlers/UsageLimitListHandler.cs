...
{
    /// <summary>
    /// MonoBehaviour list handler for UsageLimit. Owns a
    /// UsageLimitBinderCollection, instantiates a child UsageLimitListItemHandler
    ...
    /// IUsageLimitBinderListSource so items read Binders[Index] through the
    ...
    public sealed class UsageLimitListHandler : MonoBehaviour, IUsageLimitBinderListSource
    {
        ...
        // Construction seam. Defaults to DefaultUsageLimitBinderFactory.Instance;
        // override via SetBinderFactory to substitute a fake collection.
        private IUsageLimitBinderFactory? _binderFactory;

        private IUsageLimitBinderCollection? _collection;
        ...
        private readonly Dictionary<IActionableUsageLimitBinder, UsageLimitListItemHandler> _handlers =
            new Dictionary<IActionableUsageLimitBinder, UsageLimitListItemHandler>();
        ...
        private IComparer<IReadOnlyUsageLimitBinder>? _comparer;
        ...
        /// itself is the IReadOnlyList&lt;IActionableUsageLimitBinder&gt;.</summary>
        public IReadOnlyList<IActionableUsageLimitBinder> Binders =>
            (IReadOnlyList<IActionableUsageLimitBinder>?)_collection ?? Array.Empty<IActionableUsageLimitBinder>();
        ...
        public event Action<IActionableUsageLimitBinder>? ItemRemoved;
        ...
        public IComparer<IReadOnlyUsageLimitBinder>? Comparer
        {
            ...
            set
            {
                ...
                // UsageLimitBinderCollection.UsageLimitBinderComparer.
                var applied = value ?? UsageLimitBinderCollection.UsageLimitBinderComparer.Default;
        ...
        /// to substitute a fake UsageLimitBinderCollection; takes precedence over
        /// the default factory. Pass null to revert to the default. Applies to
        /// the next ReloadAsync.
        /// </summary>
        public void SetBinderFactory(IUsageLimitBinderFactory? factory)
        {
            _binderFactory = factory;
        }

        private IUsageLimitBinderFactory ResolveBinderFactory()
            => _binderFactory ?? DefaultUsageLimitBinderFactory.Instance;
        ...
        /// (the UsageLimitBinderCollection only re-sorts on list-membership
        ...
        public async Task ReloadAsync(CancellationToken cancellationToken = default)
        {
            ...
            var operationGeneration = ++_reloadGeneration;
            IUsageLimitBinderCollection? operationCollection = null;
            try
            {
                Cleanup();
                ...
                await collection.MountFromLimitLimitMasterDataAsync(cancellationToken);
                ...
                if (_autoSubscribe)
                {
                    ...
                    collection.SubscribeFromLimitLimitMasterData(collectionChanged, collectionFailed);
                }
        ...
        private bool IsCurrentOperation(long operationGeneration, IUsageLimitBinderCollection? operationCollection)
            => !_isDestroyed
        ...
        private void AttachCollectionCallbacks(
            ...
            IUsageLimitBinderCollection collection)
        {
            Action<IUsageLimitBinder> itemAdded = binder =>
                OnItemAdded(operationGeneration, collection, binder);
            Action<IUsageLimitBinder> itemRemoved = binder =>
        ...
        private void OnCollectionChanged(long operationGeneration, IUsageLimitBinderCollection collection)
        {
            if (!IsCurrentOperation(operationGeneration, collection)) return;
        ...
        private int IndexOf(IActionableUsageLimitBinder binder)
        {
            var binders = Binders;
        ...
        {
            if (!IsCurrentOperation(operationGeneration, collection)) return;
            // The collection is the IReadOnlyList<IActionableUsageLimitBinder>; index it
        ...
        private void Cleanup()
        {
            ...
            var handlers = new List<UsageLimitListItemHandler>(_handlers.Values);
            _collection = null;
