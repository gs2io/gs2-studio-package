...
{
    /// <summary>
    /// Mounts onto Binders[index] of a parent IUsageLimitBinderListSource
    /// (the plain UsageLimitListHandler or any ref-scoped variant) and
    ...
    /// </summary>
    [AddComponentMenu("GS2 Studio/DomainType/UsageLimit/UsageLimit List Item Handler")]
    public sealed class UsageLimitListItemHandler : UsageLimitHandlerBase
    {
        ...
        private IUsageLimitBinderListSource? _list;
        ...
        // non-owning IActionableUsageLimitBinder.
        private IActionableUsageLimitBinder? _binder;
        private long _reevaluateGeneration;

        public override IActionableUsageLimitBinder? Binder => _binder;
        // The binder implements <see cref="UsageLimit"/>, so it is the model.
        ...
        /// </summary>
        public void AttachTo(IUsageLimitBinderListSource list, int index)
        {
        ...
        private void Start()
        {
            ...
            var list = GetComponentInParent<IUsageLimitBinderListSource>();
            if (list == null)
            {
                RaiseFailed(new InvalidOperationException(
                    "No ancestor IUsageLimitBinderListSource found in the parent chain."));
                SetContentVisible(false);
                return;
            }
            _list = list;
