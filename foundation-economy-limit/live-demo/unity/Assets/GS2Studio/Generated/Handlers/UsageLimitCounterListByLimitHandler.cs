...
{
    /// <summary>
    /// MonoBehaviour list handler for UsageLimitCounter scoped by the
    /// Limit reference. Auto-resolves a parent
    /// UsageLimitHandlerBase from the GameObject hierarchy, owns a
    /// UsageLimitCounterBinderCollection, and instantiates a child
    /// UsageLimitCounterListItemHandler only for the binders whose
    /// Limit equals the parent's id. Implements
    /// IUsageLimitCounterBinderListSource so items read Binders[Index] through the
    /// shared parent-list surface.
    /// </summary>
    [AddComponentMenu("GS2 Studio/DomainType/UsageLimitCounter/UsageLimitCounter List By Limit Handler")]
    public sealed class UsageLimitCounterListByLimitHandler : MonoBehaviour, IUsageLimitCounterBinderListSource
    {
        // Which of UsageLimitCounterBinderCollection's mount axes this list reads
        ...
        // them.
        [SerializeField] private UsageLimitCounterListAxis _axis;
        ...
        [SerializeField] private UsageLimitHandlerBase? _parentHandler;
        [SerializeField] private UsageLimitCounterListItemHandler? _itemPrefab;
        ...
        // Construction seam. Defaults to DefaultUsageLimitCounterBinderFactory.Instance;
        // override via SetBinderFactory to substitute a fake collection.
        private IUsageLimitCounterBinderFactory? _binderFactory;

        private IUsageLimitCounterBinderCollection? _collection;
        ...
        private Action<IUsageLimitCounterBinder>? _collectionItemAddedCallback;
        private Action<IUsageLimitCounterBinder>? _collectionItemRemovedCallback;
        ...
        private UsageLimitHandlerBase? _subscribedParent;
        ...
        private UsageLimitId _parentId;
        ...
        // binders' handlers.
        private readonly Dictionary<IActionableUsageLimitCounterBinder, UsageLimitCounterListItemHandler> _handlers =
            new Dictionary<IActionableUsageLimitCounterBinder, UsageLimitCounterListItemHandler>();
        ...
        private readonly Dictionary<IActionableUsageLimitCounterBinder, IUsageLimitCounterBinder> _binderByView =
            new Dictionary<IActionableUsageLimitCounterBinder, IUsageLimitCounterBinder>();
        ...
        private readonly List<IActionableUsageLimitCounterBinder> _visibleBinders =
            new List<IActionableUsageLimitCounterBinder>();
        ...
        private IComparer<IReadOnlyUsageLimitCounterBinder>? _comparer;
        ...
        public IReadOnlyList<IActionableUsageLimitCounterBinder> Binders => _visibleBinders;
        ...
        public event Action<IActionableUsageLimitCounterBinder>? ItemAdded;
        ...
        public event Action<IActionableUsageLimitCounterBinder>? ItemRemoved;
        ...
        public IComparer<IReadOnlyUsageLimitCounterBinder>? Comparer
        {
            ...
            set
            {
                ...
                // UsageLimitCounterBinderCollection.UsageLimitCounterBinderComparer.
                var applied = value ?? UsageLimitCounterBinderCollection.UsageLimitCounterBinderComparer.Default;
        ...
        /// to substitute a fake UsageLimitCounterBinderCollection; takes precedence over
        /// the default factory. Pass null to revert to the default. Applies to
        /// the next ReloadAsync.
        /// </summary>
        public void SetBinderFactory(IUsageLimitCounterBinderFactory? factory)
        {
            _binderFactory = factory;
        }

        private IUsageLimitCounterBinderFactory ResolveBinderFactory()
        ...
        public async Task ReloadAsync(CancellationToken cancellationToken = default)
        {
            ...
            var operationGeneration = ++_reloadGeneration;
            IUsageLimitCounterBinderCollection? operationCollection = null;
            try
            {
                Cleanup();
                ...
                if (_parentHandler == null)
                    throw new InvalidOperationException("Parent UsageLimitHandlerBase is not assigned and none was found in the parent hierarchy.");
                SubscribeParent();
                var parentBinder = _parentHandler.Binder;
                if (parentBinder == null)
                    throw new InvalidOperationException("Parent UsageLimitHandlerBase has no bound binder yet.");
                _parentId = parentBinder.Id;

                var collection = ResolveBinderFactory().CreateCollection(gs2, session, new UsageLimitId(_limit ?? string.Empty));
        ...
        private void ResolveParentHandler()
        {
            ...
            // UsageLimitHandlerBase GameObject.
            if (_parentHandler == null)
            {
                _parentHandler = GetComponentInParent<UsageLimitHandlerBase>();
            }
        }
        ...
        /// </summary>
        private void OnParentBound(IActionableUsageLimitBinder binder)
        {
            _parentId = binder.Id;
            var collection = _collection;
            if (collection == null) return;
        ...
        // WhereLimit match helper on the Collection.
        private bool MatchesParent(IReadOnlyUsageLimitCounterBinder binder)
            => EqualityComparer<UsageLimitId>.Default.Equals(binder.Limit, _parentId);

        private bool IsCurrentOperation(long operationGeneration, IUsageLimitCounterBinderCollection? operationCollection)
            => !_isDestroyed
        ...
        {
            Action<IUsageLimitCounterBinder> itemAdded = binder =>
                OnItemAdded(operationGeneration, collection, binder);
            Action<IUsageLimitCounterBinder> itemRemoved = binder =>
        ...
        private void OnItemAdded(
            long operationGeneration,
            IUsageLimitCounterBinderCollection collection,
            IUsageLimitCounterBinder binder)
        {
            if (!IsCurrentOperation(operationGeneration, collection)) return;
        ...
        private void OnCollectionChanged(long operationGeneration, IUsageLimitCounterBinderCollection collection)
        {
            if (!IsCurrentOperation(operationGeneration, collection)) return;
        ...
        private int IndexOf(IActionableUsageLimitCounterBinder binder)
        {
        ...
        private void DestroyItem(IActionableUsageLimitCounterBinder binder)
        {
            ...
            IUsageLimitCounterBinderCollection collection)
        {
            ...
            var visibleSet = new HashSet<IActionableUsageLimitCounterBinder>(_visibleBinders);
        ...
        private void Cleanup()
        {
            ...
            var handlers = new List<UsageLimitCounterListItemHandler>(_handlers.Values);
            _collection = null;
