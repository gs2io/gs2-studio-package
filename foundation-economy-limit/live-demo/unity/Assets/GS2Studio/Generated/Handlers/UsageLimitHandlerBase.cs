...
namespace GS2Studio.Generated.UsageLimit
{
    ...
    /// UsageLimitBinder: the standalone/list UsageLimitHandler and the
    /// slot-bound UsageLimitListItemHandler. Concrete handlers supply the
    ...
    public abstract class UsageLimitHandlerBase : MonoBehaviour
    {
        ...
        public event Action<UsageLimit>? Updated;

        /// <summary>Fires once each time a binder is attached (non-owning actionable view).</summary>
        public event Action<IActionableUsageLimitBinder>? Bound;
        ...
        protected void RaiseUpdated(UsageLimit model) => Updated?.Invoke(model);
        protected void RaiseBound(IActionableUsageLimitBinder binder) => Bound?.Invoke(binder);
