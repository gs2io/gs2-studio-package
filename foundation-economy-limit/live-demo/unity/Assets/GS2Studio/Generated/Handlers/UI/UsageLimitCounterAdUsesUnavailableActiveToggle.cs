...
namespace GS2Studio.Generated.UsageLimitCounter.UI
{
    ...
    /// based on the condition <c>or(lt(count, freeMax), gte(count, adMax))</c> evaluated
    ...
    /// </summary>
    [AddComponentMenu("GS2 Studio/DomainType/UsageLimitCounter/ActiveToggle/AdUsesUnavailableActiveToggle")]
    public sealed class UsageLimitCounterAdUsesUnavailableActiveToggle : MonoBehaviour
    {
        ...
        private void OnEnable()
        {
            ...
            if (_handler == null)
            {
                ...
                if (!_warnedMissingHandler)
                {
                    ...
                    Debug.LogWarning(
                        $"{nameof(UsageLimitCounterAdUsesUnavailableActiveToggle)} on '{name}': no UsageLimitCounterHandlerBase found in the parent chain; component inactive.", this);
                }
                return;
            }
            if (!_subscribed)
        ...
        {
            bool result = ((System.Convert.ToInt64(model.Count, System.Globalization.CultureInfo.InvariantCulture) < System.Convert.ToInt64(model.FreeMax, System.Globalization.CultureInfo.InvariantCulture)) || (System.Convert.ToInt64(model.Count, System.Globalization.CultureInfo.InvariantCulture) >= System.Convert.ToInt64(model.AdMax, System.Globalization.CultureInfo.InvariantCulture)));
