...
namespace GS2Studio.Generated.UsageLimitCounter.UI
{
    ...
    /// based on the condition <c>lt(count, adMax)</c> evaluated
    ...
    /// </summary>
    [AddComponentMenu("GS2 Studio/DomainType/UsageLimitCounter/ActiveToggle/AnyUseLeftActiveToggle")]
    public sealed class UsageLimitCounterAnyUseLeftActiveToggle : MonoBehaviour
    {
        ...
        private void OnEnable()
        {
            ...
            if (_handler == null)
            {
                ...
                if (!_warnedMissingHandler)
                {
                    ...
                    Debug.LogWarning(
                        $"{nameof(UsageLimitCounterAnyUseLeftActiveToggle)} on '{name}': no UsageLimitCounterHandlerBase found in the parent chain; component inactive.", this);
                }
                return;
            }
            if (!_subscribed)
        ...
        {
            bool result = (System.Convert.ToInt64(model.Count, System.Globalization.CultureInfo.InvariantCulture) < System.Convert.ToInt64(model.AdMax, System.Globalization.CultureInfo.InvariantCulture));
