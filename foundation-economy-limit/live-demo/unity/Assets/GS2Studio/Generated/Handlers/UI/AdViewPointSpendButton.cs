...
namespace GS2Studio.Generated.AdViewPoint.UI
{
    ...
    /// to <c>AdViewPointHandlerBase.Binder.Spend</c> and forwards the
    ...
    /// </summary>
    [AddComponentMenu("GS2 Studio/DomainType/AdViewPoint/ButtonAction/SpendButton")]
    public sealed class AdViewPointSpendButton : MonoBehaviour
    {
        ...
        private async void OnClicked()
        {
            ...
            if (_handler == null)
            {
                ...
                if (!_warnedMissingHandler)
                {
                    ...
                    Debug.LogWarning(
                        $"{nameof(AdViewPointSpendButton)} on '{name}': no AdViewPointHandlerBase found in the parent chain; click ignored.", this);
                }
                return;
            }
            ...
            {
                UnityEngine.Debug.LogError($"AdViewPointSpendButton: Spend failed: {gs2Error}");
            ...
            {
                UnityEngine.Debug.LogError($"AdViewPointSpendButton: Spend failed: {ex}");
                return;
            }
            finally
            {
