...
namespace GS2Studio.Generated.UsageLimit.UI
{
    /// <summary>
    ...
    /// </summary>
    [AddComponentMenu("GS2 Studio/DomainType/UsageLimit/TemplateLabel/ScheduleLabel")]
    public sealed class UsageLimitScheduleLabel : MonoBehaviour
    {
        [Gs2AutoResolvedHandler]
        [SerializeField] private UsageLimitHandlerBase? _handler;
        ...
        private void OnEnable()
        {
            ...
            if (_handler == null)
            {
                ...
                if (!_warnedMissingHandler)
                {
                    ...
                    Debug.LogWarning(
                        $"{nameof(UsageLimitScheduleLabel)} on '{name}': no UsageLimitHandlerBase found in the parent chain; component inactive.", this);
                }
                return;
            }
            if (!_subscribed)
        ...
        {
            if (_handler == null) _handler = GetComponentInParent<UsageLimitHandlerBase>();
        }
