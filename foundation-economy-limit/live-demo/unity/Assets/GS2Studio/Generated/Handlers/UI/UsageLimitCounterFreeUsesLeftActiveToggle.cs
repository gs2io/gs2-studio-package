...
namespace GS2Studio.Generated.UsageLimitCounter.UI
{
    ...
    /// based on the condition <c>lt(count, freeMax)</c> evaluated
    ...
    /// </summary>
    [AddComponentMenu("GS2 Studio/DomainType/UsageLimitCounter/ActiveToggle/FreeUsesLeftActiveToggle")]
    public sealed class UsageLimitCounterFreeUsesLeftActiveToggle : MonoBehaviour
    {
        ...
        private void OnEnable()
        {
            ...
            if (_handler == null)
            {
                ...
                if (!_warnedMissingHandler)
                {
                    ...
                    Debug.LogWarning(
                        $"{nameof(UsageLimitCounterFreeUsesLeftActiveToggle)} on '{name}': no UsageLimitCounterHandlerBase found in the parent chain; component inactive.", this);
                }
                return;
            }
            if (!_subscribed)
