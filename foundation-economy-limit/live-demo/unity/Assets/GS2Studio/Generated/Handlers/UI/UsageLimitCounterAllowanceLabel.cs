...
namespace GS2Studio.Generated.UsageLimitCounter.UI
{
    ...
    /// <c>{count} of {free} used</c>. Each <c>{key}</c> placeholder is
    ...
    /// </summary>
    [AddComponentMenu("GS2 Studio/DomainType/UsageLimitCounter/TemplateLabel/AllowanceLabel")]
    public sealed class UsageLimitCounterAllowanceLabel : MonoBehaviour
    {
        ...
        private void OnEnable()
        {
            ...
            if (_handler == null)
            {
                ...
                if (!_warnedMissingHandler)
                {
                    ...
                    Debug.LogWarning(
                        $"{nameof(UsageLimitCounterAllowanceLabel)} on '{name}': no UsageLimitCounterHandlerBase found in the parent chain; component inactive.", this);
                }
                return;
            }
            if (!_subscribed)
