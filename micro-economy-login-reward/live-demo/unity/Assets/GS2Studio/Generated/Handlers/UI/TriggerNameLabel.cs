...
namespace GS2Studio.Generated.Trigger.UI
{
    ...
    /// substituted with the resolved value from <c>Trigger</c>
    ...
    /// </summary>
    [AddComponentMenu("GS2 Studio/DomainType/Trigger/TemplateLabel/NameLabel")]
    public sealed class TriggerNameLabel : MonoBehaviour
    {
        ...
        private void OnEnable()
        {
            ...
            if (_handler == null)
            {
                ...
                if (!_warnedMissingHandler)
                {
                    ...
                    Debug.LogWarning(
                        $"{nameof(TriggerNameLabel)} on '{name}': no TriggerHandlerBase found in the parent chain; component inactive.", this);
                }
                return;
            }
            if (!_subscribed)
