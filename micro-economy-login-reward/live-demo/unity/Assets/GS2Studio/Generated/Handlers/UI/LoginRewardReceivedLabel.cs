...
namespace GS2Studio.Generated.LoginReward.UI
{
    ...
    /// <c>Received</c>. Each <c>{key}</c> placeholder is
    ...
    /// </summary>
    [AddComponentMenu("GS2 Studio/DomainType/LoginReward/TemplateLabel/ReceivedLabel")]
    public sealed class LoginRewardReceivedLabel : MonoBehaviour
    {
        ...
        private void OnEnable()
        {
            ...
            if (_handler == null)
            {
                ...
                if (!_warnedMissingHandler)
                {
                    ...
                    Debug.LogWarning(
                        $"{nameof(LoginRewardReceivedLabel)} on '{name}': no LoginRewardHandlerBase found in the parent chain; component inactive.", this);
                }
                return;
            }
            if (!_subscribed)
