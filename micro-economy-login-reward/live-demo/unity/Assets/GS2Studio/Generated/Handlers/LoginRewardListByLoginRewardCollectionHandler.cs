...
{
    /// <summary>
    /// MonoBehaviour list handler for LoginReward scoped by the
    /// LoginRewardCollection reference. Auto-resolves a parent
    /// LoginRewardCollectionHandlerBase from the GameObject hierarchy, owns a
    /// LoginRewardBinderCollection, and instantiates a child
    /// LoginRewardListItemHandler only for the binders whose
    /// LoginRewardCollection equals the parent's id. Implements
    /// ILoginRewardBinderListSource so items read Binders[Index] through the
    /// shared parent-list surface.
    /// </summary>
    [AddComponentMenu("GS2 Studio/DomainType/LoginReward/LoginReward List By LoginRewardCollection Handler")]
    public sealed class LoginRewardListByLoginRewardCollectionHandler : MonoBehaviour, ILoginRewardBinderListSource
    {
        [SerializeField] private string? _loginRewardCollection;
        ...
        [SerializeField] private LoginRewardCollectionHandlerBase? _parentHandler;
        [SerializeField] private LoginRewardListItemHandler? _itemPrefab;
        ...
        // Construction seam. Defaults to DefaultLoginRewardBinderFactory.Instance;
        // override via SetBinderFactory to substitute a fake collection.
        private ILoginRewardBinderFactory? _binderFactory;

        private ILoginRewardBinderCollection? _collection;
        ...
        private Action<ILoginRewardBinder>? _collectionItemAddedCallback;
        private Action<ILoginRewardBinder>? _collectionItemRemovedCallback;
        ...
        private LoginRewardCollectionHandlerBase? _subscribedParent;
        ...
        private LoginRewardCollectionId _parentId;
        ...
        // binders' handlers.
        private readonly Dictionary<IActionableLoginRewardBinder, LoginRewardListItemHandler> _handlers =
            new Dictionary<IActionableLoginRewardBinder, LoginRewardListItemHandler>();
        ...
        private readonly Dictionary<IActionableLoginRewardBinder, ILoginRewardBinder> _binderByView =
            new Dictionary<IActionableLoginRewardBinder, ILoginRewardBinder>();
        ...
        private readonly List<IActionableLoginRewardBinder> _visibleBinders =
            new List<IActionableLoginRewardBinder>();
        ...
        private IComparer<IReadOnlyLoginRewardBinder>? _comparer;
        ...
        public IReadOnlyList<IActionableLoginRewardBinder> Binders => _visibleBinders;
        ...
        public event Action<IActionableLoginRewardBinder>? ItemAdded;
        ...
        public event Action<IActionableLoginRewardBinder>? ItemRemoved;
        ...
        public IComparer<IReadOnlyLoginRewardBinder>? Comparer
        {
            ...
            set
            {
                ...
                // LoginRewardBinderCollection.LoginRewardBinderComparer.
                var applied = value ?? LoginRewardBinderCollection.LoginRewardBinderComparer.Default;
        ...
        /// to substitute a fake LoginRewardBinderCollection; takes precedence over
        /// the default factory. Pass null to revert to the default. Applies to
        /// the next ReloadAsync.
        /// </summary>
        public void SetBinderFactory(ILoginRewardBinderFactory? factory)
        {
            _binderFactory = factory;
        }

        private ILoginRewardBinderFactory ResolveBinderFactory()
            => _binderFactory ?? DefaultLoginRewardBinderFactory.Instance;
        ...
        /// </summary>
        public void SetScope(string loginRewardCollection)
        {
        ...
        /// (the LoginRewardBinderCollection only re-sorts on list-membership
        ...
        public async Task ReloadAsync(CancellationToken cancellationToken = default)
        {
            ...
            var operationGeneration = ++_reloadGeneration;
            ILoginRewardBinderCollection? operationCollection = null;
            try
            {
                Cleanup();
                ...
                if (_parentHandler == null)
                    throw new InvalidOperationException("Parent LoginRewardCollectionHandlerBase is not assigned and none was found in the parent hierarchy.");
                SubscribeParent();
                var parentBinder = _parentHandler.Binder;
                if (parentBinder == null)
                    throw new InvalidOperationException("Parent LoginRewardCollectionHandlerBase has no bound binder yet.");
                _parentId = parentBinder.Id;

                var collection = ResolveBinderFactory().CreateCollection(gs2, session, new LoginRewardCollectionId(_loginRewardCollection ?? string.Empty));
        ...
        private void ResolveParentHandler()
        {
            ...
            // LoginRewardCollectionHandlerBase GameObject.
            if (_parentHandler == null)
            {
                _parentHandler = GetComponentInParent<LoginRewardCollectionHandlerBase>();
            }
        }
        ...
        /// </summary>
        private void OnParentBound(IActionableLoginRewardCollectionBinder binder)
        {
            _parentId = binder.Id;
            var collection = _collection;
            if (collection == null) return;
        ...
        private bool IsReadyForReload()
        {
            ...
            if (string.IsNullOrEmpty(_loginRewardCollection)) return false;
            return true;
        }

        // This expression uses the same equality renderer/lowering as the
        // WhereLoginRewardCollection match helper on the Collection.
        private bool MatchesParent(IReadOnlyLoginRewardBinder binder)
            => EqualityComparer<LoginRewardCollectionId>.Default.Equals(binder.LoginRewardCollection, _parentId);

        private bool IsCurrentOperation(long operationGeneration, ILoginRewardBinderCollection? operationCollection)
            => !_isDestroyed
        ...
        private void AttachCollectionCallbacks(
            ...
            ILoginRewardBinderCollection collection)
        {
            Action<ILoginRewardBinder> itemAdded = binder =>
                OnItemAdded(operationGeneration, collection, binder);
            Action<ILoginRewardBinder> itemRemoved = binder =>
        ...
        private void OnCollectionChanged(long operationGeneration, ILoginRewardBinderCollection collection)
        {
            if (!IsCurrentOperation(operationGeneration, collection)) return;
        ...
        private int IndexOf(IActionableLoginRewardBinder binder)
        {
        ...
        private void DestroyItem(IActionableLoginRewardBinder binder)
        {
            ...
            ILoginRewardBinderCollection collection)
        {
            ...
            var visibleSet = new HashSet<IActionableLoginRewardBinder>(_visibleBinders);
        ...
        private void Cleanup()
        {
            ...
            var handlers = new List<LoginRewardListItemHandler>(_handlers.Values);
            _collection = null;
