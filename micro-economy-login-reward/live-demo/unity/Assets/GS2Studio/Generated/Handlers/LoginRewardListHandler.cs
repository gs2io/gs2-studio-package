...
{
    /// <summary>
    /// MonoBehaviour list handler for LoginReward. Owns a
    /// LoginRewardBinderCollection, instantiates a child LoginRewardListItemHandler
    ...
    /// </summary>
    [AddComponentMenu("GS2 Studio/DomainType/LoginReward/LoginReward List Handler")]
    public sealed class LoginRewardListHandler : MonoBehaviour, ILoginRewardBinderListSource
    {
        ...
        /// itself is the IReadOnlyList&lt;IActionableLoginRewardBinder&gt;.</summary>
        public IReadOnlyList<IActionableLoginRewardBinder> Binders =>
            (IReadOnlyList<IActionableLoginRewardBinder>?)_collection ?? Array.Empty<IActionableLoginRewardBinder>();
        ...
        {
            if (!IsCurrentOperation(operationGeneration, collection)) return;
            // The collection is the IReadOnlyList<IActionableLoginRewardBinder>; index it
