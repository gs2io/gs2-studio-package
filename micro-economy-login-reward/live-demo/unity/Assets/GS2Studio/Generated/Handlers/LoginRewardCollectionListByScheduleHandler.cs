...
{
    /// <summary>
    /// MonoBehaviour list handler for LoginRewardCollection scoped by the
    /// Schedule reference. Auto-resolves a parent
    /// ScheduleHandlerBase from the GameObject hierarchy, owns a
    /// LoginRewardCollectionBinderCollection, and instantiates a child
    /// LoginRewardCollectionListItemHandler only for the binders whose
    /// Schedule equals the parent's id. Implements
    /// ILoginRewardCollectionBinderListSource so items read Binders[Index] through the
    /// shared parent-list surface.
    /// </summary>
    [AddComponentMenu("GS2 Studio/DomainType/LoginRewardCollection/LoginRewardCollection List By Schedule Handler")]
    public sealed class LoginRewardCollectionListByScheduleHandler : MonoBehaviour, ILoginRewardCollectionBinderListSource
    {
        // Which of LoginRewardCollectionBinderCollection's mount axes this list reads
        ...
        // them.
        [SerializeField] private LoginRewardCollectionListAxis _axis;
        ...
        [SerializeField] private LoginRewardCollectionListItemHandler? _itemPrefab;
        ...
        // Construction seam. Defaults to DefaultLoginRewardCollectionBinderFactory.Instance;
        // override via SetBinderFactory to substitute a fake collection.
        private ILoginRewardCollectionBinderFactory? _binderFactory;

        private ILoginRewardCollectionBinderCollection? _collection;
        ...
        private Action<ILoginRewardCollectionBinder>? _collectionItemAddedCallback;
        private Action<ILoginRewardCollectionBinder>? _collectionItemRemovedCallback;
        ...
        // binders' handlers.
        private readonly Dictionary<IActionableLoginRewardCollectionBinder, LoginRewardCollectionListItemHandler> _handlers =
            new Dictionary<IActionableLoginRewardCollectionBinder, LoginRewardCollectionListItemHandler>();
        ...
        private readonly Dictionary<IActionableLoginRewardCollectionBinder, ILoginRewardCollectionBinder> _binderByView =
            new Dictionary<IActionableLoginRewardCollectionBinder, ILoginRewardCollectionBinder>();
        ...
        private readonly List<IActionableLoginRewardCollectionBinder> _visibleBinders =
            new List<IActionableLoginRewardCollectionBinder>();
        ...
        private IComparer<IReadOnlyLoginRewardCollectionBinder>? _comparer;
        ...
        public IReadOnlyList<IActionableLoginRewardCollectionBinder> Binders => _visibleBinders;
        ...
        public event Action<IActionableLoginRewardCollectionBinder>? ItemAdded;
        ...
        public event Action<IActionableLoginRewardCollectionBinder>? ItemRemoved;
        ...
        public IComparer<IReadOnlyLoginRewardCollectionBinder>? Comparer
        {
            ...
            set
            {
                ...
                // LoginRewardCollectionBinderCollection.LoginRewardCollectionBinderComparer.
                var applied = value ?? LoginRewardCollectionBinderCollection.LoginRewardCollectionBinderComparer.Default;
        ...
        /// to substitute a fake LoginRewardCollectionBinderCollection; takes precedence over
        /// the default factory. Pass null to revert to the default. Applies to
        /// the next ReloadAsync.
        /// </summary>
        public void SetBinderFactory(ILoginRewardCollectionBinderFactory? factory)
        {
            _binderFactory = factory;
        }

        private ILoginRewardCollectionBinderFactory ResolveBinderFactory()
            => _binderFactory ?? DefaultLoginRewardCollectionBinderFactory.Instance;
        ...
        /// (the LoginRewardCollectionBinderCollection only re-sorts on list-membership
        ...
        public async Task ReloadAsync(CancellationToken cancellationToken = default)
        {
            ...
            var operationGeneration = ++_reloadGeneration;
            ILoginRewardCollectionBinderCollection? operationCollection = null;
            try
            {
                Cleanup();
                ...
                switch (_axis)
                {
                    case LoginRewardCollectionListAxis.LoginRewardLoginRewardMaster:
                        await collection.MountFromLoginRewardLoginRewardMasterDataAsync(cancellationToken);
                        break;
                    case LoginRewardCollectionListAxis.ExchangeLoginRewardStartOverMaster:
                        await collection.MountFromExchangeLoginRewardStartOverMasterDataAsync(cancellationToken);
                        break;
                    case LoginRewardCollectionListAxis.LoginRewardLoginRewardUser:
                        await collection.MountFromLoginRewardLoginRewardUserDataAsync(cancellationToken);
                        break;
                }
                ...
                if (_autoSubscribe)
                {
                    ...
                    {
                        case LoginRewardCollectionListAxis.LoginRewardLoginRewardMaster:
                            collection.SubscribeFromLoginRewardLoginRewardMasterData(collectionChanged, collectionFailed);
                            break;
                        case LoginRewardCollectionListAxis.ExchangeLoginRewardStartOverMaster:
                            collection.SubscribeFromExchangeLoginRewardStartOverMasterData(collectionChanged, collectionFailed);
                            break;
                        case LoginRewardCollectionListAxis.LoginRewardLoginRewardUser:
                            collection.SubscribeFromLoginRewardLoginRewardUserData(collectionChanged, collectionFailed);
                            break;
                    }
                }
        ...
        private const string AxisMemberNames = "LoginRewardLoginRewardMaster, ExchangeLoginRewardStartOverMaster, LoginRewardLoginRewardUser";
        ...
        private bool MatchesParent(IReadOnlyLoginRewardCollectionBinder binder)
            => binder.Schedule.HasValue && EqualityComparer<ScheduleId>.Default.Equals(binder.Schedule.Value, _parentId);

        private bool IsCurrentOperation(long operationGeneration, ILoginRewardCollectionBinderCollection? operationCollection)
            => !_isDestroyed
        ...
        private void AttachCollectionCallbacks(
            ...
            ILoginRewardCollectionBinderCollection collection)
        {
            Action<ILoginRewardCollectionBinder> itemAdded = binder =>
                OnItemAdded(operationGeneration, collection, binder);
            Action<ILoginRewardCollectionBinder> itemRemoved = binder =>
        ...
        private void OnItemAdded(
            long operationGeneration,
            ILoginRewardCollectionBinderCollection collection,
            ILoginRewardCollectionBinder binder)
        {
            if (!IsCurrentOperation(operationGeneration, collection)) return;
        ...
        private void OnCollectionChanged(long operationGeneration, ILoginRewardCollectionBinderCollection collection)
        {
            if (!IsCurrentOperation(operationGeneration, collection)) return;
        ...
        private int IndexOf(IActionableLoginRewardCollectionBinder binder)
        {
        ...
        private void DestroyItem(IActionableLoginRewardCollectionBinder binder)
        {
            ...
            ILoginRewardCollectionBinderCollection collection)
        {
            ...
            var visibleSet = new HashSet<IActionableLoginRewardCollectionBinder>(_visibleBinders);
        ...
        private void Cleanup()
        {
            ...
            var handlers = new List<LoginRewardCollectionListItemHandler>(_handlers.Values);
            _collection = null;
