...
{
    /// <summary>
    /// Mounts onto Binders[index] of a parent ILoginRewardCollectionBinderListSource
    /// (the plain LoginRewardCollectionListHandler or any ref-scoped variant) and
    ...
    /// </summary>
    [AddComponentMenu("GS2 Studio/DomainType/LoginRewardCollection/LoginRewardCollection List Item Handler")]
    public sealed class LoginRewardCollectionListItemHandler : LoginRewardCollectionHandlerBase
    {
        ...
        private ILoginRewardCollectionBinderListSource? _list;
        ...
        // non-owning IActionableLoginRewardCollectionBinder.
        private IActionableLoginRewardCollectionBinder? _binder;
        private long _reevaluateGeneration;

        public override IActionableLoginRewardCollectionBinder? Binder => _binder;
        // The binder implements <see cref="LoginRewardCollection"/>, so it is the model.
        ...
        /// </summary>
        public void AttachTo(ILoginRewardCollectionBinderListSource list, int index)
        {
        ...
        private void Start()
        {
            ...
            var list = GetComponentInParent<ILoginRewardCollectionBinderListSource>();
            if (list == null)
            {
                RaiseFailed(new InvalidOperationException(
                    "No ancestor ILoginRewardCollectionBinderListSource found in the parent chain."));
                SetContentVisible(false);
                return;
            }
            _list = list;
