...
{
    /// <summary>
    /// Mounts onto Binders[index] of a parent IWalletBinderListSource
    /// (the plain WalletListHandler or any ref-scoped variant) and
    ...
    /// </summary>
    [AddComponentMenu("GS2 Studio/DomainType/Wallet/Wallet List Item Handler")]
    public sealed class WalletListItemHandler : WalletHandlerBase
    {
        ...
        private IWalletBinderListSource? _list;
        ...
        /// </summary>
        public void AttachTo(IWalletBinderListSource list, int index)
        {
        ...
        private void Start()
        {
            ...
            var list = GetComponentInParent<IWalletBinderListSource>();
            if (list == null)
            {
                RaiseFailed(new InvalidOperationException(
                    "No ancestor IWalletBinderListSource found in the parent chain."));
                SetContentVisible(false);
                return;
            }
            _list = list;
