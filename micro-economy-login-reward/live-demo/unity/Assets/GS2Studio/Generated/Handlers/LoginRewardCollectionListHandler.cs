...
{
    /// <summary>
    /// MonoBehaviour list handler for LoginRewardCollection. Owns a
    /// LoginRewardCollectionBinderCollection, instantiates a child LoginRewardCollectionListItemHandler
    ...
    /// </summary>
    [AddComponentMenu("GS2 Studio/DomainType/LoginRewardCollection/LoginRewardCollection List Handler")]
    public sealed class LoginRewardCollectionListHandler : MonoBehaviour, ILoginRewardCollectionBinderListSource
    {
        ...
        /// itself is the IReadOnlyList&lt;IActionableLoginRewardCollectionBinder&gt;.</summary>
        public IReadOnlyList<IActionableLoginRewardCollectionBinder> Binders =>
            (IReadOnlyList<IActionableLoginRewardCollectionBinder>?)_collection ?? Array.Empty<IActionableLoginRewardCollectionBinder>();
        ...
        {
            if (!IsCurrentOperation(operationGeneration, collection)) return;
            // The collection is the IReadOnlyList<IActionableLoginRewardCollectionBinder>; index it
