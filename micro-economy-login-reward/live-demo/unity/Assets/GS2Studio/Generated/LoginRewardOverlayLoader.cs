...
#if UNITY_EDITOR
            new EditorOverlayLoader<LoginRewardOverlayEntry>();
#elif UNITY_ADDRESSABLES
            new AddressablesOverlayLoader<LoginRewardOverlayEntry>("LoginReward");
#else
            new ResourcesOverlayLoader<LoginRewardOverlayEntry>("LoginReward");
#endif
    }
}
