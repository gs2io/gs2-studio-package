...
{
    /// <summary>
    /// Read-only public contract for the FreeDeposit model. GS2 is not a
    ...
    /// <see cref="MutableFreeDeposit"/>, reconciled by the binder/collection
    /// inside the generated assembly.
    /// </summary>
    public interface FreeDeposit
    {
        /// <summary>
        /// Unique identifier
        /// </summary>
        FreeDepositId Id { get; }

        int Count { get; }
    }

    /// <summary>
    /// Read-write public contract for the FreeDeposit model. Each
    ...
    /// <see cref="FreeDeposit"/> surface.
    /// </summary>
    public interface IMutableFreeDeposit : FreeDeposit
    {
        new FreeDepositId Id { get; set; }
        new int Count { get; set; }
    }

    /// <summary>
    /// Mutable implementation of <see cref="FreeDeposit"/>. Internal to
    ...
    /// </summary>
    internal sealed class MutableFreeDeposit : IMutableFreeDeposit
    {
        public FreeDepositId Id { get; set; }
