...
{
    /// <summary>
    /// Mounts onto Binders[index] of a parent IStoreProductBinderListSource
    /// (the plain StoreProductListHandler or any ref-scoped variant) and
    ...
    /// </summary>
    [AddComponentMenu("GS2 Studio/DomainType/StoreProduct/StoreProduct List Item Handler")]
    public sealed class StoreProductListItemHandler : StoreProductHandlerBase
    {
        ...
        private IStoreProductBinderListSource? _list;
        ...
        /// </summary>
        public void AttachTo(IStoreProductBinderListSource list, int index)
        {
        ...
        private void Start()
        {
            ...
            var list = GetComponentInParent<IStoreProductBinderListSource>();
            if (list == null)
            {
                RaiseFailed(new InvalidOperationException(
                    "No ancestor IStoreProductBinderListSource found in the parent chain."));
                SetContentVisible(false);
                return;
            }
            _list = list;
