...
{
    /// <summary>
    /// UI value bound to <c>StoreProduct.appleAppStoreProductId</c>.
    ...
    /// persists it.
    /// </summary>
    [AddComponentMenu("GS2 Studio/DomainType/StoreProduct/Value/AppleAppStoreProductIdValue")]
    public sealed class StoreProductAppleAppStoreProductIdValue : MonoBehaviour
    {
        ...
        private void OnEnable()
        {
            ...
            if (_handler == null)
            {
                ...
                if (!_warnedMissingHandler)
                {
                    ...
                    Debug.LogWarning(
                        $"{nameof(StoreProductAppleAppStoreProductIdValue)} on '{name}': no StoreProductHandlerBase found in the parent chain; component inactive.", this);
                }
                return;
            }
            if (!_subscribed)
        ...
        {
            _onUpdate.Invoke(model.AppleAppStoreProductId ?? string.Empty);
        }
