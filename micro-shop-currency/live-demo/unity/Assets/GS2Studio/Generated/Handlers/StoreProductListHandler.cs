...
{
    /// <summary>
    /// MonoBehaviour list handler for StoreProduct. Owns a
    /// StoreProductBinderCollection, instantiates a child StoreProductListItemHandler
    ...
    /// IStoreProductBinderListSource so items read Binders[Index] through the
    ...
    public sealed class StoreProductListHandler : MonoBehaviour, IStoreProductBinderListSource
    {
        ...
        // Construction seam. Defaults to DefaultStoreProductBinderFactory.Instance;
        // override via SetBinderFactory to substitute a fake collection.
        private IStoreProductBinderFactory? _binderFactory;

        private IStoreProductBinderCollection? _collection;
        ...
        private Action<IStoreProductBinder>? _collectionItemAddedCallback;
        private Action<IStoreProductBinder>? _collectionItemRemovedCallback;
        ...
        private readonly Dictionary<IActionableStoreProductBinder, StoreProductListItemHandler> _handlers =
            new Dictionary<IActionableStoreProductBinder, StoreProductListItemHandler>();
        ...
        private IComparer<IReadOnlyStoreProductBinder>? _comparer;
        ...
        /// itself is the IReadOnlyList&lt;IActionableStoreProductBinder&gt;.</summary>
        public IReadOnlyList<IActionableStoreProductBinder> Binders =>
            (IReadOnlyList<IActionableStoreProductBinder>?)_collection ?? Array.Empty<IActionableStoreProductBinder>();
        ...
        public event Action<IActionableStoreProductBinder>? ItemAdded;

        /// <summary>Fires once for each binder removed.</summary>
        public event Action<IActionableStoreProductBinder>? ItemRemoved;
        ...
        public IComparer<IReadOnlyStoreProductBinder>? Comparer
        {
            ...
            set
            {
                ...
                // StoreProductBinderCollection.StoreProductBinderComparer.
                var applied = value ?? StoreProductBinderCollection.StoreProductBinderComparer.Default;
        ...
        /// to substitute a fake StoreProductBinderCollection; takes precedence over
        /// the default factory. Pass null to revert to the default. Applies to
        /// the next ReloadAsync.
        /// </summary>
        public void SetBinderFactory(IStoreProductBinderFactory? factory)
        {
            _binderFactory = factory;
        }

        private IStoreProductBinderFactory ResolveBinderFactory()
            => _binderFactory ?? DefaultStoreProductBinderFactory.Instance;
        ...
        /// </summary>
        public void SetScope(string currencyType)
        {
        ...
        /// (the StoreProductBinderCollection only re-sorts on list-membership
        ...
        public async Task ReloadAsync(CancellationToken cancellationToken = default)
        {
            ...
            var operationGeneration = ++_reloadGeneration;
            IStoreProductBinderCollection? operationCollection = null;
            try
            {
                Cleanup();
        ...
        private bool IsCurrentOperation(long operationGeneration, IStoreProductBinderCollection? operationCollection)
            => !_isDestroyed
        ...
        private void AttachCollectionCallbacks(
            ...
            IStoreProductBinderCollection collection)
        {
            Action<IStoreProductBinder> itemAdded = binder =>
                OnItemAdded(operationGeneration, collection, binder);
            Action<IStoreProductBinder> itemRemoved = binder =>
        ...
        private void OnCollectionChanged(long operationGeneration, IStoreProductBinderCollection collection)
        {
            if (!IsCurrentOperation(operationGeneration, collection)) return;
        ...
        private int IndexOf(IActionableStoreProductBinder binder)
        {
            var binders = Binders;
        ...
        {
            if (!IsCurrentOperation(operationGeneration, collection)) return;
            // The collection is the IReadOnlyList<IActionableStoreProductBinder>; index it
        ...
        private void Cleanup()
        {
            ...
            var handlers = new List<StoreProductListItemHandler>(_handlers.Values);
            _collection = null;
