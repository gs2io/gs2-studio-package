...
namespace GS2Studio.Generated.Character
{
    ...
    public interface IReadOnlyCharacterBinder : Character
    {
        ...
        /// <summary>
        /// True when this row's mount surface ran the <c>Gs2Bind.Gs2Grade.StatusLoader</c> load on <c>__userdataGradeCharacterGradeGradeModelLoader</c>. False means <c>Grade</c>, <c>PropertyId</c> were never loaded — not that they are absent, which is what their default value would otherwise say.
        /// </summary>
    ...
    public sealed class CharacterBinder : ReadOnlyCharacterBinder, ICharacterBinder
    {
        ...
        ) : base(model, gs2, session)
        {
            ...
            __userdataGradeCharacterGradeGradeModelLoader = new Gs2Bind.Gs2Grade.StatusLoader("CharacterGrade", "CharacterGrade", _model.PropertyId);
