...
{
    /// <summary>
    /// Pure read contract for <see cref="CharacterGradeStepBinder"/>: the read-only
    /// model surface (<see cref="CharacterGradeStep"/>) plus the single-fetch
    ...
    /// </summary>
    public interface IReadOnlyCharacterGradeStepBinder : CharacterGradeStep
    {
    }

    /// <summary>
    /// Actionable contract for <see cref="CharacterGradeStepBinder"/>: the read contract
    ...
    /// </summary>
    public interface IActionableCharacterGradeStepBinder : IReadOnlyCharacterGradeStepBinder
    {
    }

    /// <summary>
    /// Owning contract for <see cref="CharacterGradeStepBinder"/>: adds the lifecycle
    /// surface (Subscribe / Invalidate / Dispose) over <see cref="IActionableCharacterGradeStepBinder"/>.
    /// Returned by the binder factory; a fake implementation substitutes the
    /// whole binder.
    /// </summary>
    public interface ICharacterGradeStepBinder : IActionableCharacterGradeStepBinder, IDisposable
    {
    ...
    /// <summary>
    /// Lifecycle-free base for <see cref="CharacterGradeStepBinder"/>.
    /// Owns <c>_model</c> / <c>_gs2</c> / <c>_session</c> and implements the
    /// read-only <see cref="CharacterGradeStep"/> contract by forwarding each
    ...
    /// </summary>
    public class ReadOnlyCharacterGradeStepBinder : IReadOnlyCharacterGradeStepBinder
    {
        ...
        private protected readonly MutableCharacterGradeStep _model;
        ...
        /// the read-only <c>CharacterGradeStep</c> surface this binder implements.
        /// </summary>
        internal MutableCharacterGradeStep MutableModel => _model;
        /// <inheritdoc cref="CharacterGradeStep.Id" />
        public CharacterGradeStepId Id => _model.Id;
        /// <inheritdoc cref="CharacterGradeStep.RankCapValue" />
        public long RankCapValue => _model.RankCapValue;
        /// <inheritdoc cref="CharacterGradeStep.PropertyIdRegex" />
        public string PropertyIdRegex => _model.PropertyIdRegex;
        /// <inheritdoc cref="CharacterGradeStep.GradeUpPropertyIdRegex" />
        public string GradeUpPropertyIdRegex => _model.GradeUpPropertyIdRegex;
        /// <summary>
        ...
        /// </summary>
        private protected ReadOnlyCharacterGradeStepBinder(MutableCharacterGradeStep model, Gs2Domain gs2, IGameSession session)
        {
        ...
        /// through the read contract <see cref="IReadOnlyCharacterGradeStepBinder"/>) and
    ...
    /// <summary>
    /// Binder for CharacterGradeStep
    /// Binds GS2 resource values to the model and automatically reflects server-side changes
    /// </summary>
    public sealed class CharacterGradeStepBinder : ReadOnlyCharacterGradeStepBinder, ICharacterGradeStepBinder
    {
        ...
        /// </summary>
        internal CharacterGradeStepBinder(
            MutableCharacterGradeStep model,
            Gs2Domain gs2,
        ...
        /// <summary>
        /// Creates a CharacterGradeStep instance from identity parameters. The
        ...
        /// </summary>
        internal static MutableCharacterGradeStep CreateModel(CharacterGradeStepId id)
        {
            var model = new MutableCharacterGradeStep();
            model.Id = id;
            return model;
        }

        /// <summary>
        /// Creates a CharacterGradeStepBinder and mounts it to GS2 resources.
        /// This is the only external construction path for mount-based usage.
        /// </summary>
        public static async Task<CharacterGradeStepBinder> CreateAsync(
            ...
            CancellationToken cancellationToken = default)
        {
            ...
            var binder = new CharacterGradeStepBinder(model, gs2, session);
        ...
        /// (callable through <see cref="IReadOnlyCharacterGradeStepBinder"/>) and calls
        ...
        private void EnsureActionContext()
        {
            ...
            if (!_mounted)
            {
                throw new InvalidOperationException(
                    $"{nameof(CharacterGradeStepBinder)} is not mounted. Use CreateAsync or one of the list factories.");
            }
        }
