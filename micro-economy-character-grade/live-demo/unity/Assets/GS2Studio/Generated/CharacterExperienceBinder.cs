...
{
    /// <summary>
    /// Pure read contract for <see cref="CharacterExperienceBinder"/>: the read-only
    /// model surface (<see cref="CharacterExperience"/>) plus the single-fetch
    ...
    /// </summary>
    public interface IReadOnlyCharacterExperienceBinder : CharacterExperience
    {
    }

    /// <summary>
    /// Actionable contract for <see cref="CharacterExperienceBinder"/>: the read contract
    ...
    /// </summary>
    public interface IActionableCharacterExperienceBinder : IReadOnlyCharacterExperienceBinder
    {
    }

    /// <summary>
    /// Owning contract for <see cref="CharacterExperienceBinder"/>: adds the lifecycle
    /// surface (Subscribe / Invalidate / Dispose) over <see cref="IActionableCharacterExperienceBinder"/>.
    /// Returned by the binder factory; a fake implementation substitutes the
    /// whole binder.
    /// </summary>
    public interface ICharacterExperienceBinder : IActionableCharacterExperienceBinder, IDisposable
    {
    ...
    /// <summary>
    /// Lifecycle-free base for <see cref="CharacterExperienceBinder"/>.
    /// Owns <c>_model</c> / <c>_gs2</c> / <c>_session</c> and implements the
    /// read-only <see cref="CharacterExperience"/> contract by forwarding each
    ...
    /// </summary>
    public class ReadOnlyCharacterExperienceBinder : IReadOnlyCharacterExperienceBinder
    {
        ...
        private protected readonly MutableCharacterExperience _model;
        ...
        /// the read-only <c>CharacterExperience</c> surface this binder implements.
        /// </summary>
        internal MutableCharacterExperience MutableModel => _model;
        /// <inheritdoc cref="CharacterExperience.Id" />
        public CharacterExperienceId Id => _model.Id;
        /// <inheritdoc cref="CharacterExperience.Threshold" />
        public IReadOnlyList<long> Threshold => _model.Threshold;
        /// <inheritdoc cref="CharacterExperience.DefaultLevelCap" />
        public int DefaultLevelCap => _model.DefaultLevelCap;
        /// <inheritdoc cref="CharacterExperience.MaxLevelCap" />
        public int MaxLevelCap => _model.MaxLevelCap;
        /// <summary>
        ...
        /// </summary>
        private protected ReadOnlyCharacterExperienceBinder(MutableCharacterExperience model, Gs2Domain gs2, IGameSession session)
        {
        ...
        /// through the read contract <see cref="IReadOnlyCharacterExperienceBinder"/>) and
    ...
    /// <summary>
    /// Binder for CharacterExperience
    /// Binds GS2 resource values to the model and automatically reflects server-side changes
    /// </summary>
    public sealed class CharacterExperienceBinder : ReadOnlyCharacterExperienceBinder, ICharacterExperienceBinder
    {
        ...
        /// </summary>
        internal CharacterExperienceBinder(
            MutableCharacterExperience model,
            Gs2Domain gs2,
        ...
        /// <summary>
        /// Creates a CharacterExperience instance from identity parameters. The
        ...
        /// </summary>
        internal static MutableCharacterExperience CreateModel(CharacterExperienceId id)
        {
            var model = new MutableCharacterExperience();
            model.Id = id;
            return model;
        }

        /// <summary>
        /// Creates a CharacterExperienceBinder and mounts it to GS2 resources.
        /// This is the only external construction path for mount-based usage.
        /// </summary>
        public static async Task<CharacterExperienceBinder> CreateAsync(
            ...
            CancellationToken cancellationToken = default)
        {
            ...
            var binder = new CharacterExperienceBinder(model, gs2, session);
        ...
        public async Task MountAsync(CancellationToken cancellationToken = default)
        {
            ...
            var _experienceCharacterExperienceNamespaceExperienceModel = await __experienceCharacterExperienceNamespaceExperienceModelLoader.Load(_gs2, _session);
            cancellationToken.ThrowIfCancellationRequested();
            ApplyExperienceCharacterExperienceNamespaceExperienceModel(_model, _experienceCharacterExperienceNamespaceExperienceModel);
            _mounted = true;
        }
        ...
        {
            ThrowIfDisposed();
            _unsubscribers.Add(__experienceCharacterExperienceNamespaceExperienceModelLoader.Subscribe(
                _gs2,
                _session,
                (_, _, value) =>
                {
                    if (_disposed) return Task.CompletedTask;
                    ApplyExperienceCharacterExperienceNamespaceExperienceModel(_model, value);
        ...
        {
            ThrowIfDisposed();
            __experienceCharacterExperienceNamespaceExperienceModelLoader.Invalidate(_gs2, _session);
        }
        ...
        /// (callable through <see cref="IReadOnlyCharacterExperienceBinder"/>) and calls
        ...
        private void EnsureActionContext()
        {
            ...
            if (!_mounted)
            {
                throw new InvalidOperationException(
                    $"{nameof(CharacterExperienceBinder)} is not mounted. Use CreateAsync or one of the list factories.");
            }
        }
        ...
        /// <summary>
        /// Shared composition for the <c>__experienceCharacterExperienceNamespaceExperienceModelLoader</c> source:
        ...
        public static void ApplyExperienceCharacterExperienceNamespaceExperienceModel(IMutableCharacterExperience model, Gs2.Unity.Gs2Experience.Model.EzExperienceModel? source)
        {
            if (source != null)
            {
                model.DefaultLevelCap = (int)source.DefaultRankCap;
                model.MaxLevelCap = (int)source.MaxRankCap;
                model.Threshold = source.RankThreshold == null || source.RankThreshold.Values == null ? new List<long>() : source.RankThreshold.Values;
            }
            else
            {
                model.DefaultLevelCap = default;
                model.MaxLevelCap = default;
                model.Threshold = new List<long>();
            }
        }
        #endregion
