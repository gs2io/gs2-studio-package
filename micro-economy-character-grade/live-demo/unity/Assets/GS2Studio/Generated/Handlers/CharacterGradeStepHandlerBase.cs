...
namespace GS2Studio.Generated.CharacterGradeStep
{
    ...
    /// CharacterGradeStepBinder: the standalone/list CharacterGradeStepHandler and the
    /// slot-bound CharacterGradeStepListItemHandler. Concrete handlers supply the
    ...
    /// </summary>
    public abstract class CharacterGradeStepHandlerBase : MonoBehaviour
    {
        /// <summary>The bound binder (non-owning actionable view), or null when none is attached.</summary>
        public abstract IActionableCharacterGradeStepBinder? Binder { get; }

        /// <summary>The bound model, or null when no binder is attached.</summary>
        public abstract CharacterGradeStep? Model { get; }
        ...
        public event Action<CharacterGradeStep>? Updated;

        /// <summary>Fires once each time a binder is attached (non-owning actionable view).</summary>
        public event Action<IActionableCharacterGradeStepBinder>? Bound;
        ...
        protected void RaiseUpdated(CharacterGradeStep model) => Updated?.Invoke(model);
        protected void RaiseBound(IActionableCharacterGradeStepBinder binder) => Bound?.Invoke(binder);
