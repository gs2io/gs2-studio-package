...
namespace GS2Studio.Generated.Character
{
    ...
    public enum CharacterListAxis
    {
        ...
        /// <summary>Read from the ExchangeCharacterLimitBreak master-data mount axis.</summary>
        ExchangeCharacterLimitBreakMaster = 1054758583,

        /// <summary>Read from the ExchangeCharacterGradeTrain master-data mount axis.</summary>
        ExchangeCharacterGradeTrainMaster = 1598334606,
