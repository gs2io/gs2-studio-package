...
namespace GS2Studio.Generated.Character
{
    ...
    public sealed class CharacterListHandler : MonoBehaviour, ICharacterBinderListSource
    {
            ...
            try
            {
                ...
                switch (_axis)
                {
                    ...
                    case CharacterListAxis.ExchangeCharacterTrainMaster:
                        ...
                        break;
                    case CharacterListAxis.ExchangeCharacterLimitBreakMaster:
                        await collection.MountFromExchangeCharacterLimitBreakMasterDataAsync(cancellationToken);
                        break;
                    case CharacterListAxis.ExchangeCharacterGradeTrainMaster:
                        await collection.MountFromExchangeCharacterGradeTrainMasterDataAsync(cancellationToken);
                        break;
                ...
                if (_autoSubscribe)
                {
                    ...
                    switch (_axis)
                    {
                        ...
                        case CharacterListAxis.ExchangeCharacterTrainMaster:
                            ...
                            break;
                        case CharacterListAxis.ExchangeCharacterLimitBreakMaster:
                            collection.SubscribeFromExchangeCharacterLimitBreakMasterData(collectionChanged, collectionFailed);
                            break;
                        case CharacterListAxis.ExchangeCharacterGradeTrainMaster:
                            collection.SubscribeFromExchangeCharacterGradeTrainMasterData(collectionChanged, collectionFailed);
                            break;
                        case CharacterListAxis.InventoryCharacterUser:
        ...
        private const string AxisMemberNames = "InventoryCharacterMaster, ExchangeCharacterTrainMaster, ExchangeCharacterLimitBreakMaster, ExchangeCharacterGradeTrainMaster, InventoryCharacterUser";
