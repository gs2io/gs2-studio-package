...
namespace GS2Studio.Generated.Item
{
    ...
    /// ItemBinder: the standalone/list ItemHandler and the
    /// slot-bound ItemListItemHandler. Concrete handlers supply the
    ...
    public abstract class ItemHandlerBase : MonoBehaviour
    {
        ...
        public event Action<IActionableItemBinder>? Bound;
        ...
        protected void RaiseUpdated(Item model) => Updated?.Invoke(model);
        protected void RaiseBound(IActionableItemBinder binder) => Bound?.Invoke(binder);
