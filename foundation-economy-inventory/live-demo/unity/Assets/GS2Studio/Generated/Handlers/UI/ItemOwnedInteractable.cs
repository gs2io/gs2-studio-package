...
namespace GS2Studio.Generated.Item.UI
{
    ...
    /// groups based on the condition <c>gt(count, 0)</c>
    /// evaluated against the sibling <c>ItemHandler.Model</c>:
    /// <list type="bullet">
    ...
    /// </summary>
    [AddComponentMenu("GS2 Studio/DomainType/Item/Interactable/OwnedInteractable")]
    public sealed class ItemOwnedInteractable : MonoBehaviour
    {
        ...
        private void OnEnable()
        {
            ...
            if (_handler == null)
            {
                ...
                if (!_warnedMissingHandler)
                {
                    ...
                    Debug.LogWarning(
                        $"{nameof(ItemOwnedInteractable)} on '{name}': no ItemHandlerBase found in the parent chain; component inactive.", this);
                }
                return;
            }
            if (!_subscribed)
        ...
        {
            bool result = (System.Convert.ToInt64(model.Count, System.Globalization.CultureInfo.InvariantCulture) > System.Convert.ToInt64(0L, System.Globalization.CultureInfo.InvariantCulture));
