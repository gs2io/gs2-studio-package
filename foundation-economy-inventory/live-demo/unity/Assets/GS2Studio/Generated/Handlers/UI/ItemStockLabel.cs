...
namespace GS2Studio.Generated.Item.UI
{
    ...
    /// substituted with the resolved value from <c>Item</c>
    ...
    /// </summary>
    [AddComponentMenu("GS2 Studio/DomainType/Item/TemplateLabel/StockLabel")]
    public sealed class ItemStockLabel : MonoBehaviour
    {
        ...
        private void OnEnable()
        {
            ...
            if (_handler == null)
            {
                ...
                if (!_warnedMissingHandler)
                {
                    ...
                    Debug.LogWarning(
                        $"{nameof(ItemStockLabel)} on '{name}': no ItemHandlerBase found in the parent chain; component inactive.", this);
                }
                return;
            }
            if (!_subscribed)
