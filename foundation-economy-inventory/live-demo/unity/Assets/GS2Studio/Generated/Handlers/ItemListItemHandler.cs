...
{
    /// <summary>
    /// Mounts onto Binders[index] of a parent IItemBinderListSource
    /// (the plain ItemListHandler or any ref-scoped variant) and
    ...
    /// </summary>
    [AddComponentMenu("GS2 Studio/DomainType/Item/Item List Item Handler")]
    public sealed class ItemListItemHandler : ItemHandlerBase
    {
        ...
        private IItemBinderListSource? _list;
        ...
        // non-owning IActionableItemBinder.
        private IActionableItemBinder? _binder;

        public override IActionableItemBinder? Binder => _binder;
        // The binder implements <see cref="Item"/>, so it is the model.
        ...
        /// </summary>
        public void AttachTo(IItemBinderListSource list, int index)
        {
        ...
        private void Start()
        {
            ...
            var list = GetComponentInParent<IItemBinderListSource>();
            if (list == null)
            {
                RaiseFailed(new InvalidOperationException(
                    "No ancestor IItemBinderListSource found in the parent chain."));
                SetContentVisible(false);
                return;
            }
            _list = list;
