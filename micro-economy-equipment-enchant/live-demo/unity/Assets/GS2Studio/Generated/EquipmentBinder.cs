...
namespace GS2Studio.Generated.Equipment
{
    ...
    public enum EquipmentMountSurface
    {
        ...
        [Gs2SkipsLoaders("UserdataInventoryEquipmentItemModel", "UserdataEnchantEquipmentEnchantRarityParameterModel")]
        ...
        /// <summary>Built by the ExchangeEquipmentEnchantAdd master-data list axis.</summary>
        [Gs2SkipsLoaders("UserdataInventoryEquipmentItemModel", "UserdataEnchantEquipmentEnchantRarityParameterModel")]
        ExchangeEquipmentEnchantAddMaster,

        /// <summary>Built by the ExchangeEquipmentEnchantReroll master-data list axis.</summary>
        [Gs2SkipsLoaders("UserdataInventoryEquipmentItemModel", "UserdataEnchantEquipmentEnchantRarityParameterModel")]
        ExchangeEquipmentEnchantRerollMaster,
    ...
    public interface IReadOnlyEquipmentBinder : Equipment
    {
        ...
        /// <remarks>ExchangeEquipmentEnchantAddMaster: no per-row value for _model.PropertyId.</remarks>
        /// <remarks>ExchangeEquipmentEnchantRerollMaster: no per-row value for _model.PropertyId.</remarks>
        bool LoadedUserdataInventoryEquipmentItemModel { get; }

        /// <summary>
        /// True when this row's mount surface ran the <c>Gs2Bind.Gs2Enchant.RarityParameterStatusLoader</c> load on <c>__userdataEnchantEquipmentEnchantRarityParameterModelLoader</c>. False means <c>PropertyId</c>, <c>Enchantments</c> were never loaded — not that they are absent, which is what their default value would otherwise say.
        /// </summary>
        /// <remarks>InventoryEquipmentMaster: no per-row value for _model.PropertyId.</remarks>
        /// <remarks>ExchangeEquipmentDiscardMaster: no per-row value for _model.PropertyId.</remarks>
        /// <remarks>ExchangeEquipmentEnchantAddMaster: no per-row value for _model.PropertyId.</remarks>
        /// <remarks>ExchangeEquipmentEnchantRerollMaster: no per-row value for _model.PropertyId.</remarks>
        bool LoadedUserdataEnchantEquipmentEnchantRarityParameterModel { get; }
    }
    ...
    public abstract class ReadOnlyEquipmentBinder : IReadOnlyEquipmentBinder
    {
        ...
        /// <inheritdoc cref="Equipment.Enchant" />
        public EquipmentEnchantId? Enchant => _model.Enchant;
        /// <inheritdoc cref="Equipment.Enchantments" />
        public IReadOnlyList<GS2Studio.Generated.EquipmentEnchantment.EquipmentEnchantment>? Enchantments => _model.Enchantments;
        ...
        /// <inheritdoc />
        public abstract bool LoadedUserdataEnchantEquipmentEnchantRarityParameterModel { get; }
    ...
    public sealed class EquipmentBinder : ReadOnlyEquipmentBinder, IEquipmentBinder
    {
        ...
        private readonly Gs2Bind.Gs2Exchange.RateModelLoader __exchangeEquipmentEnchantAddNamespaceRateModelLoader;
        ...
        private readonly Gs2Bind.Gs2Exchange.RateModelLoader __exchangeEquipmentEnchantRerollNamespaceRateModelLoader;
        ...
        private readonly Gs2Bind.Gs2Enchant.RarityParameterStatusLoader __userdataEnchantEquipmentEnchantRarityParameterModelLoader;
        ...
        /// <summary>True when this row's path supplies every key <c>__userdataEnchantEquipmentEnchantRarityParameterModelLoader</c> reads.</summary>
        /// <remarks>InventoryEquipmentMaster: no per-row value for _model.PropertyId.</remarks>
        /// <remarks>ExchangeEquipmentDiscardMaster: no per-row value for _model.PropertyId.</remarks>
        /// <remarks>ExchangeEquipmentEnchantAddMaster: no per-row value for _model.PropertyId.</remarks>
        /// <remarks>ExchangeEquipmentEnchantRerollMaster: no per-row value for _model.PropertyId.</remarks>
        private bool Runs__userdataEnchantEquipmentEnchantRarityParameterModelLoader => _mountSurfaceValue is EquipmentMountSurface.Full or EquipmentMountSurface.InventoryEquipmentUser;
        ...
        /// <inheritdoc />
        public override bool LoadedUserdataEnchantEquipmentEnchantRarityParameterModel => Runs__userdataEnchantEquipmentEnchantRarityParameterModelLoader;
        ...
        ) : base(model, gs2, session)
        {
            ...
            __transactionConsumeAction2Loader = new Gs2Bind.Gs2Exchange.RateModelConsumeActionLoader("EquipmentEnchantAdd", _model.Id, 0);
            __exchangeEquipmentEnchantAddNamespaceRateModelLoader = new Gs2Bind.Gs2Exchange.RateModelLoader("EquipmentEnchantAdd", _model.Id);
            __transactionAcquireActionLoader = new Gs2Bind.Gs2Exchange.RateModelAcquireActionLoader("EquipmentEnchantAdd", _model.Id, 0);
            __transactionConsumeAction3Loader = new Gs2Bind.Gs2Exchange.RateModelConsumeActionLoader("EquipmentEnchantReroll", _model.Id, 0);
            __transactionAcquireAction2Loader = new Gs2Bind.Gs2Exchange.RateModelAcquireActionLoader("EquipmentEnchantReroll", _model.Id, 0);
            __exchangeEquipmentEnchantRerollNamespaceRateModelLoader = new Gs2Bind.Gs2Exchange.RateModelLoader("EquipmentEnchantReroll", _model.Id);
            ...
            __userdataEnchantEquipmentEnchantRarityParameterModelLoader = new Gs2Bind.Gs2Enchant.RarityParameterStatusLoader("EquipmentEnchant", _model.Enchant, _model.PropertyId);
        }
        ...
        /// </summary>
        internal static MutableEquipment CreateModel(EquipmentId id, string propertyId, EquipmentEnchantId enchant)
        {
        ...
        public static async Task<EquipmentBinder> CreateAsync(
            EquipmentId id, string propertyId, EquipmentEnchantId enchant,
            Gs2Domain gs2,
            IGameSession session,
            CancellationToken cancellationToken = default)
        {
            var model = CreateModel(id, propertyId, enchant);
        ...
        public async Task MountAsync(CancellationToken cancellationToken = default)
        {
            ...
            var _exchangeEquipmentEnchantAddNamespaceRateModel = await __exchangeEquipmentEnchantAddNamespaceRateModelLoader.Load(_gs2, _session);
            cancellationToken.ThrowIfCancellationRequested();
            if (_exchangeEquipmentEnchantAddNamespaceRateModel != null)
            {
            }
            ...
            var _exchangeEquipmentEnchantRerollNamespaceRateModel = await __exchangeEquipmentEnchantRerollNamespaceRateModelLoader.Load(_gs2, _session);
            cancellationToken.ThrowIfCancellationRequested();
            if (_exchangeEquipmentEnchantRerollNamespaceRateModel != null)
            {
            }
            ...
            var _userdataEnchantEquipmentEnchantRarityParameterModel = Runs__userdataEnchantEquipmentEnchantRarityParameterModelLoader ? await __userdataEnchantEquipmentEnchantRarityParameterModelLoader.Load(_gs2, _session) : null;
            cancellationToken.ThrowIfCancellationRequested();
            if (Runs__userdataEnchantEquipmentEnchantRarityParameterModelLoader)
            {
                ApplyUserdataEnchantEquipmentEnchantRarityParameterModel(_model, _userdataEnchantEquipmentEnchantRarityParameterModel);
            }
            ...
            if (Runs__userdataEnchantEquipmentEnchantRarityParameterModelLoader)
            {
                var __enchantmentsItems = new List<GS2Studio.Generated.EquipmentEnchantment.EquipmentEnchantment>();
                if (_userdataEnchantEquipmentEnchantRarityParameterModel?.ParameterValues != null)
                {
                    foreach (var __element in _userdataEnchantEquipmentEnchantRarityParameterModel.ParameterValues)
                    {
                        if (__element == null) continue;
                        if (__element.ResourceName == null) continue;
                        var row = new GS2Studio.Generated.EquipmentEnchantment.MutableEquipmentEnchantment();
                        row.Id = string.IsNullOrEmpty(__element.Name) ? default(GS2Studio.Generated.EquipmentEnchantment.EquipmentEnchantmentId) : new GS2Studio.Generated.EquipmentEnchantment.EquipmentEnchantmentId(__element.Name);
                        row.ResourceName = __element.ResourceName;
                        row.ResourceValue = __element.ResourceValue;
                        __enchantmentsItems.Add(row);
                    }
                }
                _model.Enchantments = __enchantmentsItems;
            }
            _mounted = true;
        }
        ...
        public void Subscribe(Action? onChange = null)
        {
            ...
            _unsubscribers.Add(__exchangeEquipmentEnchantAddNamespaceRateModelLoader.Subscribe(
                _gs2,
                _session,
                (_, _, value) =>
                {
            ...
            _unsubscribers.Add(__exchangeEquipmentEnchantRerollNamespaceRateModelLoader.Subscribe(
                _gs2,
                _session,
                (_, _, value) =>
                {
            ...
            if (Runs__userdataEnchantEquipmentEnchantRarityParameterModelLoader)
            {
                _unsubscribers.Add(__userdataEnchantEquipmentEnchantRarityParameterModelLoader.Subscribe(
                    _gs2,
                    _session,
                    (_, _, value) =>
                    {
                        if (_disposed) return Task.CompletedTask;
                        ApplyUserdataEnchantEquipmentEnchantRarityParameterModel(_model, value);
                        var __enchantmentsItems = new List<GS2Studio.Generated.EquipmentEnchantment.EquipmentEnchantment>();
                        if (value?.ParameterValues != null)
                        {
                            foreach (var __element in value.ParameterValues)
                            {
                                if (__element == null) continue;
                                if (__element.ResourceName == null) continue;
                                var row = new GS2Studio.Generated.EquipmentEnchantment.MutableEquipmentEnchantment();
        ...
        public void Invalidate()
        {
            ...
            __exchangeEquipmentEnchantAddNamespaceRateModelLoader.Invalidate(_gs2, _session);
            ...
            __exchangeEquipmentEnchantRerollNamespaceRateModelLoader.Invalidate(_gs2, _session);
            ...
            if (Runs__userdataEnchantEquipmentEnchantRarityParameterModelLoader)
            {
                __userdataEnchantEquipmentEnchantRarityParameterModelLoader.Invalidate(_gs2, _session);
            }
        }
        ...
        {
            EnsureActionContext();
            await new Gs2Bind.Gs2Exchange.RateModelLoader("EquipmentEnchantReroll", _model.Id).Exchange(_gs2, _session, count: 1, config: new Gs2.Unity.Gs2Exchange.Model.EzConfig[] { new Gs2.Unity.Gs2Exchange.Model.EzConfig { Key = "propertyId", Value = _model.PropertyId } });
        }

        public async Task AddBonus()
        {
            EnsureActionContext();
            await new Gs2Bind.Gs2Exchange.RateModelLoader("EquipmentEnchantAdd", _model.Id).Exchange(_gs2, _session, count: 1, config: new Gs2.Unity.Gs2Exchange.Model.EzConfig[] { new Gs2.Unity.Gs2Exchange.Model.EzConfig { Key = "propertyId", Value = _model.PropertyId } });
        }
        #endregion
        ...
        /// <summary>
        /// Shared composition for the <c>__userdataEnchantEquipmentEnchantRarityParameterModelLoader</c> source:
        /// writes the loaded value onto the model, or resets the covered
        /// properties when <c>source</c> is null. <c>MountAsync</c>,
        /// <c>Subscribe</c> and external stubs all route through this method.
        /// </summary>
        public static void ApplyUserdataEnchantEquipmentEnchantRarityParameterModel(IMutableEquipment model, Gs2.Unity.Gs2Enchant.Model.EzRarityParameterStatus? source)
        {
            if (source != null)
            {
