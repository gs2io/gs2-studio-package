...
{
    /// <summary>
    /// UI value bound to <c>StoreProduct.id</c>.
    ...
    /// persists it.
    /// </summary>
    [AddComponentMenu("GS2 Studio/DomainType/StoreProduct/Value/IdValue")]
    public sealed class StoreProductIdValue : MonoBehaviour
    {
        ...
        private void OnEnable()
        {
            ...
            if (_handler == null)
            {
                ...
                if (!_warnedMissingHandler)
                {
                    ...
                    Debug.LogWarning(
                        $"{nameof(StoreProductIdValue)} on '{name}': no StoreProductHandlerBase found in the parent chain; component inactive.", this);
                }
                return;
            }
            if (!_subscribed)
        ...
        {
            _onUpdate.Invoke(model.Id.ToString());
        }
