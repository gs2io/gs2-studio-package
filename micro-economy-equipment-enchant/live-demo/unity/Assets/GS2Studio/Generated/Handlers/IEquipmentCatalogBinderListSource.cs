...
{
    /// <summary>
    /// Read surface shared by EquipmentCatalogListHandler and the ref-scoped
    /// EquipmentCatalogListBy*Handler variants. EquipmentCatalogListItemHandler
    /// resolves its parent list through this interface, so one item prefab
    /// serves every list flavor.
    /// </summary>
    public interface IEquipmentCatalogBinderListSource
    {
        /// <summary>Stable index/enumeration view of the current non-owning binder set; Model.Id is not a unique lookup key.</summary>
        IReadOnlyList<IActionableEquipmentCatalogBinder> Binders { get; }
