...
{
    /// <summary>
    /// Mounts onto Binders[index] of a parent IEquipmentEnchantBinderListSource
    /// (the plain EquipmentEnchantListHandler or any ref-scoped variant) and
    ...
    /// </summary>
    [AddComponentMenu("GS2 Studio/DomainType/EquipmentEnchant/EquipmentEnchant List Item Handler")]
    public sealed class EquipmentEnchantListItemHandler : EquipmentEnchantHandlerBase
    {
        ...
        private IEquipmentEnchantBinderListSource? _list;
        ...
        // non-owning IActionableEquipmentEnchantBinder.
        private IActionableEquipmentEnchantBinder? _binder;
        private long _reevaluateGeneration;

        public override IActionableEquipmentEnchantBinder? Binder => _binder;
        // The binder implements <see cref="EquipmentEnchant"/>, so it is the model.
        ...
        /// </summary>
        public void AttachTo(IEquipmentEnchantBinderListSource list, int index)
        {
        ...
        private void Start()
        {
            ...
            var list = GetComponentInParent<IEquipmentEnchantBinderListSource>();
            if (list == null)
            {
                RaiseFailed(new InvalidOperationException(
                    "No ancestor IEquipmentEnchantBinderListSource found in the parent chain."));
                SetContentVisible(false);
                return;
            }
            _list = list;
