...
{
    /// <summary>
    /// MonoBehaviour list handler for Equipment. Owns a
    /// EquipmentBinderCollection, instantiates a child EquipmentListItemHandler
    ...
    public sealed class EquipmentListHandler : MonoBehaviour, IEquipmentBinderListSource
    {
        ...
        /// itself is the IReadOnlyList&lt;IActionableEquipmentBinder&gt;.</summary>
        public IReadOnlyList<IActionableEquipmentBinder> Binders =>
            (IReadOnlyList<IActionableEquipmentBinder>?)_collection ?? Array.Empty<IActionableEquipmentBinder>();
        ...
        private IEquipmentBinderFactory ResolveBinderFactory()
        ...
        public async Task ReloadAsync(CancellationToken cancellationToken = default)
        {
            ...
            var operationGeneration = ++_reloadGeneration;
            IEquipmentBinderCollection? operationCollection = null;
            try
            {
                Cleanup();
                ...
                var collection = ResolveBinderFactory().CreateCollection(gs2, session, new EquipmentEnchantId(_enchant ?? string.Empty));
                ...
                switch (_axis)
                {
                    case EquipmentListAxis.InventoryEquipmentMaster:
                        await collection.MountFromInventoryEquipmentMasterDataAsync(cancellationToken);
                        break;
                    case EquipmentListAxis.ExchangeEquipmentDiscardMaster:
                        await collection.MountFromExchangeEquipmentDiscardMasterDataAsync(cancellationToken);
                        break;
                    case EquipmentListAxis.ExchangeEquipmentEnchantAddMaster:
                        await collection.MountFromExchangeEquipmentEnchantAddMasterDataAsync(cancellationToken);
                        break;
                    case EquipmentListAxis.ExchangeEquipmentEnchantRerollMaster:
                        await collection.MountFromExchangeEquipmentEnchantRerollMasterDataAsync(cancellationToken);
                        break;
                    case EquipmentListAxis.InventoryEquipmentUser:
                        await collection.MountFromInventoryEquipmentUserDataAsync(cancellationToken);
                        break;
                }
                ...
                if (_autoSubscribe)
                {
                    ...
                    {
                        case EquipmentListAxis.InventoryEquipmentMaster:
                            collection.SubscribeFromInventoryEquipmentMasterData(collectionChanged, collectionFailed);
                            break;
                        case EquipmentListAxis.ExchangeEquipmentDiscardMaster:
                            collection.SubscribeFromExchangeEquipmentDiscardMasterData(collectionChanged, collectionFailed);
                            break;
                        case EquipmentListAxis.ExchangeEquipmentEnchantAddMaster:
                            collection.SubscribeFromExchangeEquipmentEnchantAddMasterData(collectionChanged, collectionFailed);
                            break;
                        case EquipmentListAxis.ExchangeEquipmentEnchantRerollMaster:
                            collection.SubscribeFromExchangeEquipmentEnchantRerollMasterData(collectionChanged, collectionFailed);
                            break;
                        case EquipmentListAxis.InventoryEquipmentUser:
                            collection.SubscribeFromInventoryEquipmentUserData(collectionChanged, collectionFailed);
                            break;
                    }
                }
        ...
        private bool IsReadyForReload()
        {
            ...
            switch (_axis)
            {
                ...
                case EquipmentListAxis.ExchangeEquipmentEnchantRerollMaster:
                    break;
                case EquipmentListAxis.InventoryEquipmentUser:
                    if (string.IsNullOrEmpty(_enchant)) return false;
                    break;
            }
            return true;
        }

        private bool IsCurrentOperation(long operationGeneration, IEquipmentBinderCollection? operationCollection)
            => !_isDestroyed
        ...
        {
            Action<IEquipmentBinder> itemAdded = binder =>
                OnItemAdded(operationGeneration, collection, binder);
            Action<IEquipmentBinder> itemRemoved = binder =>
        ...
        private void OnCollectionChanged(long operationGeneration, IEquipmentBinderCollection collection)
        {
            if (!IsCurrentOperation(operationGeneration, collection)) return;
        ...
        private int IndexOf(IActionableEquipmentBinder binder)
        {
            var binders = Binders;
        ...
        {
            if (!IsCurrentOperation(operationGeneration, collection)) return;
            // The collection is the IReadOnlyList<IActionableEquipmentBinder>; index it
        ...
        private void Cleanup()
        {
            ...
            var handlers = new List<EquipmentListItemHandler>(_handlers.Values);
            _collection = null;
