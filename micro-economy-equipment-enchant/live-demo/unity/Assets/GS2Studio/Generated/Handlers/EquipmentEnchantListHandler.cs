...
{
    /// <summary>
    /// MonoBehaviour list handler for EquipmentEnchant. Owns a
    /// EquipmentEnchantBinderCollection, instantiates a child EquipmentEnchantListItemHandler
    ...
    /// IEquipmentEnchantBinderListSource so items read Binders[Index] through the
    /// shared parent-list surface.
    /// </summary>
    [AddComponentMenu("GS2 Studio/DomainType/EquipmentEnchant/EquipmentEnchant List Handler")]
    public sealed class EquipmentEnchantListHandler : MonoBehaviour, IEquipmentEnchantBinderListSource
    {
        [SerializeField] private EquipmentEnchantListItemHandler? _itemPrefab;
        ...
        // Construction seam. Defaults to DefaultEquipmentEnchantBinderFactory.Instance;
        // override via SetBinderFactory to substitute a fake collection.
        private IEquipmentEnchantBinderFactory? _binderFactory;

        private IEquipmentEnchantBinderCollection? _collection;
        ...
        private Action<IEquipmentEnchantBinder>? _collectionItemAddedCallback;
        private Action<IEquipmentEnchantBinder>? _collectionItemRemovedCallback;
        ...
        private readonly Dictionary<IActionableEquipmentEnchantBinder, EquipmentEnchantListItemHandler> _handlers =
            new Dictionary<IActionableEquipmentEnchantBinder, EquipmentEnchantListItemHandler>();
        ...
        private IComparer<IReadOnlyEquipmentEnchantBinder>? _comparer;
        ...
        /// itself is the IReadOnlyList&lt;IActionableEquipmentEnchantBinder&gt;.</summary>
        public IReadOnlyList<IActionableEquipmentEnchantBinder> Binders =>
            (IReadOnlyList<IActionableEquipmentEnchantBinder>?)_collection ?? Array.Empty<IActionableEquipmentEnchantBinder>();
        ...
        public event Action<IActionableEquipmentEnchantBinder>? ItemAdded;

        /// <summary>Fires once for each binder removed.</summary>
        public event Action<IActionableEquipmentEnchantBinder>? ItemRemoved;
        ...
        public IComparer<IReadOnlyEquipmentEnchantBinder>? Comparer
        {
            ...
            set
            {
                ...
                // EquipmentEnchantBinderCollection.EquipmentEnchantBinderComparer.
                var applied = value ?? EquipmentEnchantBinderCollection.EquipmentEnchantBinderComparer.Default;
        ...
        /// to substitute a fake EquipmentEnchantBinderCollection; takes precedence over
        /// the default factory. Pass null to revert to the default. Applies to
        /// the next ReloadAsync.
        /// </summary>
        public void SetBinderFactory(IEquipmentEnchantBinderFactory? factory)
        {
            _binderFactory = factory;
        }

        private IEquipmentEnchantBinderFactory ResolveBinderFactory()
            => _binderFactory ?? DefaultEquipmentEnchantBinderFactory.Instance;
        ...
        /// (the EquipmentEnchantBinderCollection only re-sorts on list-membership
        ...
        public async Task ReloadAsync(CancellationToken cancellationToken = default)
        {
            ...
            var operationGeneration = ++_reloadGeneration;
            IEquipmentEnchantBinderCollection? operationCollection = null;
            try
            {
                Cleanup();
                ...
                await collection.MountFromEnchantEquipmentEnchantMasterDataAsync(cancellationToken);
                ...
                if (_autoSubscribe)
                {
                    ...
                    collection.SubscribeFromEnchantEquipmentEnchantMasterData(collectionChanged, collectionFailed);
                }
        ...
        private bool IsCurrentOperation(long operationGeneration, IEquipmentEnchantBinderCollection? operationCollection)
            => !_isDestroyed
        ...
        private void AttachCollectionCallbacks(
            ...
            IEquipmentEnchantBinderCollection collection)
        {
            Action<IEquipmentEnchantBinder> itemAdded = binder =>
                OnItemAdded(operationGeneration, collection, binder);
            Action<IEquipmentEnchantBinder> itemRemoved = binder =>
        ...
        private void OnItemAdded(
            long operationGeneration,
            IEquipmentEnchantBinderCollection collection,
            IEquipmentEnchantBinder binder)
        {
            if (!IsCurrentOperation(operationGeneration, collection)) return;
        ...
        private void OnCollectionChanged(long operationGeneration, IEquipmentEnchantBinderCollection collection)
        {
            if (!IsCurrentOperation(operationGeneration, collection)) return;
        ...
        private int IndexOf(IActionableEquipmentEnchantBinder binder)
        {
            var binders = Binders;
        ...
        {
            if (!IsCurrentOperation(operationGeneration, collection)) return;
            // The collection is the IReadOnlyList<IActionableEquipmentEnchantBinder>; index it
        ...
        private void Cleanup()
        {
            ...
            var handlers = new List<EquipmentEnchantListItemHandler>(_handlers.Values);
            _collection = null;
