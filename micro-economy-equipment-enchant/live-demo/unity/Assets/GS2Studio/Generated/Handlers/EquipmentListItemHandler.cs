...
{
    /// <summary>
    /// Mounts onto Binders[index] of a parent IEquipmentBinderListSource
    /// (the plain EquipmentListHandler or any ref-scoped variant) and
    ...
    /// </summary>
    [AddComponentMenu("GS2 Studio/DomainType/Equipment/Equipment List Item Handler")]
    public sealed class EquipmentListItemHandler : EquipmentHandlerBase
    {
        ...
        private IEquipmentBinderListSource? _list;
        ...
        /// </summary>
        public void AttachTo(IEquipmentBinderListSource list, int index)
        {
        ...
        private void Start()
        {
            ...
            var list = GetComponentInParent<IEquipmentBinderListSource>();
            if (list == null)
            {
                RaiseFailed(new InvalidOperationException(
                    "No ancestor IEquipmentBinderListSource found in the parent chain."));
                SetContentVisible(false);
                return;
            }
            _list = list;
