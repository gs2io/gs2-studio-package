...
{
    /// <summary>
    /// Pure read contract for <see cref="EquipmentEnchantOptionBinder"/>: the read-only
    /// model surface (<see cref="EquipmentEnchantOption"/>) plus the single-fetch
    ...
    /// </summary>
    public interface IReadOnlyEquipmentEnchantOptionBinder : EquipmentEnchantOption
    {
    }

    /// <summary>
    /// Actionable contract for <see cref="EquipmentEnchantOptionBinder"/>: the read contract
    ...
    /// </summary>
    public interface IActionableEquipmentEnchantOptionBinder : IReadOnlyEquipmentEnchantOptionBinder
    {
    }

    /// <summary>
    /// Owning contract for <see cref="EquipmentEnchantOptionBinder"/>: adds the lifecycle
    /// surface (Subscribe / Invalidate / Dispose) over <see cref="IActionableEquipmentEnchantOptionBinder"/>.
    /// Returned by the binder factory; a fake implementation substitutes the
    /// whole binder.
    /// </summary>
    public interface IEquipmentEnchantOptionBinder : IActionableEquipmentEnchantOptionBinder, IDisposable
    {
    ...
    /// <summary>
    /// Lifecycle-free base for <see cref="EquipmentEnchantOptionBinder"/>.
    /// Owns <c>_model</c> / <c>_gs2</c> / <c>_session</c> and implements the
    /// read-only <see cref="EquipmentEnchantOption"/> contract by forwarding each
    ...
    /// </summary>
    public class ReadOnlyEquipmentEnchantOptionBinder : IReadOnlyEquipmentEnchantOptionBinder
    {
        ...
        private protected readonly MutableEquipmentEnchantOption _model;
        ...
        /// the read-only <c>EquipmentEnchantOption</c> surface this binder implements.
        /// </summary>
        internal MutableEquipmentEnchantOption MutableModel => _model;
        /// <inheritdoc cref="EquipmentEnchantOption.Id" />
        public EquipmentEnchantOptionId Id => _model.Id;
        /// <inheritdoc cref="EquipmentEnchantOption.Enchant" />
        public EquipmentEnchantId Enchant => _model.Enchant;
        /// <inheritdoc cref="EquipmentEnchantOption.ResourceName" />
        public string ResourceName => _model.ResourceName;
        /// <inheritdoc cref="EquipmentEnchantOption.ResourceValue" />
        public long ResourceValue => _model.ResourceValue;
        /// <inheritdoc cref="EquipmentEnchantOption.Weight" />
        ...
        /// </summary>
        private protected ReadOnlyEquipmentEnchantOptionBinder(MutableEquipmentEnchantOption model, Gs2Domain gs2, IGameSession session)
        {
        ...
        /// through the read contract <see cref="IReadOnlyEquipmentEnchantOptionBinder"/>) and
    ...
    /// <summary>
    /// Binder for EquipmentEnchantOption
    /// Binds GS2 resource values to the model and automatically reflects server-side changes
    /// </summary>
    public sealed class EquipmentEnchantOptionBinder : ReadOnlyEquipmentEnchantOptionBinder, IEquipmentEnchantOptionBinder
    {
        ...
        /// </summary>
        internal EquipmentEnchantOptionBinder(
            MutableEquipmentEnchantOption model,
            Gs2Domain gs2,
        ...
        /// <summary>
        /// Creates a EquipmentEnchantOption instance from identity parameters. The
        ...
        /// </summary>
        internal static MutableEquipmentEnchantOption CreateModel(EquipmentEnchantOptionId id)
        {
            var model = new MutableEquipmentEnchantOption();
            model.Id = id;
            return model;
        }

        /// <summary>
        /// Creates a EquipmentEnchantOptionBinder and mounts it to GS2 resources.
        /// This is the only external construction path for mount-based usage.
        /// </summary>
        public static async Task<EquipmentEnchantOptionBinder> CreateAsync(
            ...
            CancellationToken cancellationToken = default)
        {
            ...
            var binder = new EquipmentEnchantOptionBinder(model, gs2, session);
        ...
        public async Task MountAsync(CancellationToken cancellationToken = default)
        {
            ...
            EquipmentEnchantOptionOverlayLoader.Active?.Get(_model.Id.ToString())?.ApplyTo(_model);
            _mounted = true;
        }
        ...
        /// (callable through <see cref="IReadOnlyEquipmentEnchantOptionBinder"/>) and calls
        ...
        private void EnsureActionContext()
        {
            ...
            if (!_mounted)
            {
                throw new InvalidOperationException(
                    $"{nameof(EquipmentEnchantOptionBinder)} is not mounted. Use CreateAsync or one of the list factories.");
            }
        }
