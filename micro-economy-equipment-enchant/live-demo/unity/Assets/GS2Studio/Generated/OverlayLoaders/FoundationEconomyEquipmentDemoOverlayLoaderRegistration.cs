...
{
    internal static class FoundationEconomyEquipmentDemoOverlayLoaderRegistration
    {
        ...
        {
#if UNITY_EDITOR
            EquipmentOverlayLoader.Active = new EditorOverlayLoader<EquipmentOverlayEntry>();
#endif
        }
        ...
        private static void ApplyAddressables()
        {
            ...
            EquipmentOverlayLoader.Active = new AddressablesOverlayLoader<EquipmentOverlayEntry>("Equipment");
#endif
        }

        private static void ApplyResources()
        {
            EquipmentOverlayLoader.Active = new ResourcesOverlayLoader<EquipmentOverlayEntry>("Equipment");
        }
    }
}
