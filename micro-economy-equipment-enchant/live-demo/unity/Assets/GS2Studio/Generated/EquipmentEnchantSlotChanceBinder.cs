...
{
    /// <summary>
    /// Pure read contract for <see cref="EquipmentEnchantSlotChanceBinder"/>: the read-only
    /// model surface (<see cref="EquipmentEnchantSlotChance"/>) plus the single-fetch
    ...
    /// </summary>
    public interface IReadOnlyEquipmentEnchantSlotChanceBinder : EquipmentEnchantSlotChance
    {
    }

    /// <summary>
    /// Actionable contract for <see cref="EquipmentEnchantSlotChanceBinder"/>: the read contract
    ...
    /// </summary>
    public interface IActionableEquipmentEnchantSlotChanceBinder : IReadOnlyEquipmentEnchantSlotChanceBinder
    {
    }

    /// <summary>
    /// Owning contract for <see cref="EquipmentEnchantSlotChanceBinder"/>: adds the lifecycle
    /// surface (Subscribe / Invalidate / Dispose) over <see cref="IActionableEquipmentEnchantSlotChanceBinder"/>.
    /// Returned by the binder factory; a fake implementation substitutes the
    /// whole binder.
    /// </summary>
    public interface IEquipmentEnchantSlotChanceBinder : IActionableEquipmentEnchantSlotChanceBinder, IDisposable
    {
    ...
    /// <summary>
    /// Lifecycle-free base for <see cref="EquipmentEnchantSlotChanceBinder"/>.
    /// Owns <c>_model</c> / <c>_gs2</c> / <c>_session</c> and implements the
    /// read-only <see cref="EquipmentEnchantSlotChance"/> contract by forwarding each
    ...
    /// </summary>
    public class ReadOnlyEquipmentEnchantSlotChanceBinder : IReadOnlyEquipmentEnchantSlotChanceBinder
    {
        ...
        private protected readonly MutableEquipmentEnchantSlotChance _model;
        ...
        /// the read-only <c>EquipmentEnchantSlotChance</c> surface this binder implements.
        /// </summary>
        internal MutableEquipmentEnchantSlotChance MutableModel => _model;
        /// <inheritdoc cref="EquipmentEnchantSlotChance.Id" />
        public EquipmentEnchantSlotChanceId Id => _model.Id;
        /// <inheritdoc cref="EquipmentEnchantSlotChance.Enchant" />
        public EquipmentEnchantId Enchant => _model.Enchant;
        /// <inheritdoc cref="EquipmentEnchantSlotChance.Count" />
        public int Count => _model.Count;
        /// <inheritdoc cref="EquipmentEnchantSlotChance.Weight" />
        ...
        /// </summary>
        private protected ReadOnlyEquipmentEnchantSlotChanceBinder(MutableEquipmentEnchantSlotChance model, Gs2Domain gs2, IGameSession session)
        {
        ...
        /// through the read contract <see cref="IReadOnlyEquipmentEnchantSlotChanceBinder"/>) and
    ...
    /// <summary>
    /// Binder for EquipmentEnchantSlotChance
    /// Binds GS2 resource values to the model and automatically reflects server-side changes
    /// </summary>
    public sealed class EquipmentEnchantSlotChanceBinder : ReadOnlyEquipmentEnchantSlotChanceBinder, IEquipmentEnchantSlotChanceBinder
    {
        ...
        /// </summary>
        internal EquipmentEnchantSlotChanceBinder(
            MutableEquipmentEnchantSlotChance model,
            Gs2Domain gs2,
        ...
        /// <summary>
        /// Creates a EquipmentEnchantSlotChance instance from identity parameters. The
        ...
        /// </summary>
        internal static MutableEquipmentEnchantSlotChance CreateModel(EquipmentEnchantSlotChanceId id)
        {
            var model = new MutableEquipmentEnchantSlotChance();
            model.Id = id;
            return model;
        }

        /// <summary>
        /// Creates a EquipmentEnchantSlotChanceBinder and mounts it to GS2 resources.
        /// This is the only external construction path for mount-based usage.
        /// </summary>
        public static async Task<EquipmentEnchantSlotChanceBinder> CreateAsync(
            ...
            CancellationToken cancellationToken = default)
        {
            ...
            var binder = new EquipmentEnchantSlotChanceBinder(model, gs2, session);
        ...
        public async Task MountAsync(CancellationToken cancellationToken = default)
        {
            ...
            EquipmentEnchantSlotChanceOverlayLoader.Active?.Get(_model.Id.ToString())?.ApplyTo(_model);
            _mounted = true;
        }
        ...
        /// (callable through <see cref="IReadOnlyEquipmentEnchantSlotChanceBinder"/>) and calls
        ...
        private void EnsureActionContext()
        {
            ...
            if (!_mounted)
            {
                throw new InvalidOperationException(
                    $"{nameof(EquipmentEnchantSlotChanceBinder)} is not mounted. Use CreateAsync or one of the list factories.");
            }
        }
