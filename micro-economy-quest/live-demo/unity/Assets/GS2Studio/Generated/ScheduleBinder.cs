...
namespace GS2Studio.Generated.Schedule
{
    ...
    public interface IScheduleBinder : IActionableScheduleBinder, IDisposable
    {
        ...
        void Invalidate();
        Task<GS2Studio.Generated.QuestCollection.IReadOnlyQuestCollectionBinderCollection> GetQuestCollections(CancellationToken cancellationToken = default);
    }
    ...
    public sealed class ScheduleBinder : ReadOnlyScheduleBinder, IScheduleBinder
    {
        ...
        private GS2Studio.Generated.QuestCollection.QuestCollectionBinderCollection? _questCollectionsRoot;
        private Task<GS2Studio.Generated.QuestCollection.QuestCollectionBinderCollection>? _questCollectionsRootTask;
        ...
        public void Dispose()
        {
            ...
            _questCollectionsRoot?.Dispose();

            GC.SuppressFinalize(this);
        }

        #region Reference navigation
        public async Task<GS2Studio.Generated.QuestCollection.IReadOnlyQuestCollectionBinderCollection> GetQuestCollections(CancellationToken cancellationToken = default)
        {
            ThrowIfDisposed();
            var root = await EnsureQuestCollectionsRootAsync(cancellationToken);
            return root.WhereSchedule(_model.Id);
        }
        #endregion

        #region Reference navigation roots
        private async Task<GS2Studio.Generated.QuestCollection.QuestCollectionBinderCollection> EnsureQuestCollectionsRootAsync(CancellationToken cancellationToken)
        {
            if (_questCollectionsRootTask == null)
            {
                _questCollectionsRootTask = BuildQuestCollectionsRootAsync(cancellationToken);
            }
            var task = _questCollectionsRootTask;
            GS2Studio.Generated.QuestCollection.QuestCollectionBinderCollection root;
            try
            {
                root = await task;
            }
            ...
            {
                if (ReferenceEquals(_questCollectionsRootTask, task)) _questCollectionsRootTask = null;
                throw;
            }

            if (_disposed) { root.Dispose(); ThrowIfDisposed(); }
            _questCollectionsRoot = root;
            return _questCollectionsRoot;
        }

        private async Task<GS2Studio.Generated.QuestCollection.QuestCollectionBinderCollection> BuildQuestCollectionsRootAsync(CancellationToken cancellationToken)
        {
            var root = await GS2Studio.Generated.QuestCollection.QuestCollectionBinderCollection.CreateFromQuestQuestMasterDataAsync(_gs2, _session, cancellationToken);
