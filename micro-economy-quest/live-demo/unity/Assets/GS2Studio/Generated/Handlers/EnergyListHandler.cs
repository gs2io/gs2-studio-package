...
{
    /// <summary>
    /// MonoBehaviour list handler for Energy. Owns a
    /// EnergyBinderCollection, instantiates a child EnergyListItemHandler
    ...
    /// IEnergyBinderListSource so items read Binders[Index] through the
    /// shared parent-list surface.
    /// </summary>
    [AddComponentMenu("GS2 Studio/DomainType/Energy/Energy List Handler")]
    public sealed class EnergyListHandler : MonoBehaviour, IEnergyBinderListSource
    {
        // Which of EnergyBinderCollection's mount axes this list reads
        ...
        [SerializeField] private EnergyListAxis _axis;
        [SerializeField] private EnergyListItemHandler? _itemPrefab;
        ...
        // Construction seam. Defaults to DefaultEnergyBinderFactory.Instance;
        // override via SetBinderFactory to substitute a fake collection.
        private IEnergyBinderFactory? _binderFactory;

        private IEnergyBinderCollection? _collection;
        ...
        private Action<IEnergyBinder>? _collectionItemAddedCallback;
        private Action<IEnergyBinder>? _collectionItemRemovedCallback;
        ...
        private readonly Dictionary<IActionableEnergyBinder, EnergyListItemHandler> _handlers =
            new Dictionary<IActionableEnergyBinder, EnergyListItemHandler>();
        ...
        private IComparer<IReadOnlyEnergyBinder>? _comparer;
        ...
        /// itself is the IReadOnlyList&lt;IActionableEnergyBinder&gt;.</summary>
        public IReadOnlyList<IActionableEnergyBinder> Binders =>
            (IReadOnlyList<IActionableEnergyBinder>?)_collection ?? Array.Empty<IActionableEnergyBinder>();
        ...
        public event Action<IActionableEnergyBinder>? ItemAdded;

        /// <summary>Fires once for each binder removed.</summary>
        public event Action<IActionableEnergyBinder>? ItemRemoved;
        ...
        public IComparer<IReadOnlyEnergyBinder>? Comparer
        {
            ...
            set
            {
                ...
                // EnergyBinderCollection.EnergyBinderComparer.
                var applied = value ?? EnergyBinderCollection.EnergyBinderComparer.Default;
        ...
        /// to substitute a fake EnergyBinderCollection; takes precedence over
        /// the default factory. Pass null to revert to the default. Applies to
        /// the next ReloadAsync.
        /// </summary>
        public void SetBinderFactory(IEnergyBinderFactory? factory)
        {
            _binderFactory = factory;
        }

        private IEnergyBinderFactory ResolveBinderFactory()
            => _binderFactory ?? DefaultEnergyBinderFactory.Instance;
        ...
        /// (the EnergyBinderCollection only re-sorts on list-membership
        ...
        public async Task ReloadAsync(CancellationToken cancellationToken = default)
        {
            ...
            var operationGeneration = ++_reloadGeneration;
            IEnergyBinderCollection? operationCollection = null;
            try
            {
                Cleanup();
                ...
                switch (_axis)
                {
                    case EnergyListAxis.StaminaEnergyMaster:
                        await collection.MountFromStaminaEnergyMasterDataAsync(cancellationToken);
                        break;
                    case EnergyListAxis.ExchangeEnergyRecoverMaster:
                        await collection.MountFromExchangeEnergyRecoverMasterDataAsync(cancellationToken);
                        break;
                    case EnergyListAxis.ExchangeEnergyConsumeMaster:
                        await collection.MountFromExchangeEnergyConsumeMasterDataAsync(cancellationToken);
                        break;
                    case EnergyListAxis.StaminaEnergyUser:
                        await collection.MountFromStaminaEnergyUserDataAsync(cancellationToken);
                        break;
                }
                ...
                if (_autoSubscribe)
                {
                    ...
                    {
                        case EnergyListAxis.StaminaEnergyMaster:
                            collection.SubscribeFromStaminaEnergyMasterData(collectionChanged, collectionFailed);
                            break;
                        case EnergyListAxis.ExchangeEnergyRecoverMaster:
                            collection.SubscribeFromExchangeEnergyRecoverMasterData(collectionChanged, collectionFailed);
                            break;
                        case EnergyListAxis.ExchangeEnergyConsumeMaster:
                            collection.SubscribeFromExchangeEnergyConsumeMasterData(collectionChanged, collectionFailed);
                            break;
                        case EnergyListAxis.StaminaEnergyUser:
                            collection.SubscribeFromStaminaEnergyUserData(collectionChanged, collectionFailed);
                            break;
                    }
                }
        ...
        private const string AxisMemberNames = "StaminaEnergyMaster, ExchangeEnergyRecoverMaster, ExchangeEnergyConsumeMaster, StaminaEnergyUser";
        ...
        private bool IsCurrentOperation(long operationGeneration, IEnergyBinderCollection? operationCollection)
            => !_isDestroyed
        ...
        private void AttachCollectionCallbacks(
            ...
            IEnergyBinderCollection collection)
        {
            Action<IEnergyBinder> itemAdded = binder =>
                OnItemAdded(operationGeneration, collection, binder);
            Action<IEnergyBinder> itemRemoved = binder =>
        ...
        private void OnCollectionChanged(long operationGeneration, IEnergyBinderCollection collection)
        {
            if (!IsCurrentOperation(operationGeneration, collection)) return;
        ...
        private int IndexOf(IActionableEnergyBinder binder)
        {
            var binders = Binders;
        ...
        {
            if (!IsCurrentOperation(operationGeneration, collection)) return;
            // The collection is the IReadOnlyList<IActionableEnergyBinder>; index it
        ...
        private void Cleanup()
        {
            ...
            var handlers = new List<EnergyListItemHandler>(_handlers.Values);
            _collection = null;
