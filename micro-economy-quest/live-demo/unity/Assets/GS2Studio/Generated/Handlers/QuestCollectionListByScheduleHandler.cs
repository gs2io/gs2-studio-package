...
{
    /// <summary>
    /// MonoBehaviour list handler for QuestCollection scoped by the
    /// Schedule reference. Auto-resolves a parent
    /// ScheduleHandlerBase from the GameObject hierarchy, owns a
    /// QuestCollectionBinderCollection, and instantiates a child
    /// QuestCollectionListItemHandler only for the binders whose
    /// Schedule equals the parent's id. Implements
    /// IQuestCollectionBinderListSource so items read Binders[Index] through the
    /// shared parent-list surface.
    /// </summary>
    [AddComponentMenu("GS2 Studio/DomainType/QuestCollection/QuestCollection List By Schedule Handler")]
    public sealed class QuestCollectionListByScheduleHandler : MonoBehaviour, IQuestCollectionBinderListSource
    {
        // Which of QuestCollectionBinderCollection's mount axes this list reads
        ...
        // them.
        [SerializeField] private QuestCollectionListAxis _axis;
        ...
        [SerializeField] private QuestCollectionListItemHandler? _itemPrefab;
        ...
        // Construction seam. Defaults to DefaultQuestCollectionBinderFactory.Instance;
        // override via SetBinderFactory to substitute a fake collection.
        private IQuestCollectionBinderFactory? _binderFactory;

        private IQuestCollectionBinderCollection? _collection;
        ...
        private Action<IQuestCollectionBinder>? _collectionItemAddedCallback;
        private Action<IQuestCollectionBinder>? _collectionItemRemovedCallback;
        ...
        // binders' handlers.
        private readonly Dictionary<IActionableQuestCollectionBinder, QuestCollectionListItemHandler> _handlers =
            new Dictionary<IActionableQuestCollectionBinder, QuestCollectionListItemHandler>();
        ...
        private readonly Dictionary<IActionableQuestCollectionBinder, IQuestCollectionBinder> _binderByView =
            new Dictionary<IActionableQuestCollectionBinder, IQuestCollectionBinder>();
        ...
        private readonly List<IActionableQuestCollectionBinder> _visibleBinders =
            new List<IActionableQuestCollectionBinder>();
        ...
        private IComparer<IReadOnlyQuestCollectionBinder>? _comparer;
        ...
        public IReadOnlyList<IActionableQuestCollectionBinder> Binders => _visibleBinders;
        ...
        public event Action<IActionableQuestCollectionBinder>? ItemAdded;
        ...
        public event Action<IActionableQuestCollectionBinder>? ItemRemoved;
        ...
        public IComparer<IReadOnlyQuestCollectionBinder>? Comparer
        {
            ...
            set
            {
                ...
                // QuestCollectionBinderCollection.QuestCollectionBinderComparer.
                var applied = value ?? QuestCollectionBinderCollection.QuestCollectionBinderComparer.Default;
        ...
        /// to substitute a fake QuestCollectionBinderCollection; takes precedence over
        /// the default factory. Pass null to revert to the default. Applies to
        /// the next ReloadAsync.
        /// </summary>
        public void SetBinderFactory(IQuestCollectionBinderFactory? factory)
        {
            _binderFactory = factory;
        }

        private IQuestCollectionBinderFactory ResolveBinderFactory()
            => _binderFactory ?? DefaultQuestCollectionBinderFactory.Instance;
        ...
        /// (the QuestCollectionBinderCollection only re-sorts on list-membership
        ...
        public async Task ReloadAsync(CancellationToken cancellationToken = default)
        {
            ...
            var operationGeneration = ++_reloadGeneration;
            IQuestCollectionBinderCollection? operationCollection = null;
            try
            {
                Cleanup();
                ...
                switch (_axis)
                {
                    case QuestCollectionListAxis.QuestQuestMaster:
                        await collection.MountFromQuestQuestMasterDataAsync(cancellationToken);
                        break;
                    case QuestCollectionListAxis.QuestQuestUser:
                        await collection.MountFromQuestQuestUserDataAsync(cancellationToken);
                        break;
                }
                ...
                if (_autoSubscribe)
                {
                    ...
                    {
                        case QuestCollectionListAxis.QuestQuestMaster:
                            collection.SubscribeFromQuestQuestMasterData(collectionChanged, collectionFailed);
                            break;
                        case QuestCollectionListAxis.QuestQuestUser:
                            collection.SubscribeFromQuestQuestUserData(collectionChanged, collectionFailed);
                            break;
                    }
                }
        ...
        private const string AxisMemberNames = "QuestQuestMaster, QuestQuestUser";
        ...
        private bool MatchesParent(IReadOnlyQuestCollectionBinder binder)
            => binder.Schedule.HasValue && EqualityComparer<ScheduleId>.Default.Equals(binder.Schedule.Value, _parentId);

        private bool IsCurrentOperation(long operationGeneration, IQuestCollectionBinderCollection? operationCollection)
            => !_isDestroyed
        ...
        private void AttachCollectionCallbacks(
            ...
            IQuestCollectionBinderCollection collection)
        {
            Action<IQuestCollectionBinder> itemAdded = binder =>
                OnItemAdded(operationGeneration, collection, binder);
            Action<IQuestCollectionBinder> itemRemoved = binder =>
        ...
        private void OnCollectionChanged(long operationGeneration, IQuestCollectionBinderCollection collection)
        {
            if (!IsCurrentOperation(operationGeneration, collection)) return;
        ...
        private int IndexOf(IActionableQuestCollectionBinder binder)
        {
        ...
        private void DestroyItem(IActionableQuestCollectionBinder binder)
        {
            ...
            IQuestCollectionBinderCollection collection)
        {
            ...
            var visibleSet = new HashSet<IActionableQuestCollectionBinder>(_visibleBinders);
        ...
        private void Cleanup()
        {
            ...
            var handlers = new List<QuestCollectionListItemHandler>(_handlers.Values);
            _collection = null;
