...
namespace GS2Studio.Generated.Quest
{
    ...
    public sealed class QuestListByCollectionHandler : MonoBehaviour, IQuestBinderListSource
    {
        ...
        public async Task ReloadAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                if (_parentHandler == null)
                    throw new InvalidOperationException("Parent QuestCollectionHandlerBase is not assigned and none was found in the parent hierarchy.");
                SubscribeParent();
                var parentBinder = _parentHandler.Binder;
                if (parentBinder == null)
                    throw new InvalidOperationException("Parent QuestCollectionHandlerBase has no bound binder yet.");
        ...
        private void DestroyItem(IActionableQuestBinder binder)
        {
