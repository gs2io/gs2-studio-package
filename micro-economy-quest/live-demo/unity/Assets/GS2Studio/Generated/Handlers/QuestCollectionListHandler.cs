...
{
    /// <summary>
    /// MonoBehaviour list handler for QuestCollection. Owns a
    /// QuestCollectionBinderCollection, instantiates a child QuestCollectionListItemHandler
    ...
    /// </summary>
    [AddComponentMenu("GS2 Studio/DomainType/QuestCollection/QuestCollection List Handler")]
    public sealed class QuestCollectionListHandler : MonoBehaviour, IQuestCollectionBinderListSource
    {
        ...
        /// itself is the IReadOnlyList&lt;IActionableQuestCollectionBinder&gt;.</summary>
        public IReadOnlyList<IActionableQuestCollectionBinder> Binders =>
            (IReadOnlyList<IActionableQuestCollectionBinder>?)_collection ?? Array.Empty<IActionableQuestCollectionBinder>();
        ...
        {
            if (!IsCurrentOperation(operationGeneration, collection)) return;
            // The collection is the IReadOnlyList<IActionableQuestCollectionBinder>; index it
