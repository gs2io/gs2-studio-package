...
{
    /// <summary>
    /// Mounts onto Binders[index] of a parent IQuestCollectionBinderListSource
    /// (the plain QuestCollectionListHandler or any ref-scoped variant) and
    ...
    /// </summary>
    [AddComponentMenu("GS2 Studio/DomainType/QuestCollection/QuestCollection List Item Handler")]
    public sealed class QuestCollectionListItemHandler : QuestCollectionHandlerBase
    {
        ...
        private IQuestCollectionBinderListSource? _list;
        ...
        // non-owning IActionableQuestCollectionBinder.
        private IActionableQuestCollectionBinder? _binder;
        private long _reevaluateGeneration;

        public override IActionableQuestCollectionBinder? Binder => _binder;
        // The binder implements <see cref="QuestCollection"/>, so it is the model.
        ...
        /// </summary>
        public void AttachTo(IQuestCollectionBinderListSource list, int index)
        {
        ...
        private void Start()
        {
            ...
            var list = GetComponentInParent<IQuestCollectionBinderListSource>();
            if (list == null)
            {
                RaiseFailed(new InvalidOperationException(
                    "No ancestor IQuestCollectionBinderListSource found in the parent chain."));
                SetContentVisible(false);
                return;
            }
            _list = list;
