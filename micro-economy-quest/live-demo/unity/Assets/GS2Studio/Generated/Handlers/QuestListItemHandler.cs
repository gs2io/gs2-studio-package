...
{
    /// <summary>
    /// Mounts onto Binders[index] of a parent IQuestBinderListSource
    /// (the plain QuestListHandler or any ref-scoped variant) and
    ...
    /// </summary>
    [AddComponentMenu("GS2 Studio/DomainType/Quest/Quest List Item Handler")]
    public sealed class QuestListItemHandler : QuestHandlerBase
    {
        ...
        private IQuestBinderListSource? _list;
        ...
        // non-owning IActionableQuestBinder.
        private IActionableQuestBinder? _binder;
        private long _reevaluateGeneration;

        public override IActionableQuestBinder? Binder => _binder;
        // The binder implements <see cref="Quest"/>, so it is the model.
        ...
        /// </summary>
        public void AttachTo(IQuestBinderListSource list, int index)
        {
        ...
        private void Start()
        {
            ...
            var list = GetComponentInParent<IQuestBinderListSource>();
            if (list == null)
            {
                RaiseFailed(new InvalidOperationException(
                    "No ancestor IQuestBinderListSource found in the parent chain."));
                SetContentVisible(false);
                return;
            }
            _list = list;
