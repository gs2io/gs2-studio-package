...
namespace GS2Studio.Generated.Quest.UI
{
    ...
    /// <c>Cleared</c>. Each <c>{key}</c> placeholder is
    ...
    /// </summary>
    [AddComponentMenu("GS2 Studio/DomainType/Quest/TemplateLabel/ClearedLabel")]
    public sealed class QuestClearedLabel : MonoBehaviour
    {
        ...
        private void OnEnable()
        {
            ...
            if (_handler == null)
            {
                ...
                if (!_warnedMissingHandler)
                {
                    ...
                    Debug.LogWarning(
                        $"{nameof(QuestClearedLabel)} on '{name}': no QuestHandlerBase found in the parent chain; component inactive.", this);
                }
                return;
            }
            if (!_subscribed)
