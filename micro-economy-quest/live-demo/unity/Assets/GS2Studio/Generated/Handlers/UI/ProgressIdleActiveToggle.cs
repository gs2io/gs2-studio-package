...
namespace GS2Studio.Generated.Progress.UI
{
    ...
    /// based on the condition <c>not(truthy(inProgress))</c> evaluated
    ...
    /// </summary>
    [AddComponentMenu("GS2 Studio/DomainType/Progress/ActiveToggle/IdleActiveToggle")]
    public sealed class ProgressIdleActiveToggle : MonoBehaviour
    {
        ...
        private void OnEnable()
        {
            ...
            if (_handler == null)
            {
                ...
                if (!_warnedMissingHandler)
                {
                    ...
                    Debug.LogWarning(
                        $"{nameof(ProgressIdleActiveToggle)} on '{name}': no ProgressHandlerBase found in the parent chain; component inactive.", this);
                }
                return;
            }
            if (!_subscribed)
