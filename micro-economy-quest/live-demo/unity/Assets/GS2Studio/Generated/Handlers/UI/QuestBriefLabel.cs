...
namespace GS2Studio.Generated.Quest.UI
{
    ...
    /// </summary>
    [AddComponentMenu("GS2 Studio/DomainType/Quest/TemplateLabel/BriefLabel")]
    public sealed class QuestBriefLabel : MonoBehaviour
    {
        ...
        private void OnEnable()
        {
            ...
            if (_handler == null)
            {
                ...
                if (!_warnedMissingHandler)
                {
                    ...
                    Debug.LogWarning(
                        $"{nameof(QuestBriefLabel)} on '{name}': no QuestHandlerBase found in the parent chain; component inactive.", this);
                }
                return;
            }
            if (!_subscribed)
