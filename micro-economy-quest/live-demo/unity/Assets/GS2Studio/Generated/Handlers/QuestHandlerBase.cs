...
namespace GS2Studio.Generated.Quest
{
    ...
    /// QuestBinder: the standalone/list QuestHandler and the
    /// slot-bound QuestListItemHandler. Concrete handlers supply the
    ...
    public abstract class QuestHandlerBase : MonoBehaviour
    {
        ...
        public abstract IActionableQuestBinder? Binder { get; }

        /// <summary>The bound model, or null when no binder is attached.</summary>
        public abstract Quest? Model { get; }
        ...
        public event Action<IActionableQuestBinder>? Bound;
        ...
        protected void RaiseUpdated(Quest model) => Updated?.Invoke(model);
        protected void RaiseBound(IActionableQuestBinder binder) => Bound?.Invoke(binder);
