...
{
    internal static class FoundationEconomyCurrencyDemoOverlayLoaderRegistration
    {
        ...
        {
#if UNITY_EDITOR
            StorePriceOverlayLoader.Active = new EditorOverlayLoader<StorePriceOverlayEntry>();
#endif
        }
        ...
        private static void ApplyAddressables()
        {
            ...
            StorePriceOverlayLoader.Active = new AddressablesOverlayLoader<StorePriceOverlayEntry>("StorePrice");
#endif
        }

        private static void ApplyResources()
        {
            StorePriceOverlayLoader.Active = new ResourcesOverlayLoader<StorePriceOverlayEntry>("StorePrice");
        }
    }
}
