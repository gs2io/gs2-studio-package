...
{
    /// <summary>
    /// Pure read contract for <see cref="CharacterFormationSlotBinder"/>: the read-only
    /// model surface (<see cref="CharacterFormationSlot"/>) plus the single-fetch
    ...
    /// </summary>
    public interface IReadOnlyCharacterFormationSlotBinder : CharacterFormationSlot
    {
    }

    /// <summary>
    /// Actionable contract for <see cref="CharacterFormationSlotBinder"/>: the read contract
    ...
    /// </summary>
    public interface IActionableCharacterFormationSlotBinder : IReadOnlyCharacterFormationSlotBinder
    {
    }

    /// <summary>
    /// Owning contract for <see cref="CharacterFormationSlotBinder"/>: adds the lifecycle
    /// surface (Subscribe / Invalidate / Dispose) over <see cref="IActionableCharacterFormationSlotBinder"/>.
    /// Returned by the binder factory; a fake implementation substitutes the
    /// whole binder.
    /// </summary>
    public interface ICharacterFormationSlotBinder : IActionableCharacterFormationSlotBinder, IDisposable
    {
    ...
    /// <summary>
    /// Lifecycle-free base for <see cref="CharacterFormationSlotBinder"/>.
    /// Owns <c>_model</c> / <c>_gs2</c> / <c>_session</c> and implements the
    /// read-only <see cref="CharacterFormationSlot"/> contract by forwarding each
    ...
    /// </summary>
    public class ReadOnlyCharacterFormationSlotBinder : IReadOnlyCharacterFormationSlotBinder
    {
        ...
        private protected readonly MutableCharacterFormationSlot _model;
        ...
        /// the read-only <c>CharacterFormationSlot</c> surface this binder implements.
        /// </summary>
        internal MutableCharacterFormationSlot MutableModel => _model;
        /// <inheritdoc cref="CharacterFormationSlot.Id" />
        public CharacterFormationSlotId Id => _model.Id;
        /// <inheritdoc cref="CharacterFormationSlot.PropertyRegex" />
        public string? PropertyRegex => _model.PropertyRegex;
        /// <summary>
        ...
        /// </summary>
        private protected ReadOnlyCharacterFormationSlotBinder(MutableCharacterFormationSlot model, Gs2Domain gs2, IGameSession session)
        {
        ...
        /// through the read contract <see cref="IReadOnlyCharacterFormationSlotBinder"/>) and
    ...
    /// <summary>
    /// Binder for CharacterFormationSlot
    /// Binds GS2 resource values to the model and automatically reflects server-side changes
    /// </summary>
    public sealed class CharacterFormationSlotBinder : ReadOnlyCharacterFormationSlotBinder, ICharacterFormationSlotBinder
    {
        ...
        /// </summary>
        internal CharacterFormationSlotBinder(
            MutableCharacterFormationSlot model,
            Gs2Domain gs2,
        ...
        /// <summary>
        /// Creates a CharacterFormationSlot instance from identity parameters. The
        ...
        /// </summary>
        internal static MutableCharacterFormationSlot CreateModel(CharacterFormationSlotId id)
        {
            var model = new MutableCharacterFormationSlot();
            model.Id = id;
            return model;
        }

        /// <summary>
        /// Creates a CharacterFormationSlotBinder and mounts it to GS2 resources.
        /// This is the only external construction path for mount-based usage.
        /// </summary>
        public static async Task<CharacterFormationSlotBinder> CreateAsync(
            ...
            CancellationToken cancellationToken = default)
        {
            ...
            var binder = new CharacterFormationSlotBinder(model, gs2, session);
        ...
        /// (callable through <see cref="IReadOnlyCharacterFormationSlotBinder"/>) and calls
        ...
        private void EnsureActionContext()
        {
            ...
            if (!_mounted)
            {
                throw new InvalidOperationException(
                    $"{nameof(CharacterFormationSlotBinder)} is not mounted. Use CreateAsync or one of the list factories.");
            }
        }
