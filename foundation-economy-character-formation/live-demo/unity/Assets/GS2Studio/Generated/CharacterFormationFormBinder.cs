...
{
    /// <summary>
    /// Pure read contract for <see cref="CharacterFormationFormBinder"/>: the read-only
    /// model surface (<see cref="CharacterFormationForm"/>) plus the single-fetch
    ...
    /// </summary>
    public interface IReadOnlyCharacterFormationFormBinder : CharacterFormationForm
    {
    }

    /// <summary>
    /// Actionable contract for <see cref="CharacterFormationFormBinder"/>: the read contract
    ...
    /// </summary>
    public interface IActionableCharacterFormationFormBinder : IReadOnlyCharacterFormationFormBinder
    {
    }

    /// <summary>
    /// Owning contract for <see cref="CharacterFormationFormBinder"/>: adds the lifecycle
    /// surface (Subscribe / Invalidate / Dispose) over <see cref="IActionableCharacterFormationFormBinder"/>.
    /// Returned by the binder factory; a fake implementation substitutes the
    /// whole binder.
    /// </summary>
    public interface ICharacterFormationFormBinder : IActionableCharacterFormationFormBinder, IDisposable
    {
    ...
    /// <summary>
    /// Lifecycle-free base for <see cref="CharacterFormationFormBinder"/>.
    /// Owns <c>_model</c> / <c>_gs2</c> / <c>_session</c> and implements the
    /// read-only <see cref="CharacterFormationForm"/> contract by forwarding each
    ...
    /// </summary>
    public class ReadOnlyCharacterFormationFormBinder : IReadOnlyCharacterFormationFormBinder
    {
        ...
        private protected readonly MutableCharacterFormationForm _model;
        ...
        /// the read-only <c>CharacterFormationForm</c> surface this binder implements.
        /// </summary>
        internal MutableCharacterFormationForm MutableModel => _model;
        /// <inheritdoc cref="CharacterFormationForm.Id" />
        public CharacterFormationFormId Id => _model.Id;
        /// <inheritdoc cref="CharacterFormationForm.Slots" />
        public IReadOnlyList<GS2Studio.Generated.CharacterFormationFormSlot.CharacterFormationFormSlot>? Slots => _model.Slots;
        /// <summary>
        ...
        /// </summary>
        private protected ReadOnlyCharacterFormationFormBinder(MutableCharacterFormationForm model, Gs2Domain gs2, IGameSession session)
        {
        ...
        /// through the read contract <see cref="IReadOnlyCharacterFormationFormBinder"/>) and
    ...
    /// <summary>
    /// Binder for CharacterFormationForm
    /// Binds GS2 resource values to the model and automatically reflects server-side changes
    /// </summary>
    public sealed class CharacterFormationFormBinder : ReadOnlyCharacterFormationFormBinder, ICharacterFormationFormBinder
    {
        private readonly List<Action> _unsubscribers = new List<Action>();
        private bool _disposed;
        internal bool _mounted;

        private readonly Gs2Bind.Gs2Formation.FormLoader __userdataFormationFormLoader;
        ...
        /// </summary>
        internal CharacterFormationFormBinder(
            MutableCharacterFormationForm model,
            Gs2Domain gs2,
            IGameSession session,
            int index
        ) : base(model, gs2, session)
        {
            __userdataFormationFormLoader = new Gs2Bind.Gs2Formation.FormLoader("CharacterFormation", "CharacterFormation", index);
        }

        /// <summary>
        /// Creates a CharacterFormationForm instance from identity parameters. The
        ...
        /// </summary>
        internal static MutableCharacterFormationForm CreateModel(CharacterFormationFormId id)
        {
            var model = new MutableCharacterFormationForm();
            model.Id = id;
            return model;
        }

        /// <summary>
        /// Creates a CharacterFormationFormBinder and mounts it to GS2 resources.
        /// This is the only external construction path for mount-based usage.
        /// </summary>
        public static async Task<CharacterFormationFormBinder> CreateAsync(
            ...
            CancellationToken cancellationToken = default)
        {
            ...
            var binder = new CharacterFormationFormBinder(model, gs2, session, index: index);
        ...
        public async Task MountAsync(CancellationToken cancellationToken = default)
        {
            ...
            var _userdataFormationForm = await __userdataFormationFormLoader.Load(_gs2, _session);
            cancellationToken.ThrowIfCancellationRequested();
            if (_userdataFormationForm != null)
            {
                // Skip primary id assignment
            }
            var __slotsItems = new List<GS2Studio.Generated.CharacterFormationFormSlot.CharacterFormationFormSlot>();
            if (_userdataFormationForm?.Slots != null)
            {
                foreach (var __element in _userdataFormationForm.Slots)
                {
                    if (__element == null) continue;
                    if (__element.PropertyId == null) continue;
                    var row = new GS2Studio.Generated.CharacterFormationFormSlot.MutableCharacterFormationFormSlot();
                    row.Id = string.IsNullOrEmpty(__element.Name) ? default(GS2Studio.Generated.CharacterFormationFormSlot.CharacterFormationFormSlotId) : new GS2Studio.Generated.CharacterFormationFormSlot.CharacterFormationFormSlotId(__element.Name);
                    row.PropertyId = __element.PropertyId;
                    __slotsItems.Add(row);
                }
            }
            _model.Slots = __slotsItems;
            _mounted = true;
        }
        ...
        {
            ThrowIfDisposed();
            _unsubscribers.Add(__userdataFormationFormLoader.Subscribe(
                _gs2,
                _session,
                (_, _, value) =>
                {
                    ...
                    if (value?.Slots != null)
                    {
                        foreach (var __element in value.Slots)
                        {
                            if (__element == null) continue;
                            if (__element.PropertyId == null) continue;
                            var row = new GS2Studio.Generated.CharacterFormationFormSlot.MutableCharacterFormationFormSlot();
        ...
        {
            ThrowIfDisposed();
            __userdataFormationFormLoader.Invalidate(_gs2, _session);
        }
        ...
        /// (callable through <see cref="IReadOnlyCharacterFormationFormBinder"/>) and calls
        ...
        private void EnsureActionContext()
        {
            ...
            if (!_mounted)
            {
                throw new InvalidOperationException(
                    $"{nameof(CharacterFormationFormBinder)} is not mounted. Use CreateAsync or one of the list factories.");
            }
        }
