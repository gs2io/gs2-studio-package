...
{
    /// <summary>
    /// MonoBehaviour list handler for CharacterFormationForm. Owns a
    /// CharacterFormationFormBinderCollection, instantiates a child CharacterFormationFormListItemHandler
    ...
    /// ICharacterFormationFormBinderListSource so items read Binders[Index] through the
    /// shared parent-list surface.
    /// </summary>
    [AddComponentMenu("GS2 Studio/DomainType/CharacterFormationForm/CharacterFormationForm List Handler")]
    public sealed class CharacterFormationFormListHandler : MonoBehaviour, ICharacterFormationFormBinderListSource
    {
        [SerializeField] private string? _moldModelName;
        [SerializeField] private CharacterFormationFormListItemHandler? _itemPrefab;
        ...
        // Construction seam. Defaults to DefaultCharacterFormationFormBinderFactory.Instance;
        // override via SetBinderFactory to substitute a fake collection.
        private ICharacterFormationFormBinderFactory? _binderFactory;

        private ICharacterFormationFormBinderCollection? _collection;
        ...
        private Action<ICharacterFormationFormBinder>? _collectionItemAddedCallback;
        private Action<ICharacterFormationFormBinder>? _collectionItemRemovedCallback;
        ...
        private readonly Dictionary<IActionableCharacterFormationFormBinder, CharacterFormationFormListItemHandler> _handlers =
            new Dictionary<IActionableCharacterFormationFormBinder, CharacterFormationFormListItemHandler>();
        ...
        private IComparer<IReadOnlyCharacterFormationFormBinder>? _comparer;
        ...
        /// itself is the IReadOnlyList&lt;IActionableCharacterFormationFormBinder&gt;.</summary>
        public IReadOnlyList<IActionableCharacterFormationFormBinder> Binders =>
            (IReadOnlyList<IActionableCharacterFormationFormBinder>?)_collection ?? Array.Empty<IActionableCharacterFormationFormBinder>();
        ...
        public event Action<IActionableCharacterFormationFormBinder>? ItemAdded;

        /// <summary>Fires once for each binder removed.</summary>
        public event Action<IActionableCharacterFormationFormBinder>? ItemRemoved;
        ...
        public IComparer<IReadOnlyCharacterFormationFormBinder>? Comparer
        {
            ...
            set
            {
                ...
                // CharacterFormationFormBinderCollection.CharacterFormationFormBinderComparer.
                var applied = value ?? CharacterFormationFormBinderCollection.CharacterFormationFormBinderComparer.Default;
        ...
        /// to substitute a fake CharacterFormationFormBinderCollection; takes precedence over
        /// the default factory. Pass null to revert to the default. Applies to
        /// the next ReloadAsync.
        /// </summary>
        public void SetBinderFactory(ICharacterFormationFormBinderFactory? factory)
        {
            _binderFactory = factory;
        }

        private ICharacterFormationFormBinderFactory ResolveBinderFactory()
            => _binderFactory ?? DefaultCharacterFormationFormBinderFactory.Instance;
        ...
        /// </summary>
        public void SetScope(string moldModelName)
        {
        ...
        /// (the CharacterFormationFormBinderCollection only re-sorts on list-membership
        ...
        public async Task ReloadAsync(CancellationToken cancellationToken = default)
        {
            ...
            var operationGeneration = ++_reloadGeneration;
            ICharacterFormationFormBinderCollection? operationCollection = null;
            try
            {
                Cleanup();
                ...
                var collection = ResolveBinderFactory().CreateCollection(gs2, session, _moldModelName ?? string.Empty);
                ...
                await collection.MountFromFormationCharacterFormationUserDataAsync(cancellationToken);
                ...
                if (_autoSubscribe)
                {
                    ...
                    collection.SubscribeFromFormationCharacterFormationUserData(collectionChanged, collectionFailed);
                }
        ...
        private bool IsReadyForReload()
        {
            ...
            if (string.IsNullOrEmpty(_moldModelName)) return false;
            return true;
        }

        private bool IsCurrentOperation(long operationGeneration, ICharacterFormationFormBinderCollection? operationCollection)
            => !_isDestroyed
        ...
        private void AttachCollectionCallbacks(
            ...
            ICharacterFormationFormBinderCollection collection)
        {
            Action<ICharacterFormationFormBinder> itemAdded = binder =>
                OnItemAdded(operationGeneration, collection, binder);
            Action<ICharacterFormationFormBinder> itemRemoved = binder =>
        ...
        private void OnItemAdded(
            long operationGeneration,
            ICharacterFormationFormBinderCollection collection,
            ICharacterFormationFormBinder binder)
        {
            if (!IsCurrentOperation(operationGeneration, collection)) return;
        ...
        private void OnCollectionChanged(long operationGeneration, ICharacterFormationFormBinderCollection collection)
        {
            if (!IsCurrentOperation(operationGeneration, collection)) return;
        ...
        private int IndexOf(IActionableCharacterFormationFormBinder binder)
        {
            var binders = Binders;
        ...
        {
            if (!IsCurrentOperation(operationGeneration, collection)) return;
            // The collection is the IReadOnlyList<IActionableCharacterFormationFormBinder>; index it
        ...
        private void Cleanup()
        {
            ...
            var handlers = new List<CharacterFormationFormListItemHandler>(_handlers.Values);
            _collection = null;
