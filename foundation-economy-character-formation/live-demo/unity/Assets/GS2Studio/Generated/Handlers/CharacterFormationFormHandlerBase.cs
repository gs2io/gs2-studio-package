...
namespace GS2Studio.Generated.CharacterFormationForm
{
    ...
    /// CharacterFormationFormBinder: the standalone/list CharacterFormationFormHandler and the
    /// slot-bound CharacterFormationFormListItemHandler. Concrete handlers supply the
    ...
    /// </summary>
    public abstract class CharacterFormationFormHandlerBase : MonoBehaviour
    {
        /// <summary>The bound binder (non-owning actionable view), or null when none is attached.</summary>
        public abstract IActionableCharacterFormationFormBinder? Binder { get; }

        /// <summary>The bound model, or null when no binder is attached.</summary>
        public abstract CharacterFormationForm? Model { get; }
        ...
        public event Action<CharacterFormationForm>? Updated;

        /// <summary>Fires once each time a binder is attached (non-owning actionable view).</summary>
        public event Action<IActionableCharacterFormationFormBinder>? Bound;
        ...
        protected void RaiseUpdated(CharacterFormationForm model) => Updated?.Invoke(model);
        protected void RaiseBound(IActionableCharacterFormationFormBinder binder) => Bound?.Invoke(binder);
