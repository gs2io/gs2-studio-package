...
{
    /// <summary>
    /// Mounts onto Binders[index] of a parent ICharacterFormationFormBinderListSource
    /// (the plain CharacterFormationFormListHandler or any ref-scoped variant) and
    ...
    /// </summary>
    [AddComponentMenu("GS2 Studio/DomainType/CharacterFormationForm/CharacterFormationForm List Item Handler")]
    public sealed class CharacterFormationFormListItemHandler : CharacterFormationFormHandlerBase
    {
        ...
        private ICharacterFormationFormBinderListSource? _list;
        ...
        // non-owning IActionableCharacterFormationFormBinder.
        private IActionableCharacterFormationFormBinder? _binder;
        private long _reevaluateGeneration;

        public override IActionableCharacterFormationFormBinder? Binder => _binder;
        // The binder implements <see cref="CharacterFormationForm"/>, so it is the model.
        ...
        /// </summary>
        public void AttachTo(ICharacterFormationFormBinderListSource list, int index)
        {
        ...
        private void Start()
        {
            ...
            var list = GetComponentInParent<ICharacterFormationFormBinderListSource>();
            if (list == null)
            {
                RaiseFailed(new InvalidOperationException(
                    "No ancestor ICharacterFormationFormBinderListSource found in the parent chain."));
                SetContentVisible(false);
                return;
            }
            _list = list;
