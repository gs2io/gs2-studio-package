...
namespace GS2Studio.Generated.CharacterFormationSlot
{
    ...
    /// CharacterFormationSlotBinder: the standalone/list CharacterFormationSlotHandler and the
    /// slot-bound CharacterFormationSlotListItemHandler. Concrete handlers supply the
    ...
    /// </summary>
    public abstract class CharacterFormationSlotHandlerBase : MonoBehaviour
    {
        /// <summary>The bound binder (non-owning actionable view), or null when none is attached.</summary>
        public abstract IActionableCharacterFormationSlotBinder? Binder { get; }

        /// <summary>The bound model, or null when no binder is attached.</summary>
        public abstract CharacterFormationSlot? Model { get; }
        ...
        public event Action<CharacterFormationSlot>? Updated;

        /// <summary>Fires once each time a binder is attached (non-owning actionable view).</summary>
        public event Action<IActionableCharacterFormationSlotBinder>? Bound;
        ...
        protected void RaiseUpdated(CharacterFormationSlot model) => Updated?.Invoke(model);
        protected void RaiseBound(IActionableCharacterFormationSlotBinder binder) => Bound?.Invoke(binder);
