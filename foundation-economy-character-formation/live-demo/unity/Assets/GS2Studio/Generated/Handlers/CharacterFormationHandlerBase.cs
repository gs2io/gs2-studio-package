...
namespace GS2Studio.Generated.CharacterFormation
{
    ...
    /// CharacterFormationBinder: the standalone/list CharacterFormationHandler and the
    /// slot-bound CharacterFormationListItemHandler. Concrete handlers supply the
    ...
    /// </summary>
    public abstract class CharacterFormationHandlerBase : MonoBehaviour
    {
        /// <summary>The bound binder (non-owning actionable view), or null when none is attached.</summary>
        public abstract IActionableCharacterFormationBinder? Binder { get; }

        /// <summary>The bound model, or null when no binder is attached.</summary>
        public abstract CharacterFormation? Model { get; }
        ...
        public event Action<CharacterFormation>? Updated;

        /// <summary>Fires once each time a binder is attached (non-owning actionable view).</summary>
        public event Action<IActionableCharacterFormationBinder>? Bound;
        ...
        protected void RaiseUpdated(CharacterFormation model) => Updated?.Invoke(model);
        protected void RaiseBound(IActionableCharacterFormationBinder binder) => Bound?.Invoke(binder);
