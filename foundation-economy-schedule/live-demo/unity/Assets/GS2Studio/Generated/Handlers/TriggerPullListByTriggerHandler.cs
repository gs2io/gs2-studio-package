...
{
    /// <summary>
    /// MonoBehaviour list handler for TriggerPull scoped by the
    /// Trigger reference. Auto-resolves a parent
    /// TriggerHandlerBase from the GameObject hierarchy, owns a
    /// TriggerPullBinderCollection, and instantiates a child
    /// TriggerPullListItemHandler only for the binders whose
    /// Trigger equals the parent's id. Implements
    /// ITriggerPullBinderListSource so items read Binders[Index] through the
    ...
    public sealed class TriggerPullListByTriggerHandler : MonoBehaviour, ITriggerPullBinderListSource
    {
        ...
        [SerializeField] private TriggerHandlerBase? _parentHandler;
        [SerializeField] private TriggerPullListItemHandler? _itemPrefab;
        ...
        // Construction seam. Defaults to DefaultTriggerPullBinderFactory.Instance;
        // override via SetBinderFactory to substitute a fake collection.
        private ITriggerPullBinderFactory? _binderFactory;

        private ITriggerPullBinderCollection? _collection;
        ...
        private TriggerHandlerBase? _subscribedParent;
        ...
        // binders' handlers.
        private readonly Dictionary<IActionableTriggerPullBinder, TriggerPullListItemHandler> _handlers =
            new Dictionary<IActionableTriggerPullBinder, TriggerPullListItemHandler>();
        ...
        private readonly Dictionary<IActionableTriggerPullBinder, ITriggerPullBinder> _binderByView =
            new Dictionary<IActionableTriggerPullBinder, ITriggerPullBinder>();
        ...
        private readonly List<IActionableTriggerPullBinder> _visibleBinders =
            new List<IActionableTriggerPullBinder>();
        ...
        private IComparer<IReadOnlyTriggerPullBinder>? _comparer;
        ...
        public IReadOnlyList<IActionableTriggerPullBinder> Binders => _visibleBinders;
        ...
        public event Action<IActionableTriggerPullBinder>? ItemAdded;
        ...
        public event Action<IActionableTriggerPullBinder>? ItemRemoved;
        ...
        public IComparer<IReadOnlyTriggerPullBinder>? Comparer
        {
            ...
            set
            {
                ...
                // TriggerPullBinderCollection.TriggerPullBinderComparer.
                var applied = value ?? TriggerPullBinderCollection.TriggerPullBinderComparer.Default;
        ...
        /// to substitute a fake TriggerPullBinderCollection; takes precedence over
        /// the default factory. Pass null to revert to the default. Applies to
        /// the next ReloadAsync.
        /// </summary>
        public void SetBinderFactory(ITriggerPullBinderFactory? factory)
        {
            _binderFactory = factory;
        }

        private ITriggerPullBinderFactory ResolveBinderFactory()
            => _binderFactory ?? DefaultTriggerPullBinderFactory.Instance;
        ...
        /// (the TriggerPullBinderCollection only re-sorts on list-membership
        ...
        public async Task ReloadAsync(CancellationToken cancellationToken = default)
        {
            ...
            var operationGeneration = ++_reloadGeneration;
            ITriggerPullBinderCollection? operationCollection = null;
            try
            {
                Cleanup();
                ...
                if (_parentHandler == null)
                    throw new InvalidOperationException("Parent TriggerHandlerBase is not assigned and none was found in the parent hierarchy.");
                SubscribeParent();
                var parentBinder = _parentHandler.Binder;
                if (parentBinder == null)
                    throw new InvalidOperationException("Parent TriggerHandlerBase has no bound binder yet.");
                ...
                await collection.MountFromExchangeTriggerPullMasterDataAsync(cancellationToken);
                ...
                if (_autoSubscribe)
                {
                    ...
                    collection.SubscribeFromExchangeTriggerPullMasterData(collectionChanged, collectionFailed);
                }
        ...
        private void ResolveParentHandler()
        {
            ...
            // TriggerHandlerBase GameObject.
            if (_parentHandler == null)
            {
                _parentHandler = GetComponentInParent<TriggerHandlerBase>();
            }
        }
        ...
        /// </summary>
        private void OnParentBound(IActionableTriggerBinder binder)
        {
            _parentId = binder.Id;
            var collection = _collection;
            if (collection == null) return;
        ...
        private bool IsCurrentOperation(long operationGeneration, ITriggerPullBinderCollection? operationCollection)
            => !_isDestroyed
        ...
        private void AttachCollectionCallbacks(
            ...
            ITriggerPullBinderCollection collection)
        {
            Action<ITriggerPullBinder> itemAdded = binder =>
                OnItemAdded(operationGeneration, collection, binder);
            Action<ITriggerPullBinder> itemRemoved = binder =>
        ...
        private void OnCollectionChanged(long operationGeneration, ITriggerPullBinderCollection collection)
        {
            if (!IsCurrentOperation(operationGeneration, collection)) return;
        ...
        private int IndexOf(IActionableTriggerPullBinder binder)
        {
        ...
        private void DestroyItem(IActionableTriggerPullBinder binder)
        {
            ...
            ITriggerPullBinderCollection collection)
        {
            ...
            var visibleSet = new HashSet<IActionableTriggerPullBinder>(_visibleBinders);
        ...
        private void Cleanup()
        {
            ...
            var handlers = new List<TriggerPullListItemHandler>(_handlers.Values);
            _collection = null;
