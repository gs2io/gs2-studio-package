...
{
    /// <summary>
    /// Mounts onto Binders[index] of a parent ITriggerBinderListSource
    /// (the plain TriggerListHandler or any ref-scoped variant) and
    ...
    /// </summary>
    [AddComponentMenu("GS2 Studio/DomainType/Trigger/Trigger List Item Handler")]
    public sealed class TriggerListItemHandler : TriggerHandlerBase
    {
        ...
        private ITriggerBinderListSource? _list;
        ...
        // non-owning IActionableTriggerBinder.
        private IActionableTriggerBinder? _binder;

        public override IActionableTriggerBinder? Binder => _binder;
        // The binder implements <see cref="Trigger"/>, so it is the model.
        ...
        /// </summary>
        public void AttachTo(ITriggerBinderListSource list, int index)
        {
        ...
        private void Start()
        {
            ...
            var list = GetComponentInParent<ITriggerBinderListSource>();
            if (list == null)
            {
                RaiseFailed(new InvalidOperationException(
                    "No ancestor ITriggerBinderListSource found in the parent chain."));
                SetContentVisible(false);
                return;
            }
            _list = list;
