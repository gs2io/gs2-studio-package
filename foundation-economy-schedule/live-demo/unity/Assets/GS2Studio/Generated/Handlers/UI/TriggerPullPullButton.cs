        ...
        private async void OnClicked()
        {
            if (_handler == null)
            {
                ...
                if (!_warnedMissingHandler)
                {
                    ...
                    Debug.LogWarning(
                        $"{nameof(TriggerPullPullButton)} on '{name}': no TriggerPullHandlerBase found in the parent chain; click ignored.", this);
                }
                return;
            }
            ...
            {
                UnityEngine.Debug.LogError($"TriggerPullPullButton: Pull failed: {ex}");
                return;
            }
            _onCompleted.Invoke();
        }
