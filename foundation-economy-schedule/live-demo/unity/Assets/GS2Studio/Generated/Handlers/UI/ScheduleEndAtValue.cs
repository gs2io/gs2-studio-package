...
{
    /// <summary>
    /// UI value bound to <c>Schedule.endAt</c>.
    ...
    /// persists it.
    /// </summary>
    [AddComponentMenu("GS2 Studio/DomainType/Schedule/Value/EndAtValue")]
    public sealed class ScheduleEndAtValue : MonoBehaviour
    {
        ...
        private void OnEnable()
        {
            ...
            if (_handler == null)
            {
                ...
                if (!_warnedMissingHandler)
                {
                    ...
                    Debug.LogWarning(
                        $"{nameof(ScheduleEndAtValue)} on '{name}': no ScheduleHandlerBase found in the parent chain; component inactive.", this);
                }
                return;
            }
            if (!_subscribed)
        ...
        {
            _onUpdate.Invoke(model.EndAt.GetValueOrDefault());
        }
