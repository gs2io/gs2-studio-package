...
namespace GS2Studio.Generated.Schedule.UI
{
    ...
    /// based on the condition <c>eq(scheduleType, absolute)</c> evaluated
    /// against the sibling <c>ScheduleHandler.Model</c>:
    /// <list type="bullet">
    ...
    /// <c>ScheduleHandler</c> or <c>ScheduleListItemHandler</c>;
    ...
    /// </summary>
    [AddComponentMenu("GS2 Studio/DomainType/Schedule/ActiveToggle/AbsoluteActiveToggle")]
    public sealed class ScheduleAbsoluteActiveToggle : MonoBehaviour
    {
        ...
        private void OnEnable()
        {
            ...
            if (_handler == null)
            {
                ...
                if (!_warnedMissingHandler)
                {
                    ...
                    Debug.LogWarning(
                        $"{nameof(ScheduleAbsoluteActiveToggle)} on '{name}': no ScheduleHandlerBase found in the parent chain; component inactive.", this);
                }
                return;
            }
            if (!_subscribed)
        ...
        {
            bool result = object.Equals(model.ScheduleType, "absolute");
