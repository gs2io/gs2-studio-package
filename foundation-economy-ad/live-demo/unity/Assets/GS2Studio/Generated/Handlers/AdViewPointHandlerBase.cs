...
namespace GS2Studio.Generated.AdViewPoint
{
    ...
    /// AdViewPointBinder: the standalone/list AdViewPointHandler and the
    /// slot-bound AdViewPointListItemHandler. Concrete handlers supply the
    ...
    public abstract class AdViewPointHandlerBase : MonoBehaviour
    {
        ...
        public event Action<AdViewPoint>? Updated;

        /// <summary>Fires once each time a binder is attached (non-owning actionable view).</summary>
        public event Action<IActionableAdViewPointBinder>? Bound;
        ...
        protected void RaiseUpdated(AdViewPoint model) => Updated?.Invoke(model);
        protected void RaiseBound(IActionableAdViewPointBinder binder) => Bound?.Invoke(binder);
