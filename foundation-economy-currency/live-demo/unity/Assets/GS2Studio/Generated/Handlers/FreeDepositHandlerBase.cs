...
namespace GS2Studio.Generated.FreeDeposit
{
    ...
    /// FreeDepositBinder: the standalone/list FreeDepositHandler and the
    /// slot-bound FreeDepositListItemHandler. Concrete handlers supply the
    ...
    public abstract class FreeDepositHandlerBase : MonoBehaviour
    {
        ...
        public event Action<FreeDeposit>? Updated;

        /// <summary>Fires once each time a binder is attached (non-owning actionable view).</summary>
        public event Action<IActionableFreeDepositBinder>? Bound;
        ...
        protected void RaiseUpdated(FreeDeposit model) => Updated?.Invoke(model);
        protected void RaiseBound(IActionableFreeDepositBinder binder) => Bound?.Invoke(binder);
