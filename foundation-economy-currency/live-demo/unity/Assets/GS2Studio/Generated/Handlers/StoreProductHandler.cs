...
{
    /// <summary>
    /// MonoBehaviour handler for StoreProduct. Holds one StoreProductBinder,
    ...
    /// StoreProductListItemHandler, which reads its binder from the
    /// parent list instead of owning one.
    /// </summary>
    [AddComponentMenu("GS2 Studio/DomainType/StoreProduct/StoreProduct Handler")]
    public sealed class StoreProductHandler : StoreProductHandlerBase
    {
        ...
        /// binder implements <see cref="StoreProduct"/>, so it is the model.</summary>
        public override StoreProduct? Model => _binder;
        ...
        /// to substitute a fake StoreProductBinder; takes precedence over the
        ...
        /// <summary>
        /// Creates a StoreProductBinder from the current identity keys, mounts it,
        ...
        /// <summary>
        /// Attaches an externally-owned StoreProductBinder (lifecycle managed by the
        ...
        /// external subscription path (e.g. a StoreProductBinderCollection) already
