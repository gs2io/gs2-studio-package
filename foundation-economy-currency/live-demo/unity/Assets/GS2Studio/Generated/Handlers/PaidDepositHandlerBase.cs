...
namespace GS2Studio.Generated.PaidDeposit
{
    ...
    /// PaidDepositBinder: the standalone/list PaidDepositHandler and the
    /// slot-bound PaidDepositListItemHandler. Concrete handlers supply the
    ...
    public abstract class PaidDepositHandlerBase : MonoBehaviour
    {
        ...
        public event Action<PaidDeposit>? Updated;

        /// <summary>Fires once each time a binder is attached (non-owning actionable view).</summary>
        public event Action<IActionablePaidDepositBinder>? Bound;
        ...
        protected void RaiseUpdated(PaidDeposit model) => Updated?.Invoke(model);
        protected void RaiseBound(IActionablePaidDepositBinder binder) => Bound?.Invoke(binder);
