...
namespace GS2Studio.Generated.Character
{
    ...
    public enum CharacterMountSurface
    {
        ...
        /// <summary>Built by the ExchangeCharacterEnhanceWithPotion master-data list axis.</summary>
        [Gs2SkipsLoaders("UserdataInventoryCharacterItemModel", "UserdataExperienceCharacterExperienceExperienceModel")]
        ExchangeCharacterEnhanceWithPotionMaster,

        /// <summary>Built by the ExchangeCharacterEnhanceWithElixir master-data list axis.</summary>
        [Gs2SkipsLoaders("UserdataInventoryCharacterItemModel", "UserdataExperienceCharacterExperienceExperienceModel")]
        ExchangeCharacterEnhanceWithElixirMaster,
    ...
    public interface IReadOnlyCharacterBinder : Character
    {
        ...
        /// <remarks>ExchangeCharacterEnhanceWithPotionMaster: passes no itemSetName constructor argument.</remarks>
        /// <remarks>ExchangeCharacterEnhanceWithElixirMaster: passes no itemSetName constructor argument.</remarks>
        ...
        /// <remarks>ExchangeCharacterEnhanceWithPotionMaster: no per-row value for _model.PropertyId.</remarks>
        /// <remarks>ExchangeCharacterEnhanceWithElixirMaster: no per-row value for _model.PropertyId.</remarks>
    ...
    {
        Task Train();
        Task EnhanceWithPotion();
        Task EnhanceWithElixir();
    }
    ...
    public sealed class CharacterBinder : ReadOnlyCharacterBinder, ICharacterBinder
    {
        ...
        private readonly Gs2Bind.Gs2Exchange.RateModelLoader __exchangeCharacterEnhanceWithPotionNamespaceRateModelLoader;
        private readonly Gs2Bind.Gs2Exchange.RateModelLoader __exchangeCharacterEnhanceWithElixirNamespaceRateModelLoader;
        ...
        ) : base(model, gs2, session)
        {
            ...
            __transactionAcquireActionLoader = new Gs2Bind.Gs2Exchange.RateModelAcquireActionLoader("CharacterEnhanceWithElixir", _model.Id, 0);
            __transactionAcquireAction2Loader = new Gs2Bind.Gs2Exchange.RateModelAcquireActionLoader("CharacterEnhanceWithPotion", _model.Id, 0);
            __exchangeCharacterEnhanceWithPotionNamespaceRateModelLoader = new Gs2Bind.Gs2Exchange.RateModelLoader("CharacterEnhanceWithPotion", _model.Id);
            __exchangeCharacterEnhanceWithElixirNamespaceRateModelLoader = new Gs2Bind.Gs2Exchange.RateModelLoader("CharacterEnhanceWithElixir", _model.Id);
            __transactionAcquireAction3Loader = new Gs2Bind.Gs2Exchange.RateModelAcquireActionLoader("CharacterTrain", _model.Id, 0);
        ...
        public async Task MountAsync(CancellationToken cancellationToken = default)
        {
            ...
            var _exchangeCharacterEnhanceWithPotionNamespaceRateModel = await __exchangeCharacterEnhanceWithPotionNamespaceRateModelLoader.Load(_gs2, _session);
            cancellationToken.ThrowIfCancellationRequested();
            if (_exchangeCharacterEnhanceWithPotionNamespaceRateModel != null)
            {
            }
            var _exchangeCharacterEnhanceWithElixirNamespaceRateModel = await __exchangeCharacterEnhanceWithElixirNamespaceRateModelLoader.Load(_gs2, _session);
            cancellationToken.ThrowIfCancellationRequested();
            if (_exchangeCharacterEnhanceWithElixirNamespaceRateModel != null)
            {
            }
        ...
        public void Subscribe(Action? onChange = null)
        {
            ...
            _unsubscribers.Add(__exchangeCharacterEnhanceWithPotionNamespaceRateModelLoader.Subscribe(
                _gs2,
                _session,
                (_, _, value) =>
                {
            ...
            _unsubscribers.Add(__exchangeCharacterEnhanceWithElixirNamespaceRateModelLoader.Subscribe(
                _gs2,
                _session,
                (_, _, value) =>
                {
        ...
        public void Invalidate()
        {
            ...
            __exchangeCharacterEnhanceWithPotionNamespaceRateModelLoader.Invalidate(_gs2, _session);
            __exchangeCharacterEnhanceWithElixirNamespaceRateModelLoader.Invalidate(_gs2, _session);
        ...
        public async Task EnhanceWithPotion()
        {
            EnsureActionContext();
            await new Gs2Bind.Gs2Exchange.RateModelLoader("CharacterEnhanceWithPotion", _model.Id).Exchange(_gs2, _session, count: 1, config: new Gs2.Unity.Gs2Exchange.Model.EzConfig[] { new Gs2.Unity.Gs2Exchange.Model.EzConfig { Key = "propertyId", Value = _model.PropertyId } });
        }

        public async Task EnhanceWithElixir()
        {
            EnsureActionContext();
            await new Gs2Bind.Gs2Exchange.RateModelLoader("CharacterEnhanceWithElixir", _model.Id).Exchange(_gs2, _session, count: 1, config: new Gs2.Unity.Gs2Exchange.Model.EzConfig[] { new Gs2.Unity.Gs2Exchange.Model.EzConfig { Key = "propertyId", Value = _model.PropertyId } });
        }
        #endregion
