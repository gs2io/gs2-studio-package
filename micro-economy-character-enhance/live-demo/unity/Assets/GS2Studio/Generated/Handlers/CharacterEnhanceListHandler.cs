...
{
    /// <summary>
    /// MonoBehaviour list handler for CharacterEnhance. Owns a
    /// CharacterEnhanceBinderCollection, instantiates a child CharacterEnhanceListItemHandler
    ...
    /// ICharacterEnhanceBinderListSource so items read Binders[Index] through the
    /// shared parent-list surface.
    /// </summary>
    [AddComponentMenu("GS2 Studio/DomainType/CharacterEnhance/CharacterEnhance List Handler")]
    public sealed class CharacterEnhanceListHandler : MonoBehaviour, ICharacterEnhanceBinderListSource
    {
        [SerializeField] private CharacterEnhanceListItemHandler? _itemPrefab;
        ...
        // Construction seam. Defaults to DefaultCharacterEnhanceBinderFactory.Instance;
        // override via SetBinderFactory to substitute a fake collection.
        private ICharacterEnhanceBinderFactory? _binderFactory;

        private ICharacterEnhanceBinderCollection? _collection;
        ...
        private Action<ICharacterEnhanceBinder>? _collectionItemAddedCallback;
        private Action<ICharacterEnhanceBinder>? _collectionItemRemovedCallback;
        ...
        private readonly Dictionary<IActionableCharacterEnhanceBinder, CharacterEnhanceListItemHandler> _handlers =
            new Dictionary<IActionableCharacterEnhanceBinder, CharacterEnhanceListItemHandler>();
        ...
        private IComparer<IReadOnlyCharacterEnhanceBinder>? _comparer;
        ...
        /// itself is the IReadOnlyList&lt;IActionableCharacterEnhanceBinder&gt;.</summary>
        public IReadOnlyList<IActionableCharacterEnhanceBinder> Binders =>
            (IReadOnlyList<IActionableCharacterEnhanceBinder>?)_collection ?? Array.Empty<IActionableCharacterEnhanceBinder>();
        ...
        public event Action<IActionableCharacterEnhanceBinder>? ItemAdded;

        /// <summary>Fires once for each binder removed.</summary>
        public event Action<IActionableCharacterEnhanceBinder>? ItemRemoved;
        ...
        public IComparer<IReadOnlyCharacterEnhanceBinder>? Comparer
        {
            ...
            set
            {
                ...
                // CharacterEnhanceBinderCollection.CharacterEnhanceBinderComparer.
                var applied = value ?? CharacterEnhanceBinderCollection.CharacterEnhanceBinderComparer.Default;
        ...
        /// to substitute a fake CharacterEnhanceBinderCollection; takes precedence over
        /// the default factory. Pass null to revert to the default. Applies to
        /// the next ReloadAsync.
        /// </summary>
        public void SetBinderFactory(ICharacterEnhanceBinderFactory? factory)
        {
            _binderFactory = factory;
        }

        private ICharacterEnhanceBinderFactory ResolveBinderFactory()
            => _binderFactory ?? DefaultCharacterEnhanceBinderFactory.Instance;
        ...
        /// (the CharacterEnhanceBinderCollection only re-sorts on list-membership
        ...
        public async Task ReloadAsync(CancellationToken cancellationToken = default)
        {
            ...
            var operationGeneration = ++_reloadGeneration;
            ICharacterEnhanceBinderCollection? operationCollection = null;
            try
            {
                Cleanup();
                ...
                await collection.MountFromEnhanceCharacterEnhanceMasterDataAsync(cancellationToken);
                ...
                if (_autoSubscribe)
                {
                    ...
                    collection.SubscribeFromEnhanceCharacterEnhanceMasterData(collectionChanged, collectionFailed);
                }
        ...
        private bool IsCurrentOperation(long operationGeneration, ICharacterEnhanceBinderCollection? operationCollection)
            => !_isDestroyed
        ...
        private void AttachCollectionCallbacks(
            ...
            ICharacterEnhanceBinderCollection collection)
        {
            Action<ICharacterEnhanceBinder> itemAdded = binder =>
                OnItemAdded(operationGeneration, collection, binder);
            Action<ICharacterEnhanceBinder> itemRemoved = binder =>
        ...
        private void OnItemAdded(
            long operationGeneration,
            ICharacterEnhanceBinderCollection collection,
            ICharacterEnhanceBinder binder)
        {
            if (!IsCurrentOperation(operationGeneration, collection)) return;
        ...
        private void OnCollectionChanged(long operationGeneration, ICharacterEnhanceBinderCollection collection)
        {
            if (!IsCurrentOperation(operationGeneration, collection)) return;
        ...
        private int IndexOf(IActionableCharacterEnhanceBinder binder)
        {
            var binders = Binders;
        ...
        {
            if (!IsCurrentOperation(operationGeneration, collection)) return;
            // The collection is the IReadOnlyList<IActionableCharacterEnhanceBinder>; index it
        ...
        private void Cleanup()
        {
            ...
            var handlers = new List<CharacterEnhanceListItemHandler>(_handlers.Values);
            _collection = null;
