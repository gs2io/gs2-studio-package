...
{
    /// <summary>
    /// Mounts onto Binders[index] of a parent ICharacterEnhanceMaterialBinderListSource
    /// (the plain CharacterEnhanceMaterialListHandler or any ref-scoped variant) and
    ...
    /// </summary>
    [AddComponentMenu("GS2 Studio/DomainType/CharacterEnhanceMaterial/CharacterEnhanceMaterial List Item Handler")]
    public sealed class CharacterEnhanceMaterialListItemHandler : CharacterEnhanceMaterialHandlerBase
    {
        ...
        private ICharacterEnhanceMaterialBinderListSource? _list;
        ...
        // non-owning IActionableCharacterEnhanceMaterialBinder.
        private IActionableCharacterEnhanceMaterialBinder? _binder;
        private long _reevaluateGeneration;

        public override IActionableCharacterEnhanceMaterialBinder? Binder => _binder;
        // The binder implements <see cref="CharacterEnhanceMaterial"/>, so it is the model.
        ...
        /// </summary>
        public void AttachTo(ICharacterEnhanceMaterialBinderListSource list, int index)
        {
        ...
        private void Start()
        {
            ...
            var list = GetComponentInParent<ICharacterEnhanceMaterialBinderListSource>();
            if (list == null)
            {
                RaiseFailed(new InvalidOperationException(
                    "No ancestor ICharacterEnhanceMaterialBinderListSource found in the parent chain."));
                SetContentVisible(false);
                return;
            }
            _list = list;
