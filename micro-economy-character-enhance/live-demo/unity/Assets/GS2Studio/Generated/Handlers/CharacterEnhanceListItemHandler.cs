...
{
    /// <summary>
    /// Mounts onto Binders[index] of a parent ICharacterEnhanceBinderListSource
    /// (the plain CharacterEnhanceListHandler or any ref-scoped variant) and
    ...
    /// </summary>
    [AddComponentMenu("GS2 Studio/DomainType/CharacterEnhance/CharacterEnhance List Item Handler")]
    public sealed class CharacterEnhanceListItemHandler : CharacterEnhanceHandlerBase
    {
        ...
        private ICharacterEnhanceBinderListSource? _list;
        ...
        // non-owning IActionableCharacterEnhanceBinder.
        private IActionableCharacterEnhanceBinder? _binder;
        private long _reevaluateGeneration;

        public override IActionableCharacterEnhanceBinder? Binder => _binder;
        // The binder implements <see cref="CharacterEnhance"/>, so it is the model.
        ...
        /// </summary>
        public void AttachTo(ICharacterEnhanceBinderListSource list, int index)
        {
        ...
        private void Start()
        {
            ...
            var list = GetComponentInParent<ICharacterEnhanceBinderListSource>();
            if (list == null)
            {
                RaiseFailed(new InvalidOperationException(
                    "No ancestor ICharacterEnhanceBinderListSource found in the parent chain."));
                SetContentVisible(false);
                return;
            }
            _list = list;
