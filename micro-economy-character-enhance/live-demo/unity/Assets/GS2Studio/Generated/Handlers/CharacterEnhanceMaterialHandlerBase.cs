...
namespace GS2Studio.Generated.CharacterEnhanceMaterial
{
    ...
    /// CharacterEnhanceMaterialBinder: the standalone/list CharacterEnhanceMaterialHandler and the
    /// slot-bound CharacterEnhanceMaterialListItemHandler. Concrete handlers supply the
    ...
    /// </summary>
    public abstract class CharacterEnhanceMaterialHandlerBase : MonoBehaviour
    {
        /// <summary>The bound binder (non-owning actionable view), or null when none is attached.</summary>
        public abstract IActionableCharacterEnhanceMaterialBinder? Binder { get; }

        /// <summary>The bound model, or null when no binder is attached.</summary>
        public abstract CharacterEnhanceMaterial? Model { get; }
        ...
        public event Action<CharacterEnhanceMaterial>? Updated;

        /// <summary>Fires once each time a binder is attached (non-owning actionable view).</summary>
        public event Action<IActionableCharacterEnhanceMaterialBinder>? Bound;
        ...
        protected void RaiseUpdated(CharacterEnhanceMaterial model) => Updated?.Invoke(model);
        protected void RaiseBound(IActionableCharacterEnhanceMaterialBinder binder) => Bound?.Invoke(binder);
