...
{
    /// <summary>
    /// MonoBehaviour list handler for CharacterEnhanceMaterial. Owns a
    /// CharacterEnhanceMaterialBinderCollection, instantiates a child CharacterEnhanceMaterialListItemHandler
    ...
    /// ICharacterEnhanceMaterialBinderListSource so items read Binders[Index] through the
    ...
    public sealed class CharacterEnhanceMaterialListHandler : MonoBehaviour, ICharacterEnhanceMaterialBinderListSource
    {
        ...
        [SerializeField] private CharacterEnhanceMaterialListAxis _axis;
        [SerializeField] private CharacterEnhanceMaterialListItemHandler? _itemPrefab;
        ...
        // Construction seam. Defaults to DefaultCharacterEnhanceMaterialBinderFactory.Instance;
        // override via SetBinderFactory to substitute a fake collection.
        private ICharacterEnhanceMaterialBinderFactory? _binderFactory;

        private ICharacterEnhanceMaterialBinderCollection? _collection;
        ...
        private readonly Dictionary<IActionableCharacterEnhanceMaterialBinder, CharacterEnhanceMaterialListItemHandler> _handlers =
            new Dictionary<IActionableCharacterEnhanceMaterialBinder, CharacterEnhanceMaterialListItemHandler>();
        ...
        private IComparer<IReadOnlyCharacterEnhanceMaterialBinder>? _comparer;
        ...
        /// itself is the IReadOnlyList&lt;IActionableCharacterEnhanceMaterialBinder&gt;.</summary>
        public IReadOnlyList<IActionableCharacterEnhanceMaterialBinder> Binders =>
            (IReadOnlyList<IActionableCharacterEnhanceMaterialBinder>?)_collection ?? Array.Empty<IActionableCharacterEnhanceMaterialBinder>();
        ...
        public event Action<IActionableCharacterEnhanceMaterialBinder>? ItemRemoved;
        ...
        public IComparer<IReadOnlyCharacterEnhanceMaterialBinder>? Comparer
        {
            ...
            set
            {
                ...
                // CharacterEnhanceMaterialBinderCollection.CharacterEnhanceMaterialBinderComparer.
                var applied = value ?? CharacterEnhanceMaterialBinderCollection.CharacterEnhanceMaterialBinderComparer.Default;
        ...
        /// to substitute a fake CharacterEnhanceMaterialBinderCollection; takes precedence over
        /// the default factory. Pass null to revert to the default. Applies to
        /// the next ReloadAsync.
        /// </summary>
        public void SetBinderFactory(ICharacterEnhanceMaterialBinderFactory? factory)
        {
            _binderFactory = factory;
        }

        private ICharacterEnhanceMaterialBinderFactory ResolveBinderFactory()
            => _binderFactory ?? DefaultCharacterEnhanceMaterialBinderFactory.Instance;
        ...
        /// (the CharacterEnhanceMaterialBinderCollection only re-sorts on list-membership
        ...
        public async Task ReloadAsync(CancellationToken cancellationToken = default)
        {
            ...
            var operationGeneration = ++_reloadGeneration;
            ICharacterEnhanceMaterialBinderCollection? operationCollection = null;
            try
            {
                Cleanup();
                ...
                switch (_axis)
                {
                    case CharacterEnhanceMaterialListAxis.InventoryCharacterEnhanceMaterialMaster:
                        await collection.MountFromInventoryCharacterEnhanceMaterialMasterDataAsync(cancellationToken);
                        break;
                    case CharacterEnhanceMaterialListAxis.ExchangeCharacterEnhanceMaterialGetMaster:
                        await collection.MountFromExchangeCharacterEnhanceMaterialGetMasterDataAsync(cancellationToken);
                        break;
                    case CharacterEnhanceMaterialListAxis.InventoryCharacterEnhanceMaterialUser:
                        await collection.MountFromInventoryCharacterEnhanceMaterialUserDataAsync(cancellationToken);
                        break;
                }
                ...
                if (_autoSubscribe)
                {
                    ...
                    {
                        case CharacterEnhanceMaterialListAxis.InventoryCharacterEnhanceMaterialMaster:
                            collection.SubscribeFromInventoryCharacterEnhanceMaterialMasterData(collectionChanged, collectionFailed);
                            break;
                        case CharacterEnhanceMaterialListAxis.ExchangeCharacterEnhanceMaterialGetMaster:
                            collection.SubscribeFromExchangeCharacterEnhanceMaterialGetMasterData(collectionChanged, collectionFailed);
                            break;
                        case CharacterEnhanceMaterialListAxis.InventoryCharacterEnhanceMaterialUser:
                            collection.SubscribeFromInventoryCharacterEnhanceMaterialUserData(collectionChanged, collectionFailed);
                            break;
                    }
                }
        ...
        private const string AxisMemberNames = "InventoryCharacterEnhanceMaterialMaster, ExchangeCharacterEnhanceMaterialGetMaster, InventoryCharacterEnhanceMaterialUser";
        ...
        {
            if (_axis == CharacterEnhanceMaterialListAxis.Unset)
            {
                return "'_axis' is not set: this list has not been told which axis to read from. " +
                    "Set it to one of: " + AxisMemberNames + ".";
            }
            if (!Enum.IsDefined(typeof(CharacterEnhanceMaterialListAxis), _axis))
            {
        ...
        private bool IsCurrentOperation(long operationGeneration, ICharacterEnhanceMaterialBinderCollection? operationCollection)
            => !_isDestroyed
        ...
        private void AttachCollectionCallbacks(
            ...
            ICharacterEnhanceMaterialBinderCollection collection)
        {
            Action<ICharacterEnhanceMaterialBinder> itemAdded = binder =>
                OnItemAdded(operationGeneration, collection, binder);
            Action<ICharacterEnhanceMaterialBinder> itemRemoved = binder =>
        ...
        private void OnItemAdded(
            long operationGeneration,
            ICharacterEnhanceMaterialBinderCollection collection,
            ICharacterEnhanceMaterialBinder binder)
        {
            if (!IsCurrentOperation(operationGeneration, collection)) return;
        ...
        private void OnCollectionChanged(long operationGeneration, ICharacterEnhanceMaterialBinderCollection collection)
        {
            if (!IsCurrentOperation(operationGeneration, collection)) return;
        ...
        private int IndexOf(IActionableCharacterEnhanceMaterialBinder binder)
        {
            var binders = Binders;
        ...
        {
            if (!IsCurrentOperation(operationGeneration, collection)) return;
            // The collection is the IReadOnlyList<IActionableCharacterEnhanceMaterialBinder>; index it
        ...
        private void Cleanup()
        {
            ...
            var handlers = new List<CharacterEnhanceMaterialListItemHandler>(_handlers.Values);
            _collection = null;
