...
{
    /// <summary>
    /// Which mount axis a GlobalMessage list reads through.
    /// GlobalMessageBinderCollection exposes one mount method per axis;
    ...
    /// </para>
    /// <para>
    /// Where a <c>GlobalMessageMountSurface</c> is also generated, these
    ...
    /// </para>
    /// </summary>
    public enum GlobalMessageListAxis
    {
        /// <summary>No axis was written here. A scene that was never baked reads as this.</summary>
        Unset = 0,

        /// <summary>Read from the ExchangeInboxDeliver master-data mount axis.</summary>
        ExchangeInboxDeliverMaster = 1071135751,

        /// <summary>Read from the ScheduleInboxSchedule master-data mount axis.</summary>
        ScheduleInboxScheduleMaster = 76609567,
    }
}
