...
{
    /// <summary>
    /// Mounts onto Binders[index] of a parent IMessageBinderListSource
    /// (the plain MessageListHandler or any ref-scoped variant) and
    ...
    /// </summary>
    [AddComponentMenu("GS2 Studio/DomainType/Message/Message List Item Handler")]
    public sealed class MessageListItemHandler : MessageHandlerBase
    {
        ...
        private IMessageBinderListSource? _list;
        ...
        // non-owning IActionableMessageBinder.
        private IActionableMessageBinder? _binder;
        private long _reevaluateGeneration;

        public override IActionableMessageBinder? Binder => _binder;
        // The binder implements <see cref="Message"/>, so it is the model.
        ...
        /// </summary>
        public void AttachTo(IMessageBinderListSource list, int index)
        {
        ...
        private void Start()
        {
            ...
            var list = GetComponentInParent<IMessageBinderListSource>();
            if (list == null)
            {
                RaiseFailed(new InvalidOperationException(
                    "No ancestor IMessageBinderListSource found in the parent chain."));
                SetContentVisible(false);
                return;
            }
            _list = list;
