...
namespace GS2Studio.Generated.Gift
{
    ...
    /// GiftBinder: the standalone/list GiftHandler and the
    /// slot-bound GiftListItemHandler. Concrete handlers supply the
    ...
    public abstract class GiftHandlerBase : MonoBehaviour
    {
        ...
        protected void RaiseUpdated(Gift model) => Updated?.Invoke(model);
        protected void RaiseBound(IActionableGiftBinder binder) => Bound?.Invoke(binder);
