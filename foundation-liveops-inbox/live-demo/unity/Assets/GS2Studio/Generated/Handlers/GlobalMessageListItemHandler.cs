...
{
    /// <summary>
    /// Mounts onto Binders[index] of a parent IGlobalMessageBinderListSource
    /// (the plain GlobalMessageListHandler or any ref-scoped variant) and
    ...
    /// </summary>
    [AddComponentMenu("GS2 Studio/DomainType/GlobalMessage/GlobalMessage List Item Handler")]
    public sealed class GlobalMessageListItemHandler : GlobalMessageHandlerBase
    {
        ...
        private IGlobalMessageBinderListSource? _list;
        ...
        // non-owning IActionableGlobalMessageBinder.
        private IActionableGlobalMessageBinder? _binder;
        private long _reevaluateGeneration;

        public override IActionableGlobalMessageBinder? Binder => _binder;
        // The binder implements <see cref="GlobalMessage"/>, so it is the model.
        ...
        /// </summary>
        public void AttachTo(IGlobalMessageBinderListSource list, int index)
        {
        ...
        private void Start()
        {
            ...
            var list = GetComponentInParent<IGlobalMessageBinderListSource>();
            if (list == null)
            {
                RaiseFailed(new InvalidOperationException(
                    "No ancestor IGlobalMessageBinderListSource found in the parent chain."));
                SetContentVisible(false);
                return;
            }
            _list = list;
