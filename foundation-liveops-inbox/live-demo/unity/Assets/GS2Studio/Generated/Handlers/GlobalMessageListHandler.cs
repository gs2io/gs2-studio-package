...
{
    /// <summary>
    /// MonoBehaviour list handler for GlobalMessage. Owns a
    /// GlobalMessageBinderCollection, instantiates a child GlobalMessageListItemHandler
    ...
    /// IGlobalMessageBinderListSource so items read Binders[Index] through the
    /// shared parent-list surface.
    /// </summary>
    [AddComponentMenu("GS2 Studio/DomainType/GlobalMessage/GlobalMessage List Handler")]
    public sealed class GlobalMessageListHandler : MonoBehaviour, IGlobalMessageBinderListSource
    {
        // Which of GlobalMessageBinderCollection's mount axes this list reads
        ...
        [SerializeField] private GlobalMessageListAxis _axis;
        [SerializeField] private GlobalMessageListItemHandler? _itemPrefab;
        ...
        // Construction seam. Defaults to DefaultGlobalMessageBinderFactory.Instance;
        // override via SetBinderFactory to substitute a fake collection.
        private IGlobalMessageBinderFactory? _binderFactory;

        private IGlobalMessageBinderCollection? _collection;
        ...
        private Action<IGlobalMessageBinder>? _collectionItemAddedCallback;
        private Action<IGlobalMessageBinder>? _collectionItemRemovedCallback;
        ...
        private readonly Dictionary<IActionableGlobalMessageBinder, GlobalMessageListItemHandler> _handlers =
            new Dictionary<IActionableGlobalMessageBinder, GlobalMessageListItemHandler>();
        ...
        private IComparer<IReadOnlyGlobalMessageBinder>? _comparer;
        ...
        /// itself is the IReadOnlyList&lt;IActionableGlobalMessageBinder&gt;.</summary>
        public IReadOnlyList<IActionableGlobalMessageBinder> Binders =>
            (IReadOnlyList<IActionableGlobalMessageBinder>?)_collection ?? Array.Empty<IActionableGlobalMessageBinder>();
        ...
        public event Action<IActionableGlobalMessageBinder>? ItemAdded;

        /// <summary>Fires once for each binder removed.</summary>
        public event Action<IActionableGlobalMessageBinder>? ItemRemoved;
        ...
        public IComparer<IReadOnlyGlobalMessageBinder>? Comparer
        {
            ...
            set
            {
                ...
                // GlobalMessageBinderCollection.GlobalMessageBinderComparer.
                var applied = value ?? GlobalMessageBinderCollection.GlobalMessageBinderComparer.Default;
        ...
        /// to substitute a fake GlobalMessageBinderCollection; takes precedence over
        /// the default factory. Pass null to revert to the default. Applies to
        /// the next ReloadAsync.
        /// </summary>
        public void SetBinderFactory(IGlobalMessageBinderFactory? factory)
        {
            _binderFactory = factory;
        }

        private IGlobalMessageBinderFactory ResolveBinderFactory()
            => _binderFactory ?? DefaultGlobalMessageBinderFactory.Instance;
        ...
        /// (the GlobalMessageBinderCollection only re-sorts on list-membership
        ...
        public async Task ReloadAsync(CancellationToken cancellationToken = default)
        {
            ...
            var operationGeneration = ++_reloadGeneration;
            IGlobalMessageBinderCollection? operationCollection = null;
            try
            {
                Cleanup();
                ...
                switch (_axis)
                {
                    case GlobalMessageListAxis.ExchangeInboxDeliverMaster:
                        await collection.MountFromExchangeInboxDeliverMasterDataAsync(cancellationToken);
                        break;
                    case GlobalMessageListAxis.ScheduleInboxScheduleMaster:
                        await collection.MountFromScheduleInboxScheduleMasterDataAsync(cancellationToken);
                        break;
                }
                ...
                if (_autoSubscribe)
                {
                    ...
                    {
                        case GlobalMessageListAxis.ExchangeInboxDeliverMaster:
                            collection.SubscribeFromExchangeInboxDeliverMasterData(collectionChanged, collectionFailed);
                            break;
                        case GlobalMessageListAxis.ScheduleInboxScheduleMaster:
                            collection.SubscribeFromScheduleInboxScheduleMasterData(collectionChanged, collectionFailed);
                            break;
                    }
                }
        ...
        private const string AxisMemberNames = "ExchangeInboxDeliverMaster, ScheduleInboxScheduleMaster";
        ...
        private bool IsCurrentOperation(long operationGeneration, IGlobalMessageBinderCollection? operationCollection)
            => !_isDestroyed
        ...
        private void AttachCollectionCallbacks(
            ...
            IGlobalMessageBinderCollection collection)
        {
            Action<IGlobalMessageBinder> itemAdded = binder =>
                OnItemAdded(operationGeneration, collection, binder);
            Action<IGlobalMessageBinder> itemRemoved = binder =>
        ...
        private void OnCollectionChanged(long operationGeneration, IGlobalMessageBinderCollection collection)
        {
            if (!IsCurrentOperation(operationGeneration, collection)) return;
        ...
        private int IndexOf(IActionableGlobalMessageBinder binder)
        {
            var binders = Binders;
        ...
        {
            if (!IsCurrentOperation(operationGeneration, collection)) return;
            // The collection is the IReadOnlyList<IActionableGlobalMessageBinder>; index it
        ...
        private void Cleanup()
        {
            ...
            var handlers = new List<GlobalMessageListItemHandler>(_handlers.Values);
            _collection = null;
