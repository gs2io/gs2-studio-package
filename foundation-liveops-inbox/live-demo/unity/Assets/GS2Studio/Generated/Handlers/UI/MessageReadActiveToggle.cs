...
namespace GS2Studio.Generated.Message.UI
{
    ...
    /// based on the condition <c>truthy(isRead)</c> evaluated
    ...
    /// </summary>
    [AddComponentMenu("GS2 Studio/DomainType/Message/ActiveToggle/ReadActiveToggle")]
    public sealed class MessageReadActiveToggle : MonoBehaviour
    {
        ...
        private void OnEnable()
        {
            ...
            if (_handler == null)
            {
                ...
                if (!_warnedMissingHandler)
                {
                    ...
                    Debug.LogWarning(
                        $"{nameof(MessageReadActiveToggle)} on '{name}': no MessageHandlerBase found in the parent chain; component inactive.", this);
                }
                return;
            }
            if (!_subscribed)
