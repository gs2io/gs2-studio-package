...
namespace GS2Studio.Generated.Gift.UI
{
    ...
    /// </summary>
    [AddComponentMenu("GS2 Studio/DomainType/Gift/TemplateLabel/AmountLabel")]
    public sealed class GiftAmountLabel : MonoBehaviour
    {
        ...
        private void OnEnable()
        {
            ...
            if (_handler == null)
            {
                ...
                if (!_warnedMissingHandler)
                {
                    ...
                    Debug.LogWarning(
                        $"{nameof(GiftAmountLabel)} on '{name}': no GiftHandlerBase found in the parent chain; component inactive.", this);
                }
                return;
            }
            if (!_subscribed)
