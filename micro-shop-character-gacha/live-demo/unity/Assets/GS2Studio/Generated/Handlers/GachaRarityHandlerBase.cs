...
namespace GS2Studio.Generated.GachaRarity
{
    ...
    /// GachaRarityBinder: the standalone/list GachaRarityHandler and the
    /// slot-bound GachaRarityListItemHandler. Concrete handlers supply the
    ...
    public abstract class GachaRarityHandlerBase : MonoBehaviour
    {
        ...
        public event Action<GachaRarity>? Updated;

        /// <summary>Fires once each time a binder is attached (non-owning actionable view).</summary>
        public event Action<IActionableGachaRarityBinder>? Bound;
        ...
        protected void RaiseUpdated(GachaRarity model) => Updated?.Invoke(model);
        protected void RaiseBound(IActionableGachaRarityBinder binder) => Bound?.Invoke(binder);
