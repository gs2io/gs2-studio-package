...
namespace GS2Studio.Generated.Character.UI
{
    ...
    /// based on the condition <c>truthy(acquired)</c> evaluated
    ...
    /// </summary>
    [AddComponentMenu("GS2 Studio/DomainType/Character/ActiveToggle/AcquiredActiveToggle")]
    public sealed class CharacterAcquiredActiveToggle : MonoBehaviour
    {
        ...
        private void OnEnable()
        {
            ...
            if (_handler == null)
            {
                ...
                if (!_warnedMissingHandler)
                {
                    ...
                    Debug.LogWarning(
                        $"{nameof(CharacterAcquiredActiveToggle)} on '{name}': no CharacterHandlerBase found in the parent chain; component inactive.", this);
                }
                return;
            }
            if (!_subscribed)
