...
{
    /// <summary>
    /// UI value bound to <c>StoreProduct.googlePlayProductId</c>.
    ...
    /// persists it.
    /// </summary>
    [AddComponentMenu("GS2 Studio/DomainType/StoreProduct/Value/GooglePlayProductIdValue")]
    public sealed class StoreProductGooglePlayProductIdValue : MonoBehaviour
    {
        ...
        private void OnEnable()
        {
            ...
            if (_handler == null)
            {
                ...
                if (!_warnedMissingHandler)
                {
                    ...
                    Debug.LogWarning(
                        $"{nameof(StoreProductGooglePlayProductIdValue)} on '{name}': no StoreProductHandlerBase found in the parent chain; component inactive.", this);
                }
                return;
            }
            if (!_subscribed)
        ...
        {
            _onUpdate.Invoke(model.GooglePlayProductId ?? string.Empty);
        }
