...
namespace GS2Studio.Generated.Character.UI
{
    ...
    /// based on the condition <c>not(truthy(acquired))</c> evaluated
    ...
    /// </summary>
    [AddComponentMenu("GS2 Studio/DomainType/Character/ActiveToggle/UnacquiredActiveToggle")]
    public sealed class CharacterUnacquiredActiveToggle : MonoBehaviour
    {
        ...
        private void OnEnable()
        {
            ...
            if (_handler == null)
            {
                ...
                if (!_warnedMissingHandler)
                {
                    ...
                    Debug.LogWarning(
                        $"{nameof(CharacterUnacquiredActiveToggle)} on '{name}': no CharacterHandlerBase found in the parent chain; component inactive.", this);
                }
                return;
            }
            if (!_subscribed)
