...
namespace GS2Studio.Generated.Gacha.UI
{
    ...
    /// substituted with the resolved value from <c>Gacha</c>
    ...
    /// </summary>
    [AddComponentMenu("GS2 Studio/DomainType/Gacha/TemplateLabel/NameLabel")]
    public sealed class GachaNameLabel : MonoBehaviour
    {
        ...
        private void OnEnable()
        {
            ...
            if (_handler == null)
            {
                ...
                if (!_warnedMissingHandler)
                {
                    ...
                    Debug.LogWarning(
                        $"{nameof(GachaNameLabel)} on '{name}': no GachaHandlerBase found in the parent chain; component inactive.", this);
                }
                return;
            }
            if (!_subscribed)
        ...
        private void OnUpdated(Gacha model)
        {
