...
{
    /// <summary>
    /// MonoBehaviour list handler for Gacha. Owns a
    /// GachaBinderCollection, instantiates a child GachaListItemHandler
    ...
    /// </summary>
    [AddComponentMenu("GS2 Studio/DomainType/Gacha/Gacha List Handler")]
    public sealed class GachaListHandler : MonoBehaviour, IGachaBinderListSource
    {
        ...
        /// itself is the IReadOnlyList&lt;IActionableGachaBinder&gt;.</summary>
        public IReadOnlyList<IActionableGachaBinder> Binders =>
            (IReadOnlyList<IActionableGachaBinder>?)_collection ?? Array.Empty<IActionableGachaBinder>();
        ...
        {
            if (!IsCurrentOperation(operationGeneration, collection)) return;
            // The collection is the IReadOnlyList<IActionableGachaBinder>; index it
