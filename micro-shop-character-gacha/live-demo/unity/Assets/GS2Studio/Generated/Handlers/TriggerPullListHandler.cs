...
{
    /// <summary>
    /// MonoBehaviour list handler for TriggerPull. Owns a
    /// TriggerPullBinderCollection, instantiates a child TriggerPullListItemHandler
    ...
    /// </summary>
    [AddComponentMenu("GS2 Studio/DomainType/TriggerPull/TriggerPull List Handler")]
    public sealed class TriggerPullListHandler : MonoBehaviour, ITriggerPullBinderListSource
    {
        ...
        /// itself is the IReadOnlyList&lt;IActionableTriggerPullBinder&gt;.</summary>
        public IReadOnlyList<IActionableTriggerPullBinder> Binders =>
            (IReadOnlyList<IActionableTriggerPullBinder>?)_collection ?? Array.Empty<IActionableTriggerPullBinder>();
        ...
        {
            if (!IsCurrentOperation(operationGeneration, collection)) return;
            // The collection is the IReadOnlyList<IActionableTriggerPullBinder>; index it
