...
{
    /// <summary>
    /// Mounts onto Binders[index] of a parent ICharacterRecruitBinderListSource
    /// (the plain CharacterRecruitListHandler or any ref-scoped variant) and
    ...
    /// </summary>
    [AddComponentMenu("GS2 Studio/DomainType/CharacterRecruit/CharacterRecruit List Item Handler")]
    public sealed class CharacterRecruitListItemHandler : CharacterRecruitHandlerBase
    {
        ...
        private ICharacterRecruitBinderListSource? _list;
        ...
        // non-owning IActionableCharacterRecruitBinder.
        private IActionableCharacterRecruitBinder? _binder;

        public override IActionableCharacterRecruitBinder? Binder => _binder;
        // The binder implements <see cref="CharacterRecruit"/>, so it is the model.
        ...
        /// </summary>
        public void AttachTo(ICharacterRecruitBinderListSource list, int index)
        {
        ...
        private void Start()
        {
            ...
            var list = GetComponentInParent<ICharacterRecruitBinderListSource>();
            if (list == null)
            {
                RaiseFailed(new InvalidOperationException(
                    "No ancestor ICharacterRecruitBinderListSource found in the parent chain."));
                SetContentVisible(false);
                return;
            }
            _list = list;
