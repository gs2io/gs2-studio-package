...
{
    /// <summary>
    /// Mounts onto Binders[index] of a parent IGachaBinderListSource
    /// (the plain GachaListHandler or any ref-scoped variant) and
    ...
    /// </summary>
    [AddComponentMenu("GS2 Studio/DomainType/Gacha/Gacha List Item Handler")]
    public sealed class GachaListItemHandler : GachaHandlerBase
    {
        ...
        private IGachaBinderListSource? _list;
        ...
        /// </summary>
        public void AttachTo(IGachaBinderListSource list, int index)
        {
        ...
        private void Start()
        {
            ...
            var list = GetComponentInParent<IGachaBinderListSource>();
            if (list == null)
            {
                RaiseFailed(new InvalidOperationException(
                    "No ancestor IGachaBinderListSource found in the parent chain."));
                SetContentVisible(false);
                return;
            }
            _list = list;
