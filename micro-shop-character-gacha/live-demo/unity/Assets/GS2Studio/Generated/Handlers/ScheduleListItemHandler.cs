...
{
    /// <summary>
    /// Mounts onto Binders[index] of a parent IScheduleBinderListSource
    /// (the plain ScheduleListHandler or any ref-scoped variant) and
    ...
    /// </summary>
    [AddComponentMenu("GS2 Studio/DomainType/Schedule/Schedule List Item Handler")]
    public sealed class ScheduleListItemHandler : ScheduleHandlerBase
    {
        ...
        private IScheduleBinderListSource? _list;
        ...
        /// </summary>
        public void AttachTo(IScheduleBinderListSource list, int index)
        {
        ...
        private void Start()
        {
            ...
            var list = GetComponentInParent<IScheduleBinderListSource>();
            if (list == null)
            {
                RaiseFailed(new InvalidOperationException(
                    "No ancestor IScheduleBinderListSource found in the parent chain."));
                SetContentVisible(false);
                return;
            }
            _list = list;
