...
namespace GS2Studio.Generated.Character
{
    ...
    public interface IReadOnlyCharacterBinder : Character
    {
        ...
        Task<ICharacterRateBinder> GetCharacterRate(GachaRarityId rarity, CancellationToken cancellationToken = default);
    }
    ...
    public abstract class ReadOnlyCharacterBinder : IReadOnlyCharacterBinder
    {
        ...
        public async Task<ICharacterRateBinder> GetCharacterRate(GachaRarityId rarity, CancellationToken cancellationToken = default)
        {
            ThrowIfDisposedForNavigation();
            return await CharacterRateBinder.CreateAsync(rarity, _model.Id, _gs2, _session, cancellationToken);
        }
        #endregion
    }
