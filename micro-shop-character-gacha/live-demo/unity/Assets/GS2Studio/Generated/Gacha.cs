...
{
    /// <summary>
    /// Read-only public contract for the Gacha model. GS2 is not a
    ...
    /// <see cref="MutableGacha"/>, reconciled by the binder/collection
    ...
    /// <summary>
    /// Read-write public contract for the Gacha model. Each
    ...
    /// <see cref="Gacha"/> surface.
    /// </summary>
    public interface IMutableGacha : Gacha
    {
        new GachaId Id { get; set; }
        new ScheduleId? Schedule { get; set; }
    }

    /// <summary>
    /// Mutable implementation of <see cref="Gacha"/>. Internal to
    ...
    /// </summary>
    internal sealed class MutableGacha : IMutableGacha
    {
