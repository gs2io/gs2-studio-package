...
{
    internal static class MicroShopCharacterGachaDemoOverlayLoaderRegistration
    {
        ...
        {
#if UNITY_EDITOR
            GachaOverlayLoader.Active = new EditorOverlayLoader<GachaOverlayEntry>();
#endif
        }
        ...
        private static void ApplyAddressables()
        {
            ...
            GachaOverlayLoader.Active = new AddressablesOverlayLoader<GachaOverlayEntry>("Gacha");
#endif
        }

        private static void ApplyResources()
        {
            GachaOverlayLoader.Active = new ResourcesOverlayLoader<GachaOverlayEntry>("Gacha");
        }
    }
}
