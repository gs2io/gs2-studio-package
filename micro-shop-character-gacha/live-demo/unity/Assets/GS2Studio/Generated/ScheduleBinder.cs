...
namespace GS2Studio.Generated.Schedule
{
    ...
    public interface IScheduleBinder : IActionableScheduleBinder, IDisposable
    {
        ...
        void Invalidate();
        Task<GS2Studio.Generated.Gacha.IReadOnlyGachaBinderCollection> GetGachas(CancellationToken cancellationToken = default);
    }
    ...
    public sealed class ScheduleBinder : ReadOnlyScheduleBinder, IScheduleBinder
    {
        ...
        private GS2Studio.Generated.Gacha.GachaBinderCollection? _gachasRoot;
        private Task<GS2Studio.Generated.Gacha.GachaBinderCollection>? _gachasRootTask;
        ...
        public async Task<GS2Studio.Generated.Gacha.IReadOnlyGachaBinderCollection> GetGachas(CancellationToken cancellationToken = default)
        {
            ThrowIfDisposed();
            var root = await EnsureGachasRootAsync(cancellationToken);
            return root.WhereSchedule(_model.Id);
        }
        #endregion

        #region Reference navigation roots
        private async Task<GS2Studio.Generated.Gacha.GachaBinderCollection> EnsureGachasRootAsync(CancellationToken cancellationToken)
        {
            if (_gachasRootTask == null)
            {
                _gachasRootTask = BuildGachasRootAsync(cancellationToken);
            }
            var task = _gachasRootTask;
            GS2Studio.Generated.Gacha.GachaBinderCollection root;
            try
            {
                root = await task;
            }
            ...
            {
                if (ReferenceEquals(_gachasRootTask, task)) _gachasRootTask = null;
                throw;
            }
        ...
        private async Task<GS2Studio.Generated.Gacha.GachaBinderCollection> BuildGachasRootAsync(CancellationToken cancellationToken)
        {
            var root = await GS2Studio.Generated.Gacha.GachaBinderCollection.CreateFromShowcaseCharacterGachaMasterDataAsync(_gs2, _session, cancellationToken);
            try { root.SubscribeFromShowcaseCharacterGachaMasterData(); }
