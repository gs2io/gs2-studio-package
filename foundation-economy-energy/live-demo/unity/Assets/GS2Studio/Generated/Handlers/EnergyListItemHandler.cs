...
{
    /// <summary>
    /// Mounts onto Binders[index] of a parent IEnergyBinderListSource
    /// (the plain EnergyListHandler or any ref-scoped variant) and
    ...
    /// </summary>
    [AddComponentMenu("GS2 Studio/DomainType/Energy/Energy List Item Handler")]
    public sealed class EnergyListItemHandler : EnergyHandlerBase
    {
        ...
        private IEnergyBinderListSource? _list;
        ...
        /// </summary>
        public void AttachTo(IEnergyBinderListSource list, int index)
        {
        ...
        private void Start()
        {
            ...
            var list = GetComponentInParent<IEnergyBinderListSource>();
            if (list == null)
            {
                RaiseFailed(new InvalidOperationException(
                    "No ancestor IEnergyBinderListSource found in the parent chain."));
                SetContentVisible(false);
                return;
            }
            _list = list;
