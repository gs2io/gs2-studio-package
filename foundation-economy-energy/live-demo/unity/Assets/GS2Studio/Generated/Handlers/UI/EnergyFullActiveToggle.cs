...
namespace GS2Studio.Generated.Energy.UI
{
    ...
    /// based on the condition <c>gte(currentValue, currentMaximumValue)</c> evaluated
    /// against the sibling <c>EnergyHandler.Model</c>:
    /// <list type="bullet">
    ...
    /// <c>EnergyHandler</c> or <c>EnergyListItemHandler</c>;
    ...
    public sealed class EnergyFullActiveToggle : MonoBehaviour
    {
        ...
        {
            bool result = (System.Convert.ToInt64(model.CurrentValue, System.Globalization.CultureInfo.InvariantCulture) >= System.Convert.ToInt64(model.CurrentMaximumValue, System.Globalization.CultureInfo.InvariantCulture));
