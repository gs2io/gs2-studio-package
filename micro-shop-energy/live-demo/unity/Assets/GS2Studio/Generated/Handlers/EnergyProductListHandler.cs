...
namespace GS2Studio.Generated.EnergyProduct
{
    ...
    public sealed class EnergyProductListHandler : MonoBehaviour, IEnergyProductBinderListSource
    {
        ...
        // Construction seam. Defaults to DefaultEnergyProductBinderFactory.Instance;
        // override via SetBinderFactory to substitute a fake collection.
        private IEnergyProductBinderFactory? _binderFactory;

        private IEnergyProductBinderCollection? _collection;
        ...
        private IComparer<IReadOnlyEnergyProductBinder>? _comparer;
        ...
        public IComparer<IReadOnlyEnergyProductBinder>? Comparer
        {
            ...
            set
            {
                ...
                // EnergyProductBinderCollection.EnergyProductBinderComparer.
                var applied = value ?? EnergyProductBinderCollection.EnergyProductBinderComparer.Default;
        ...
        /// to substitute a fake EnergyProductBinderCollection; takes precedence over
        /// the default factory. Pass null to revert to the default. Applies to
        /// the next ReloadAsync.
        /// </summary>
        public void SetBinderFactory(IEnergyProductBinderFactory? factory)
        {
            _binderFactory = factory;
        }

        private IEnergyProductBinderFactory ResolveBinderFactory()
            => _binderFactory ?? DefaultEnergyProductBinderFactory.Instance;
        ...
        /// (the EnergyProductBinderCollection only re-sorts on list-membership
        ...
        public async Task ReloadAsync(CancellationToken cancellationToken = default)
        {
            ...
            var operationGeneration = ++_reloadGeneration;
            IEnergyProductBinderCollection? operationCollection = null;
            try
            {
                Cleanup();
                ...
                switch (_axis)
                {
                    case EnergyProductListAxis.ExchangeEnergyShopMaster:
                        await collection.MountFromExchangeEnergyShopMasterDataAsync(cancellationToken);
                        break;
                    case EnergyProductListAxis.ExchangeEnergyProductMaster:
                        await collection.MountFromExchangeEnergyProductMasterDataAsync(cancellationToken);
                        break;
                }
                ...
                if (_autoSubscribe)
                {
                    ...
                    {
                        case EnergyProductListAxis.ExchangeEnergyShopMaster:
                            collection.SubscribeFromExchangeEnergyShopMasterData(collectionChanged, collectionFailed);
                            break;
                        case EnergyProductListAxis.ExchangeEnergyProductMaster:
                            collection.SubscribeFromExchangeEnergyProductMasterData(collectionChanged, collectionFailed);
                            break;
                    }
                }
        ...
        private const string AxisMemberNames = "ExchangeEnergyShopMaster, ExchangeEnergyProductMaster";
        ...
        {
            Action<IEnergyProductBinder> itemAdded = binder =>
                OnItemAdded(operationGeneration, collection, binder);
            Action<IEnergyProductBinder> itemRemoved = binder =>
        ...
        private void OnCollectionChanged(long operationGeneration, IEnergyProductBinderCollection collection)
        {
            if (!IsCurrentOperation(operationGeneration, collection)) return;
        ...
        private void Cleanup()
        {
            ...
            var handlers = new List<EnergyProductListItemHandler>(_handlers.Values);
            _collection = null;
