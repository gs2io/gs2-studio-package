...
{
    /// <summary>
    /// Mounts onto Binders[index] of a parent IEnergyProductBinderListSource
    /// (the plain EnergyProductListHandler or any ref-scoped variant) and
    ...
    /// </summary>
    [AddComponentMenu("GS2 Studio/DomainType/EnergyProduct/EnergyProduct List Item Handler")]
    public sealed class EnergyProductListItemHandler : EnergyProductHandlerBase
    {
        ...
        private IEnergyProductBinderListSource? _list;
        ...
        // non-owning IActionableEnergyProductBinder.
        private IActionableEnergyProductBinder? _binder;
        private long _reevaluateGeneration;

        public override IActionableEnergyProductBinder? Binder => _binder;
        // The binder implements <see cref="EnergyProduct"/>, so it is the model.
        ...
        /// </summary>
        public void AttachTo(IEnergyProductBinderListSource list, int index)
        {
        ...
        private void Start()
        {
            ...
            var list = GetComponentInParent<IEnergyProductBinderListSource>();
            if (list == null)
            {
                RaiseFailed(new InvalidOperationException(
                    "No ancestor IEnergyProductBinderListSource found in the parent chain."));
                SetContentVisible(false);
                return;
            }
            _list = list;
