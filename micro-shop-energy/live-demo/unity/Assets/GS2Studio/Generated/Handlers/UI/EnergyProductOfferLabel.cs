...
namespace GS2Studio.Generated.EnergyProduct.UI
{
    ...
    /// </summary>
    [AddComponentMenu("GS2 Studio/DomainType/EnergyProduct/TemplateLabel/OfferLabel")]
    public sealed class EnergyProductOfferLabel : MonoBehaviour
    {
        ...
        private void OnEnable()
        {
            ...
            if (_handler == null)
            {
                ...
                if (!_warnedMissingHandler)
                {
                    ...
                    Debug.LogWarning(
                        $"{nameof(EnergyProductOfferLabel)} on '{name}': no EnergyProductHandlerBase found in the parent chain; component inactive.", this);
                }
                return;
            }
            if (!_subscribed)
